...
// +-----------------------------------------------------------------+
//  Path: /modules/ucounting/language/en_us/language.php
//
// Locale specification
define('LANGUAGE','English (US)');
define('TITLE', 'Ucounting ERP');
define('TEXT_UCOUNTING_INFO','Ucounting Small Business Solutions');
...
define('LOAD_CONFIG_ERROR','There was an error returned while retrieving the configuration data.<br />UcBooks was able to connect to the database but could not find the configuration table. Looks like the table is missing! Options include deleting /includes/configure.php and re-installing (for new installations) or restoring the database tables (database crash).');
define('SAFE_MODE_ERROR','Operating in Safe Mode. UcBooks will not operate properly if PHP is set to Safe Mode!)');
...
define('ERROR_CANNOT_CREATE_DIR','Backup directory could not be created in /'.PATH_TO_MY_FILES.'. Check permissions.');
...
define('TEXT_VERSION_CHECK_NEW_VER','There is a new Ucounting version available. Installed Version: <b>%s</b> available version = <b>%s</b>');
...
define('TEXT_SELECT_FILE_TO_ATTACH','Attachment ');
...
define('TEXT_IMP_ERMSG2','The filesize exceeds the MAX_FILE_SIZE directive in the UcBooks form.');
...
define('TEXT_IMP_ERMSG8','UcBooks could not find a valid report to import in the uploaded file!');
