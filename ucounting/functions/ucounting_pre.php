...
//echo 'inserting data: '; print_r($table_array); echo '<br>';
                ...
                if ($table == 'contacts') {
                    $Fsql = mysql_query("SELECT * FROM " . TABLE_CONTACTS . " where short_name='" . $table_array['short_name'] . "'");
                    if ($table_array['id']) {
                    ...
                    $Fsql = mysql_query("SELECT * FROM " . TABLE_INVENTORY . " where sku='" . $table_array['sku'] . "'");
                    if ($table_array['id']) {
                    ...
                    $Fsql = mysql_query("SELECT * FROM " . TABLE_ADDRESS_BOOK . " where primary_name='" . $table_array['primary_name'] . "'");

                    if ($table_array['address_id']) {
                        $result = $db->Execute("SELECT * FROM " . TABLE_ADDRESS_BOOK . " where address_id='" . $table_array['address_id'] . "'");
                        if ($result->RecordCount() > 0) {
