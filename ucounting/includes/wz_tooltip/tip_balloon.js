...
config. BalloonImgPath = "modules/ucounting/includes/wz_tooltip/tip_balloon/"; // Path to images (border, corners, stem), in quotes. Path must be relative to your HTML file.
