...
// Database configuration ************   UPDATED FOR UcBooks ****************
// file: /modules/ucounting/includes/bigdump/bigdump.php
...
$comment[]='/*';  // **************** UcBooks Release 1.5 and earlier company backups *********************
...
$db_connection_charset = 'utf8'; // *************** Set to utf8 for UcBooks *********************
$finished = false; // *************** added to logout on success for UcBooks *********************
...
<!--  <title>BigDump ver. <?php echo (VERSION); ?></title> ***********  Mod for UcBooks ************ -->
...
<?php // ****************************** BOF - Mods by UcSoft **************************************** ?>
  ...
  var combo_image_on  = '<?php echo DIR_WS_ICONS . '16x16/ucbooks/pull_down_active.gif'; ?>';
  var combo_image_off = '<?php echo DIR_WS_ICONS . '16x16/ucbooks/pull_down_inactive.gif'; ?>';
  </script>
  <script type="text/javascript" src="includes/common.js"></script>
  <script type="text/javascript" src="modules/ucounting/includes/jquery/jquery-1.4.3.min.js"></script>
  <?php 
  ...
  include_once(DIR_FS_MODULES . 'ucounting/includes/bigdump/language/'.$_SESSION['language'].'/language.php');
...
//    { echo ("<p class=\"successcentr\">".BIGDUMP_READ_SUCCESS."</p>\n");
    { echo ("<p class=\"successcentr\">" . html_button_field('logout', BIGDUMP_IMPORT_MSG_17, 'onclick="location.href = \'' . html_href_link(FILENAME_DEFAULT, 'module=ucounting&page=main&action=logout', 'SSL') . '\'"') . "</p>\n");
/*
