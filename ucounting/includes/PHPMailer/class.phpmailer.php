...
// ******************** BOF - Modified by UcBooks ********************
	load_method_language(DIR_FS_MODULES . 'ucounting/includes/PHPMailer');
    $PHPMAILER_LANG = array( // ****** UcBooks changed all of these to constants *****
...
//      if (PHP_VERSION < 6) {
// EOF - UcSoft Patch for deprecated function
