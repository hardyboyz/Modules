...
//        }
        ...
        $purc_total_tax = $purc_total_tax + $get_purc_item['sales_tax'];
    }
}
//this is for Sales
...
//        }
        ...
        $Supp_total_tax = $Supp_total_tax + $get_Supp_item['sales_tax'];
    }
}
...
$heading = array(
    array('header_start' => 'CompInfoStart',
        'header' => array('CompanyName', 'CompanyID', 'GSTNo', 'PeriodStart', 'PeriodEnd', 'GAFCreationDate', 'ProductVersion', 'GAFVersion'),
        'com_val' => $company_array,
        'header_end' => 'CompInfoEnd'
    ),
    array('header_start' => 'PurcDataStart',
        'header' => array('SupplierName', 'SupplierID', 'InvoiceDate', 'InvoiceNo', 'ImportK1No', 'LineNo', 'ProductDescription', 'PurchaseValueRM', 'GSTValueRM', 'TaxCode', 'FCYCode', 'PurchaseFCY', 'GSTFCY'),
    ...
    array('header_start' => 'SuppDataStart',
        'header' => array('CustomerName', 'CustomerID', 'InvoiceDate', 'InvoiceNo', 'LineNo', 'ProductDescription', 'SupplyValueRM', 'GSTValueRM', 'TaxCode', 'Country', 'FCYCode', 'SupplyFCY', 'GSTFCY'),
    ...
    array('header_start' => 'GLDataStart',
        ...
        'header_end' => array('GLDataEnd','','','','','','','', $gl_total_debit, $gl_total_credit, $count_gl)
    )
);
