...
// +-----------------------------------------------------------------+
//  Path: /modules/ucounting/pages/users/template_main.php
//
...
$toolbar->icon_list['new']['text']    = "+ New User";
...
<!--    <thead class="ui-widget-header">
    ...
    <thead class="ui-widget-hewidgetader">   
        <tr style="height: 36px;" > 
            ...
            <th class="ui-state-default"><?php echo GEN_DISPLAY_NAME ?></th>
            <th class="ui-state-default"><?php echo GEN_EMAIL ?></th>            
