...
// +-----------------------------------------------------------------+
//  Path: /modules/ucounting/pages/pw_lost/template_main.php
//
echo html_form('pw_lost', FILENAME_DEFAULT, 'module=ucounting&amp;page=main&amp;action=lost_pw&amp;req=pw_lost_sub') . chr(10);
?>
<div style="margin-left:25%;margin-right:25%;margin-top:50px;">
<table class="ui-widget" style="border-collapse:collapse;width:100%">
 <thead class="ui-widget-header">
   <tr height="70"><th colspan="2" align="right"><img src="modules/ucounting/images/ucsoft_logo.png" alt="Ucounting Business Toolkit" height="50" /></th></tr>
 </thead>
