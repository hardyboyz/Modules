...
<div class="bizz_content login_block ">
    ...
    <div class="login_area">
        <h2 style="background-color: none !important;" class="heading_style"><?php if(!empty($company_name['configuration_value'])){ echo $company_name['configuration_value'];} else echo 'Ucounting'; ?> </h2>
        <form  class="form-signin form_class" name="login" method="POST" action="login-db.php">
