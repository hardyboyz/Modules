    ...
    while (!$cp_boxes->EOF) {
        ...
        if (file_exists(DIR_FS_MODULES . $module_id . '/dashboards/' . $dashboard_id . '/' . $dashboard_id . '.php')) {
            ...
            if ($dashboard_id == 'dashboard') {
                ...
                if ($counter == 1 && $dashboard_id != 'dashboard') {
                    $firts = true;
                    ?>
                    <br/>
                    <br/>
                    ...
                    while (!$cp_boxes->EOF) {
                        ...
                        if (file_exists(DIR_FS_MODULES . $module_id . '/dashboards/' . $dashboard_id . '/' . $dashboard_id . '.php')) {
                            ...
                            if ($dashboard_id == 'sales_dashboard') {
                                echo $new_box->Output($params);
                            } else {
                                if ($counter == 1 && $dashboard_id != 'sales_dashboard') {
                                    $firts = true;
                                    ?>
                                    <br/>
                                    <br/>
                                    ...
                                    while (!$cp_boxes->EOF) {
                                        ...
                                        if (file_exists(DIR_FS_MODULES . $module_id . '/dashboards/' . $dashboard_id . '/' . $dashboard_id . '.php')) {
                                            ...
                                            $new_box->column_id = $cp_boxes->fields['column_id'];
                                            $new_box->row_id = $cp_boxes->fields['row_id'];
                                            if ($dashboard_id == 'purchase_dashboard') {
                                                echo $new_box->Output($params);
                                            } else {
                                                if ($counter == 1 && $dashboard_id != 'purchase_dashboard') {
                                                    $firts = true;
                                                    ?>
                                                    <br/>
                                                    <br/>
                                                                ...
                                                                tooltip: {
                                                                    ...
                                                                    column: {
                                                                        ...
                                                                        point: {
                                                                            events: {
                                                                                click: function(e) {
                                                                                    window.open( 'index.php?module=ucbooks&page=status&jID=6&list=1'+'&category='+this.category+'&series='+this.series.name+'','_newtab'); //proper path 2)
                                                                                    e.preventDefault();
                                                                                }
                                                                            }
                                                                        },
                                                                   ...
                                                                   plotOptions: {
                                                                    column: {
                                                                        ...
                                                                        point: {
                                                                            events: {
                                                                                click: function(e) {
                                                                                    window.open( 'index.php?module=ucbooks&page=status&jID=12&list=1'+'&category='+this.category+'&series='+this.series.name+'','_newtab'); //proper path 2)
                                                                                    e.preventDefault();
                                                                                }
                                                                            }
                                                                        },
