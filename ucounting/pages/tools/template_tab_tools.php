...
// +-----------------------------------------------------------------+
//  Path: /modules/ucounting/pages/admin/template_tab_tools.php
//
?>
<div id="tab_tools">
<fieldset>
...
?>
	<tr>
            <?php if(isset($_GET['action_type']) || $_GET['action_type'] == "transaction_sequence"){ ?>
            <td colspan="2" align="right"><?php 
                echo html_button_field('ordr_nums', GEN_ADM_TOOLS_BTN_SAVE, 'onclick="submitThis(this)"');
             ?></td>
            <?php }else{ ?>
                <td colspan="2" align="right"><?php 
