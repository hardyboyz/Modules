...
if(isset($_POST['setup_wizard_action']) && $_POST['setup_wizard_action'] == 'transaction_sequence'){
    $action = $_GET['action'];
}
...
if ($action == 'first_dashboard' || $_POST['first_dashboard'] == 'first_dashboard') {
    ...
    define('PAGE_TITLE', BOX_GENERAL_ADMIN);
} else if((isset($_GET['action_type']) && $_GET['action_type'] == "transaction_sequence")||isset($_POST['setup_wizard_action']) && $_POST['setup_wizard_action'] == 'transaction_sequence'){
    $include_header = true;
    $include_footer = true;
    $menu_select = 'home';
    $sub_menu_select = 'setup_wizard';
  
    $setupwizard_menu = 'step_6';
    $include_template = 'setup_wizard_transaction_sequence.php';
    define('PAGE_TITLE', BOX_GENERAL_ADMIN);
}
...
if (isset($_POST['wizard'])) {
    ...
    if($res){
        gen_redirect(html_href_link(FILENAME_DEFAULT, 'module=ucounting&page=tools&action_type=transaction_sequence', 'SSL'));	
    }
