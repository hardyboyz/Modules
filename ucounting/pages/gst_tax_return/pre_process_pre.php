...
journal_main.product_desc
from journal_main JOIN journal_item on journal_main.id = journal_item.ref_id
WHERE journal_item.gl_type = 'por' and journal_item.post_date BETWEEN '".$start."' and '".$end."' order by journal_main.post_date";
...
journal_main.product_desc
from journal_main JOIN journal_item on journal_main.id = journal_item.ref_id
WHERE journal_item.gl_type = 'sos' and journal_item.post_date BETWEEN '".$start."' and '".$end."' order by journal_main.post_date";
