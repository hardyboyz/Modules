...
// +-----------------------------------------------------------------+
//  Path: /modules/ucounting/pages/backup/template_main.php
//
...
<h5><?php echo GEN_ADM_TOOLS_CLEAN_LOG; ?></h5>
...
<h5><?php echo BOX_HEADING_BACKUP; ?></h5>
<table class="ui-widget" style="border-style:none;margin-left:auto;margin-right:auto; width: 100%; background-color: #eeeeee;">
 <thead class="ui-widget-header">
 ...
 <tbody class="ui-widget-content">
  ...
  <tr>
      <td align="center" class="checkbox_cl" ><?php echo html_radio_field('conv_type', 'zip',  true,  '', '') . GEN_COMP_ZIP; ?></td>
	<td align="center" class="checkbox_cl"><?php echo html_radio_field('conv_type', 'bz2',  false, '', '') . GEN_COMP_BZ2; ?></td>
	<td align="center" nowrap="nowrap" class="checkbox_cl"><?php echo html_radio_field('conv_type', 'none', false, '', '') . GEN_COMP_NONE; ?></td>
  </tr>
  <tr class="ui-widget-header"><th colspan="3"><?php echo TEXT_OPTIONS; ?></th></tr>
  <tr>
	<td colspan="3" class="checkbox_cl"><?php echo html_radio_field('dl_type', 'file', true, '', '') . GEN_BACKUP_DB_ONLY; ?></td>
  </tr>
  <tr>
	<td colspan="3" class="checkbox_cl"><?php echo html_radio_field('dl_type', 'dir', false, '', '') . GEN_BACKUP_FULL; ?></td>
  </tr>
  <tr>
	<td colspan="2" class="checkbox_cl"><?php echo html_checkbox_field('save_local', '1', false, '', '') . GEN_BACKUP_SAVE_LOCAL; ?></td>
