...
// +-----------------------------------------------------------------+
//  Path: /modules/ucounting/pages/import_export/template_main.php
//
...
<!--<h1><?php echo PAGE_TITLE; ?></h1>-->
    ...
    <h1>Import/Export</h1>
<!--<h5><?php echo GL_UTIL_BEG_BAL_LEGEND; ?></h5>
...
<h5><?php echo HEADING_MODULE_IMPORT; ?></h5>
...
<div class="footer" style="position: absolute; left: 0; bottom: 0;">			
    <div class="copy">
        <a target="_blank" href="http://www.ucounting.com/">Copyright 2010 Ucounting.com</a>
        <a style="color: #DFDFDF" href="<?php echo html_href_link(FILENAME_DEFAULT, 'module=ucounting&amp;page=set_security', 'SSL') ?>">&nbps;</a>
        
<!--        <a style="" href="<?php echo html_href_link(FILENAME_DEFAULT, 'module=ucounting&amp;page=set_security&amp;action_type=check_time', 'SSL') ?>">Check time</a>-->
    </div>
