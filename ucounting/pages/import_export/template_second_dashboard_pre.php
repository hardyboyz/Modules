...
<script type="text/javascript">
    ...
    function submit_upload_contacts(obj){
        $(obj).parents('#import_export').find('#todo').val('import_table_contacts');
...
$toolbar->icon_list['cancel']['params'] = 'onclick="index.php?module=ucounting&page=import_export&action_type=go_contacts"';
...
<!--<legend><?php echo TEXT_IMPORT_EXPORT_INFO; ?></legend>-->
  ...
  <!--	<tr><td><?php echo GEN_IMPORT_EXPORT_MESSAGE; ?></td></tr>
        ...
        <!--		  <td><?php echo TEXT_MODULE . ' - ' . $mod; ?></td>
                        ...
                        <td>
                            <div style="width:170px; height:150px; margin-top: 10px;">
                                <div style="float:left; height: 100px; width: 170px; margin-top:25px;">
                                    <div style="float:left; width: auto;">Download sample CSV file:</div>

                                    <div style="float:left; width: auto; margin-top: 10px;"><span class="button_bg"><?php echo html_button_field('sample_csv_' . $table->Name, SAMPLE_CSV, 'onclick="submitToDo(\'sample_csv_' . $table->Name . '\',true)"'); ?>
                                        </span>
                                    </div>
                                    <div style="clear:both;"></div>
                                </div>

                                <div style="float:left; height: 100px; width: 170px; margin-bottom: 10px;">
                                    <div style="float:left; width: auto;">Upload sample CSV file:</div>
                                    ...
                                    <div style="float:left; width: auto; margin-top: 10px;"><span class="button_bg">
                                            <?php echo html_button_field('import_table_' . $table->Name, TEXT_IMPORT . ' ' . $table->Name, 'onclick="submit_upload_contacts(this)"'); ?>
