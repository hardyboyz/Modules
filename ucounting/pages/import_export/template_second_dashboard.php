        ...
        <!--		  <td><?php echo TEXT_MODULE . ' - ' . $mod; ?></td>
                        ...
                        <td>
                            <div style="width:100%; height:150px; margin-top: 10px;">
                                ...
                                <div style="float:left; width: auto; margin-left: 20px;">Upload sample CSV file:<br/><br/>
                                ...
                                <div style="float:left; width: auto; margin-top: 15px; margin-left: 20px;"><span class="button_bg">
