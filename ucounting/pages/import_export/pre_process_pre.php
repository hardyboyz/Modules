        ...
        switch ($format) {
            ...
            case 'csv':
                ...
                if ($db_table == 'contacts') {
                    ...
                    if ($result[0] > 0) {
                        $messageStack->add($result[0] . ' Contacts successfully uploaded.', 'success');
                    }
                    if ($result[1] > 0) {
                        $messageStack->add($result[1] . ' Contacts did not uploaded due to missing of required information.', 'error');
                    }
                }else{
