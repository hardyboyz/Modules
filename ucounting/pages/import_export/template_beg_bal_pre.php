...
// +-----------------------------------------------------------------+
//  Path: /modules/ucounting/pages/import_export/template_beg_bal.php
//
...
<input type="hidden" name="redirect" value="beg_balances" />
<h5><?php echo GL_UTIL_BEG_BAL_LEGEND; ?></h5>
<table class="ui-widget" style="border-style:none;width:100%">
 <tbody class="ui-widget-content">
    <tr>
	  <td>
              <?php echo GL_UTIL_BEG_BAL_TEXT; ?>
    ...
    <tr>
        <td align="left"> 
            <br/><br/>
            <a href="javascript:" onclick="showContent(this)" >Click here to proceed to Enter Beginning Balances</a>
        </td>
    </tr>
 </tbody>
</table>
<br/><br/>
<table class="ui-widget"  id="beg_bal"style="border-style:none;width:100%; display: none;">
  <tr><td valign="top" >
