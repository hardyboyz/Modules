...
// +-----------------------------------------------------------------+
//  Path: /modules/bank_transfer/defaults.php
//
// default directory for order attachments
define('bank_transfer_DIR_MY_ORDERS',  DIR_FS_MY_FILES . $_SESSION['company'] . '/bank_transfer/orders/');
// default for sorting on PAyBIlls and CUstomer Receipts listings
define('bank_transfer_DEFAULT_BILL_SORT','invoice'); // choices are 'invoice', 'due_date'
