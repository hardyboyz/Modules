...
// +-----------------------------------------------------------------+
//  Path: /modules/bank_transfer/language/en_us/language.php
//
// Page Titles
...
define('GL_ERROR_NO_REFERENCE','For recurring transactions, a starting reference number needs to be entered. bank_transfer will increment it for each recurring entry.');
...
define('GL_ERROR_NO_RETAINED_EARNINGS_ACCOUNT','Zero or more than one retained earnings accounts found. There needs to be one and only one retained earnings account in bank_transfer to operate properly!');
...
// Javascript Messages
define('ORD_JS_RECUR_NO_INVOICE','For a recurring transaction, a starting invoice number needs to be entered. bank_transfer will increment it for each recurring entry.');
