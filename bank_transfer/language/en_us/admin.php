...
// +-----------------------------------------------------------------+
//  Path: /modules/bank_transfer/language/en_us/admin.php
//

// Module information
define('MODULE_BANK_TRANSFER_TITLE','bank_transfer Module');
define('MODULE_BANK_TRANSFER_DESCRIPTION','The bank_transfer module provides double entry accounting. Functions include Purchase Orders, Sales Orders, Invoicing, Journal Entries and more. <b>NOTE: This is a core module and should not be removed!</b>');
// Headings
// Installation
define('MODULE_BANK_TRANSFER_NOTES_1','PRIORITY MEDIUM: Enter company information (Company -> Module Administration -> My Company tab)');
define('MODULE_BANK_TRANSFER_NOTES_2','PRIORITY LOW: Set up mail server settings (Company -> Module Administration -> Email tab)');
define('MODULE_BANK_TRANSFER_NOTES_3','PRIORITY HIGH: Change or import chart of accounts from default settings (Company -> Module Administration -> bank_transfer Module Properties -> Chart of Accounts tab)');
define('MODULE_BANK_TRANSFER_NOTES_4','PRIORITY MEDIUM: Update default general ledger accounts for customer and Suppliers, after loading GL accounts (Company -> Module Administration -> bank_transfer Module Properties -> Customers/Suppliers tab)');
// General Defines
...
define('PB_PF_VENDOR_CRD_MEMO','Credit Memos - Suppliers');
define('PB_PF_VENDOR_LABEL','Labels - Suppliers');
define('PB_PF_VENDOR_QUOTE','Supplier Quotes');
define('PB_PF_VENDOR_STATEMENT','Suppliers Statements');
/************************** (bank_transfer Utilities) ***********************************************/
...
define('CD_01_52_DESC', 'Enabling this feature will cause bank_transfer to round calculated taxes by authority prior to adding up all applicable authorities. For tax rates with a single authority, this will only keep math precision errors from entering the journal. For multi-authority tax rates, this could cause too much or too little tax from being collected. If not sure, leave set to No.');
...
define('ALLOW_NEGATIVE_INVENTORY_DESC','Allow sales of inventory items resulting in negative stock levels? bank_transfer allows this and the journal entry resulting in inventory going negative is re-posted when inventory is received to accurately calculate costs.');
/************************** (Customer Defaults) ***********************************************/
