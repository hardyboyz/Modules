...
// +-----------------------------------------------------------------+
//  Path: /modules/bank_transfer/updates/R14toR15.php
//
...
if (!defined('INVENTORY_AUTO_ADD')) {
  ...
  $db->Execute("INSERT INTO " .  TABLE_CONFIGURATION . " 
    ...
    VALUES ( 'Enable Automatic Creation of Inventory Items', 'INVENTORY_AUTO_ADD', '0', 'Allows the automatic creation of inventory items in the order screens.<br /><br /> SKUs are not required in bank_transfer for non-trackable inventory types. This feature allows for the automatic creation of SKUs in the inventory database table. The inventory type used will be stock for inventory type GL accounts and non-stock for all other type accounts. The GL account used to determine the type is the account selected with the line item in the order screen.', '5', '55', NULL , now(), NULL , 'cfg_keyed_select_option(array(0 =>\'No\', 1=>\'Yes\'),' ),
  ...
  require(DIR_FS_MODULES . 'orders/functions/bank_transfer.php');
