...
// +-----------------------------------------------------------------+
//  Path: /modules/bank_transfer/install/updates/R21toR30.php
//

// This script updates Release 2.1 to Ucounting Framework Release 3.0, it is included as part of the update script
...
$result = $db->Execute("select id, doc_title from " . TABLE_UCFORM . " where doc_ext in ('rpt','frm')");
$new_reports = array();
while (!$result->EOF) {
