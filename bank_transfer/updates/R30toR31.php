...
// +-----------------------------------------------------------------+
//  Path: /modules/bank_transfer/install/updates/R30toR31.php
//
// This script updates bank_transfer release 3.0 to release 3.1, it is included as part of the update script
