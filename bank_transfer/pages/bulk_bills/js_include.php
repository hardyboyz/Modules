...
// +-----------------------------------------------------------------+
//  Path: /modules/bank_transfer/pages/bulk_bills/js_include.php
//
?>
...
<?php if ($post_success && $action == 'print') { ?>
  var printWin = window.open("index.php?module=ucform&page=popup_gen&gID=<?php echo POPUP_FORM_TYPE; ?>&date=a&xfld=journal_main.purchase_invoice_id&xcr=RANGE&xmin=<?php echo $print_crit['min']; ?>&xmax=<?php echo $print_crit['max']; ?>","reportFilter","width=1150px,height=550px,resizable=1,scrollbars=1,top=150px,left=100px");
  printWin.focus();
<?php } ?>
}
...
<script type="text/javascript" src="modules/bank_transfer/javascript/banking.js"></script>
