...
$toolbar->icon_list['print']['params'] = 'onclick="window.open(\'' . html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=print_invoice&amp;oID=' . $_GET['oID'] . '&amp;jID=' . $_GET['jID'] . '&amp;action=pdf&amp;pdf_type=ReM', 'SSL') . '\',\'_blank\')"';
$toolbar->icon_list['print']['text'] = 'Generate Received Money PDF';
