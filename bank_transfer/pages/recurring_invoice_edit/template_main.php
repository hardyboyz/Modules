<script type="text/javascript">
    ...
    function email_invoice(){
        ...
        window.open('<?php echo 'index.php?module=ucform&page=popup_gen&gID=' . POPUP_FORM_TYPE . '&date=a&xfld=journal_main.id&xcr=EQUAL&xmin=' . $_GET['oID'] . '&emailsend=email' ?>','email','height=600,width=1100,left=100');
    }
</script>
...
$toolbar->icon_list['print']['text'] = "Print/Save PDF";
...
if ($security_level < 2 || JOURNAL_ID == 6 || JOURNAL_ID == 7)
...
<h1><?php //echo constant('ORD_TEXT_' . JOURNAL_ID . '_WINDOW_TITLE'); ?>Editing Recurring Invoice</h1>
                        ...
                        <tr>
                            ...
                            <td width="36%">
                                ...
                                <?php if (isset($template_options['waiting'])) { // show waiting for invoice (purchase_receive, vendor cm) checkbox ?>
                                    ...
                                    <span class="form_label" ><?php echo $template_options['waiting']['title']; ?> :</span>
                            ...
                            <?php if (ENABLE_MULTI_CURRENCY) { ?>
                                <table class="td_padding" style="width: 100%">
                                    <tr>
                                        ...
                                        <td width="4%" height="30px">:</td>
                                        <td width="56%" height="30px"><?php echo html_input_field('currencies_value', $order->currencies_value, 'readonly="readonly"'); ?></td>
                                    </tr>
                                </table>
                            <?php } ?>
