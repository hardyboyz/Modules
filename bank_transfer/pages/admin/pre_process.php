...
// +-----------------------------------------------------------------+
//  Path: /modules/bank_transfer/pages/admin/pre_process.php
//
...
$install           = new bank_transfer_admin();
...
switch ($action) {
  ...
  case 'save':
	...
	$messageStack->add(bank_transfer_CONFIG_SAVED,'success');
    break;
  case 'delete':
...
define('PAGE_TITLE', BOX_BANK_TRANSFER_MODULE_ADM);
