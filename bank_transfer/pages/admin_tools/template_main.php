...
// +-----------------------------------------------------------------+
//  Path: /modules/bank_transfer/pages/admin_tools/template_main.php
//
...
<h5><?php echo GL_UTIL_PERIOD_LEGEND; ?></h5>
...
<h5><?php echo GEN_ADM_TOOLS_REPOST_HEADING; ?></h5>
<p><?php echo GEN_ADM_TOOLS_REPOST_DESC; ?></p>
 ...
 <tbody class="ui-widget-content">
	...
	<tr>
          <td class="checkbox_cl"><?php echo  html_checkbox_field('jID_9', '1', false); ?></td>
	  <td><?php echo GEN_ADM_TOOLS_J09; ?></td>
	  <td class="checkbox_cl"><?php echo  html_checkbox_field('jID_3', '1', false); ?></td>
	  <td><?php echo GEN_ADM_TOOLS_J03; ?></td>
	  <td class="checkbox_cl"><?php echo  html_checkbox_field('jID_2', '1', false); ?></td>
	  <td><?php echo GEN_ADM_TOOLS_J02; ?></td>
  	  <td colspan="2"><?php echo GEN_ADM_TOOLS_START_DATE; ?></td>
	</tr>
	<tr>
	  <td class="checkbox_cl"><?php echo  html_checkbox_field('jID_10', '1', false); ?></td>
	  <td><?php echo GEN_ADM_TOOLS_J10; ?></td>
	  <td class="checkbox_cl"><?php echo  html_checkbox_field('jID_4', '1', false); ?></td>
	  <td><?php echo GEN_ADM_TOOLS_J04; ?></td>
	  <td class="checkbox_cl"><?php echo  html_checkbox_field('jID_8', '1', false); ?></td>
	  <td><?php echo GEN_ADM_TOOLS_J08; ?></td>
	  <td colspan="2"><?php echo html_calendar_field($cal_repost_start); ?></td>
	</tr>
	<tr>
	  <td class="checkbox_cl"><?php echo  html_checkbox_field('jID_12', '1', false); ?></td>
	  <td><?php echo GEN_ADM_TOOLS_J12; ?></td>
	  <td class="checkbox_cl"><?php echo  html_checkbox_field('jID_6', '1', false); ?></td>
	  <td><?php echo GEN_ADM_TOOLS_J06; ?></td>
	  <td class="checkbox_cl"><?php echo  html_checkbox_field('jID_14', '1', false); ?></td>
	  <td><?php echo GEN_ADM_TOOLS_J14; ?></td>
  	  <td colspan="2"><?php echo GEN_ADM_TOOLS_END_DATE; ?></td>
	</tr>
	<tr>
	  <td class="checkbox_cl"><?php echo  html_checkbox_field('jID_13', '1', false); ?></td>
	  <td><?php echo GEN_ADM_TOOLS_J13; ?></td>
	  <td class="checkbox_cl"><?php echo  html_checkbox_field('jID_7', '1', false); ?></td>
	  <td><?php echo GEN_ADM_TOOLS_J07; ?></td>
	  <td class="checkbox_cl"><?php echo  html_checkbox_field('jID_16', '1', false); ?></td>
	  <td><?php echo GEN_ADM_TOOLS_J16; ?></td>
	  <td colspan="2"><?php echo html_calendar_field($cal_repost_end); ?></td>
	</tr>
	<tr>
	  <td class="checkbox_cl"><?php echo  html_checkbox_field('jID_19', '1', false); ?></td>
	  <td><?php echo GEN_ADM_TOOLS_J19; ?></td>
	  <td class="checkbox_cl"><?php echo  html_checkbox_field('jID_21', '1', false); ?></td>
	  <td><?php echo GEN_ADM_TOOLS_J21; ?></td>
	  <td class="checkbox_cl"><?php echo  html_checkbox_field('jID_18', '1', false); ?></td>
	  <td><?php echo GEN_ADM_TOOLS_J18; ?></td>
	</tr>
	<tr>
	  <td colspan="2">&nbsp;</td>
	  <td colspan="2">&nbsp;</td>
	  <td class="checkbox_cl"><?php echo  html_checkbox_field('jID_20', '1', false); ?></td>
