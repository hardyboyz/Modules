...
// +-----------------------------------------------------------------+
//  Path: /modules/bank_transfer/pages/popup_recur/pre_process.php
//
...
switch (JOURNAL_ID) {
	...
	case 12:	// Sales/Invoice Journal
		break;
	default:
		die('No valid journal id found (filename: modules/bank_transfer/pages/popup_recur.php), Journal ID needs to be passed to this script to identify the correct procedure.');
}
