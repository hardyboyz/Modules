...
// +-----------------------------------------------------------------+
//  Path: /modules/bank_transfer/pages/chart_of_accounts/template_main.php
//
...
//  require (DIR_FS_MODULES . $module . '/pages/chart_of_accounts/template_tab_vendors.php');
  require (DIR_FS_MODULES . $module . '/pages/chart_of_accounts/template_tab_chart_of_accounts.php');
