...
<script type="text/javascript">
    ...
    var sub_journalID         = '<?php echo SUB_OURNAL_ID; ?>';
...
<?php if ($action == 'edit') echo '  EditJournal(' . $oID . ');' . chr(10); ?>
    ...
    function check_form() {
        ...
        function processEditJournal(sXml) {
            ...
            if ($(xml).find("bill_contact").text()) document.getElementById('bill_contact').value = $(xml).find("bill_contact").text();
            if ($(xml).find("bill_primary_name").text()) document.getElementById('description').value = $(xml).find("bill_primary_name").text();
            ...
            $(xml).find("items").each(function(i,v) {
                ...
                if($(this).find("credit_amount").text()==0){
                    ...
                    if($(xml).find("tax_inclusive").text() == 1){
                        ...
                        tax =  parseFloat($(this).find("debit_amount").text()) * (tax_rates[tax_index].rate / (parseFloat(100)));
                        // alert(tax)
                        //  }else{
                    ...
                    document.getElementById('debit_'+jIndex).value  = formatCurrency(parseFloat($(this).find("debit_amount").text())+parseFloat(tax));
                
                    document.getElementById('credit_'+jIndex).value = formatCurrency(parseFloat($(this).find("credit_amount").text()));
        ...
        function addGLRow(debit, credit, description, tax_val) {
            ...
            cell[4] = '<td><input type="text" name="debit_'+rowCnt+'" id="debit_'+rowCnt+'" style="text-align:right" size="13" maxlength="12"  value="'+debit+'" onchange="formatRow('+rowCnt+', \'d\')"><\/td>';
            cell[5] = '<td><input type="hidden" name="credit_'+rowCnt+'" id="credit_'+rowCnt+'" style="text-align:right" size="13" maxlength="12" value="'+credit+'"onchange="formatRow('+rowCnt+', \'c\')"><\/td>';
        ...
        function updateBalance() {
            ...
            var ct = new String(debit_total);
            var ct0 = new String(credit_0);
            document.getElementById('credit_0').value = formatCurrency(dt);
