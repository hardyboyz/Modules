...
// +-----------------------------------------------------------------+
//  Path: /modules/bank_transfer/dashboards/po_status/po_status.php
//
// Revision history
  ...
  function Output($params) {
	...
	if ($result->RecordCount() < 1) {
	  ...
	  while (!$result->EOF) {
		...
		$contents .= '<div>';
		$contents .= '<a href="' . html_href_link(FILENAME_DEFAULT, 'module=bank_transfer&amp;page=orders&amp;oID=' . $result->fields['id'] . '&amp;jID=4&amp;action=edit', 'SSL') . '">';
