...
// +-----------------------------------------------------------------+
//  Path: /modules/bank_transfer/dashboards/todays_s_quotes/todays_s_quotes.php
//
...
//		$contents .= '<a href="' . html_href_link(FILENAME_DEFAULT, 'module=bank_transfer&amp;page=orders&amp;oID=' . $result->fields['id'] . '&amp;jID=10&amp;action=edit', 'SSL') . '">';
                $contents .= '<a href="' . html_href_link(FILENAME_DEFAULT, 'module=bank_transfer&amp;page=orders&amp;oID=' . $result->fields['id'] . '&amp;jID=9&amp;action=edit', 'SSL') . '">';
