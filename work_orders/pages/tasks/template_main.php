    ...
    <tr>
        <td width="33%">
            <table width="100%">
                ...
                <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_TASK_NAME; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('task_name', $task_name); ?></td>
                </tr>
                <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_DEPARTMENT; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_pull_down_menu('dept_id', $departments, $dept_id); ?></td>
                </tr>
                <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_DESCRIPTION; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_textarea_field('description', 40, 3, $description); ?></td>
                </tr>
                <tr>
                    <td colspan="3">&nbsp;</td>
                </tr>
        ...
        <td width="33%">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('ref_doc', $ref_doc); ?></td>
                </tr>
                <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_DRAWINGS; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('ref_spec', $ref_spec); ?></td>
                </tr>
                <tr>
                    <td width="40%"> <span class="form_label" ><?php echo TEXT_TASK_TIME; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%">
                        <?php 
        ...
        <td width="33%">
            <table width="100%">
                ...
                <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_MFG_INIT; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_pull_down_menu('mfg', $yes_no_array, $mfg); ?></td>
                </tr>
                <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_QA_INIT; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_pull_down_menu('qa', $yes_no_array, $qa); ?></td>
                </tr>
                <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_DATA_ENTRY; ?></span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_pull_down_menu('data_entry', $yes_no_array, $data_entry); ?></td>
                </tr>
                <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_ERP_ENTRY; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_pull_down_menu('erp_entry', $yes_no_array, $erp_entry); ?></td>
                </tr>
                <tr>
                    <td colspan="3">&nbsp;</td>
                </tr>
