...
$toolbar->icon_list['new']['text'] = "+ Work Order";
...
<!--    <thead class="ui-widget-header">
    ...
    <thead class="ui-widget-hewidgetader">   
        <tr style="height: 36px;" > 
            <th class="ui-state-default" style="padding: 8px 0 0 0;" ><?php echo TEXT_WO_ID ?></th>
            <th class="ui-state-default"><?php echo TEXT_PRIORITY ?></th>
            <th class="ui-state-default"><?php echo TEXT_POST_DATE ?></th>
            <th class="ui-state-default"><?php echo TEXT_QUANTITY ?></th>
            <th class="ui-state-default"><?php echo TEXT_SKU ?></th>
            <th class="ui-state-default"><?php echo TEXT_WO_TITLE ?></th>  
            <th class="ui-state-default">Status</th>  
            <th class="ui-state-default"><?php echo TEXT_CLOSE_DATE ?></th>             
