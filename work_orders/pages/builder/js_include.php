...
<?php
if ($action <> 'new' && $action <> 'edit') { // set focus for main window
    ...
    $("input[id*='sku']").live('keyup',function(e){
        ...
        if(e.keyCode == 13){
            ...
            if (e.keyCode != 40 && e.keyCode != 38) { 
                ...
                $.ajax({
                    type: "GET",
                    url: 'index.php?module=ucbooks&page=ajax&op=autocopmplete&action=item&row='+id[1]+'&keyword='+keyword,
                    dataType: "text",
...
//    $(document).ready(function(){
//        $("#sku").tokenInput('index.php?module=ucbooks&page=ajax&op=autocopmplete&action=item', {
//            onAdd: function (item) {
//                var id = $(this).attr('id').split('_');
...
//    })
    ...
    function itemList(rowCnt) {
        var storeID = '0';
        var rowCnt = '1';
        window.open("index.php?module=inventory&page=popup_inv&rowID="+rowCnt+"&storeID="+storeID+"&search_text="+document.getElementById('sku').value,"inventory","width=1150px,height=550px,resizable=1,scrollbars=1,top=150,left=100");
    }
    ...
    function taskList(id) {
        window.open("index.php?module=work_orders&page=popup_tasks&rowID="+id,"popup_tasks","width=1150px,height=500px,resizable=1,scrollbars=1,top=50,left=100");
    }
