...
$toolbar->icon_list['new']['text'] = "+ Work Order Builder";
...
<!--    <thead class="ui-widget-header">
    ...
    <thead class="ui-widget-hewidgetader">   
        <tr style="height: 36px;" > 
            <th class="ui-state-default" style="padding: 8px 0 0 0;" ><?php echo TEXT_WO_TITLE ?></th>
            ...
            <th class="ui-state-default"><?php echo TEXT_REVISION_DATE ?></th>            
