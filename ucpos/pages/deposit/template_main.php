...
// +-----------------------------------------------------------------+
//  Path: /modules/ucpos/pages/deposit/template_main.php
//
// start the form
...
switch (JOURNAL_ID) {
    case 19: $toolbar->add_help('07.05');
        break;
    case 21: $toolbar->add_help('07.05');
        break;
}
...
<div>
    <table width="100%" border="0" cellspacing="2" cellpadding="2" style="background-color: #eeeeee;">
        <tr>
            <td width="50%">
                <table width="100%">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="4%">:</td>
                        <td class="input_container" width="56%">
<?php
...
?><ul id="customer_list"></ul>
                    ...
                    <tr>
                        <td colspan="3">
                            <h5><?php echo (JOURNAL_ID == 21 ? TEXT_REMIT_TO : TEXT_BILL_TO) . chr(10); ?></h5>                
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3">
...
<?php echo ((JOURNAL_ID == 21 || !isset($_SESSION['admin_encrypt'])) ? '&nbsp;' : BNK_TEXT_SAVE_PAYMENT_INFO . html_checkbox_field('save_payment', '1', ($order->save_payment ? true : false), '', '')); ?>
                    ...
                    <tr>
                        <td width="40%"><span class="form_label"><?php echo ((JOURNAL_ID == 19) ? BNK_TEXT_DEPOSIT_ID : BNK_TEXT_PAYMENT_ID) . '&nbsp;'; ?> </span></td>
                        <td width="4%">:</td>
                        <td width="56%"><?php echo html_input_field('purchase_invoice_id', $next_inv_ref, 'style="text-align:right"'); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="4%">:</td>
                        <td width="56%"><?php echo html_pull_down_menu('gl_acct_id', $gl_array_list, $order->gl_acct_id, 'onchange="loadNewBalance(this.value)"'); ?></td>
                    </tr>
                    <tr>
                        <td width="40%">
                            <span class="form_label"><?php echo TEXT_TOTAL; ?>
...
<?php echo html_pull_down_menu('payment_id', gen_null_pull_down(), '', 'style="visibility:hidden" onchange=\'fillPayment()\'') . chr(10); ?>
                        ...
                        <tr>
                            <td width="40%"><span class="form_label"><?php echo TEXT_PAYMENT_METHOD; ?></span></td>
                            <td width="4%">:</td>
                            <td width="56%">
                                <?php
...
<div>
    ...
    <table align="center" border="1" cellpadding="1" cellspacing="1" style="background-color: #eeeeee; width: 100%">
        <tr>
        ...
        // End hidden fields
        echo html_input_field('desc_1', $order->desc_1, 'size="64"');
        echo '  </td>' . chr(10);
        echo '  <td class="main" align="center">' . html_pull_down_menu('acct_1', $gl_array_list, $order->acct_1, '') . '</td>' . chr(10);
        echo '  <td class="main" align="center">' . html_input_field('total_1', $currencies->format($order->total_1), 'size="11" onchange="updateDepositPrice()" style="text-align:right"') . '</td>' . chr(10);
        echo '</tr>' . chr(10);
        ?>
    </table>
    <br/><br/>
