...
// +-----------------------------------------------------------------+
//  Path: /modules/ucpos/pages/main/template_main.php
//
// start the form
...
$toolbar->add_icon('new', 'onclick="location.href = \'' . html_href_link(FILENAME_DEFAULT, gen_get_all_get_params(array('action', 'jID')) . 'jID=' . JOURNAL_ID, 'SSL') . '\'"', 2,'+ New POS');
if ($security_level > 1) {
...
<table width="100%" style="background-color:#EEEEEE; padding-top: 20px;">
    <tr>
    ...
    <tr>
        <td width="50%">
            <table width="100%">
                ...
                <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_BRANCH ?> </span></td>
                    <td width="4%">:</td>
                ...
                <tr>
                    ...
                    <td width="4%">:</td>
                    <td width="56%"><?php
                    echo html_input_field('sku', '', ' size="' . (MAX_INVENTORY_SKU_LENGTH + 1) . '" maxlength="' . MAX_INVENTORY_SKU_LENGTH . '" onfocus="clearField(\'sku\', \'' . TEXT_SEARCH . '\')" onblur="setField(\'sku\', \'' . TEXT_SEARCH . '\');" onChange ="loadSkuDetails(0, 0)"') . chr(10);
        ...
        <td width="50%">
            <table width="100%">
                ...
                <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_CURRENCY ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_pull_down_menu('display_currency', gen_get_pull_down(TABLE_CURRENCIES, false, false, 'code', 'title'), $order->currencies_code, 'onchange="recalculateCurrencies();"'); ?></td>
                </tr>
                <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_EXCHANGE_RATE ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('currencies_value', $order->currencies_value, 'readonly="readonly"'); ?></td>
                </tr>
                <?php } ?>
                <tr>
                    <td width="40%"><span class="form_label" ><?php echo ORD_ACCT_ID ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%">
                        <?php
         ...
         <td width="50%">
             <table width="100%">
                 ...
                 <tr>
                    ...
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('bill_primary_name', $order->bill_primary_name, 'size="33" maxlength="32" onfocus="clearField(\'bill_primary_name\', \'' . GEN_PRIMARY_NAME . '\')" onblur="setField(\'bill_primary_name\', \'' . GEN_PRIMARY_NAME . '\')"', true) . chr(10); ?></td>
                </tr>
                 <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_ADD_UPDATE ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_checkbox_field('bill_add_update', '1', ($order->bill_add_update) ? true : false, '', '') . '<br />' . chr(10); ?></td>
                </tr>
                 <tr>
                    <td width="40%"><span class="form_label" ><?php echo GEN_CONTACT; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('bill_contact', $order->bill_contact, 'size="33" maxlength="32" onfocus="clearField(\'bill_contact\', \'' . GEN_CONTACT . '\')" onblur="setField(\'bill_contact\', \'' . GEN_CONTACT . '\')"', ADDRESS_BOOK_CONTACT_REQUIRED) . '<br />' . chr(10); ?></td>
                </tr>
                 <tr>
                    <td width="40%"><span class="form_label" ><?php echo GEN_ADDRESS1; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('bill_address1', $order->bill_address1, 'size="33" maxlength="32" onfocus="clearField(\'bill_address1\', \'' . GEN_ADDRESS1 . '\')" onblur="setField(\'bill_address1\', \'' . GEN_ADDRESS1 . '\')"', ADDRESS_BOOK_ADDRESS1_REQUIRED) . '<br />' . chr(10); ?></td>
                </tr>
                 <tr>
                    <td width="40%"><span class="form_label" ><?php echo GEN_ADDRESS2; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('bill_address2', $order->bill_address2, 'size="33" maxlength="32" onfocus="clearField(\'bill_address2\', \'' . GEN_ADDRESS2 . '\')" onblur="setField(\'bill_address2\', \'' . GEN_ADDRESS2 . '\')"', ADDRESS_BOOK_ADDRESS2_REQUIRED) . '<br />' . chr(10); ?></td>
                </tr>
                 <tr>
                    <td width="40%"><span class="form_label" ><?php echo GEN_CITY_TOWN; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('bill_city_town', $order->bill_city_town, 'size="25" maxlength="24" onfocus="clearField(\'bill_city_town\', \'' . GEN_CITY_TOWN . '\')" onblur="setField(\'bill_city_town\', \'' . GEN_CITY_TOWN . '\')"', ADDRESS_BOOK_CITY_TOWN_REQUIRED) . chr(10); ?></td>
                </tr>
                 <tr>
                    <td width="40%"><span class="form_label" ><?php echo GEN_STATE_PROVINCE; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('bill_state_province', $order->bill_state_province, 'size="3" maxlength="5" onfocus="clearField(\'bill_state_province\', \'' . GEN_STATE_PROVINCE . '\')" onblur="setField(\'bill_state_province\', \'' . GEN_STATE_PROVINCE . '\')"', ADDRESS_BOOK_STATE_PROVINCE_REQUIRED) . chr(10); ?></td>
                </tr>
                 <tr>
                    <td width="40%"><span class="form_label" ><?php echo GEN_POSTAL_CODE; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('bill_postal_code', $order->bill_postal_code, 'size="11" maxlength="10" onfocus="clearField(\'bill_postal_code\', \'' . GEN_POSTAL_CODE . '\')" onblur="setField(\'bill_postal_code\', \'' . GEN_POSTAL_CODE . '\')"', ADDRESS_BOOK_POSTAL_CODE_REQUIRED) . '<br />' . chr(10); ?></td>
                </tr>
                 <tr>
                    <td width="40%"><span class="form_label" >Country </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_pull_down_menu('bill_country_code', gen_get_countries(), $order->bill_country_code ? $order->bill_country_code : COMPANY_COUNTRY) . '<br />' . chr(10); ?></td>
                </tr>
                 <tr>
                    <td width="40%"><span class="form_label" ><?php echo GEN_TELEPHONE1; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('bill_telephone1', $order->bill_telephone1, 'size="21" maxlength="20" onfocus="clearField(\'bill_telephone1\', \'' . GEN_TELEPHONE1 . '\')" onblur="setField(\'bill_telephone1\', \'' . GEN_TELEPHONE1 . '\')"', ADDRESS_BOOK_TELEPHONE1_REQUIRED) . chr(10); ?></td>
                </tr>
                 <tr>
                    <td width="40%"><span class="form_label" ><?php echo GEN_EMAIL ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"> <?php echo html_input_field('bill_email', $order->bill_email, 'size="35" maxlength="48" onfocus="clearField(\'bill_email\', \'' . GEN_EMAIL . '\')" onblur="setField(\'bill_email\', \'' . GEN_EMAIL . '\')"', ADDRESS_BOOK_EMAIL_REQUIRED) . chr(10); ?></td>
                </tr>
             </table>
         </td>    
         <td width="50%">
             <table width="100%">
                 <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_SUBTOTAL ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('subtotal', $currencies->format($order->subtotal, true, $order->currencies_code, $order->currencies_value), 'readonly="readonly" size="15" maxlength="20" style="text-align:right"'); ?></td>
                </tr>
                <?php
                ...
                <tr>
                    <td>
                        <?php $hidden_fields .= html_hidden_field('disc_gl_acct_id', '') . chr(10); ?>
                    </td>
                </tr>
                 <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_DISCOUNT_PERCENT ?></span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('disc_percent', ($order->disc_percent ? number_format(100 * $order->disc_percent, 3) : '0'), 'size="7" maxlength="6" onchange="calculateDiscountPercent()" style="text-align:right"') . ' '; ?></td>
                </tr>
                 <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_AMOUNT ?></span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('discount', $currencies->format(($order->discount ? $order->discount : '0'), true, $order->currencies_code, $order->currencies_value), 'size="15" maxlength="20" onchange="calculateDiscount()" style="text-align:right"'); ?></td>
                </tr>
                    <?php   } else {?>
                <tr>
                    <td>
                 ...
                 <tr>
                    <td width="40%"><span class="form_label" ><?php echo ORD_SALES_TAX  ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo  html_input_field('sales_tax', $currencies->format(($order->sales_tax ? $order->sales_tax : '0.00'), true, $order->currencies_code, $order->currencies_value), 'readonly="readonly" size="15" maxlength="20" onchange="updateTotalPrices()" style="text-align:right"'); ?></td>
                </tr>
                 <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_TOTAL  ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('total', $currencies->format($order->total_amount, true, $order->currencies_code, $order->currencies_value), 'readonly="readonly" size="15" maxlength="20" style="text-align:right"'); ?></td>
                </tr>
                 <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_AMOUNT_PAID   ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo  html_input_field('pmt_recvd', $currencies->format($order->pmt_recvd), 'readonly="readonly" size="15" maxlength="20" style="text-align:right"'); ?></td>
                </tr>
                 <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_BALANCE_DUE   ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('bal_due', $currencies->format($order->bal_due), 'readonly="readonly" size="15" maxlength="20" style="text-align:right"'); ?></td>
                </tr>
                 <tr>
                     <td colspan="3">
                         <?php echo html_button_field('payment', TEXT_PAYMENT, 'onclick="centerPopup(), popupPayment()"'); ?>
                     </td>
                </tr>
                <tr>
                    <td colspan="3">
...
// add the help file index and build the toolbar
    ...
    <table width="300" align="center">
        ...
        <tr>
            ...
            <td><?php echo html_icon('ucbooks/pdficon_large.gif', TEXT_PRINT, 'large', 'onclick="SavePayment(\'print\')"', 0, 0, 'btn_save'); ?></td>
        </tr>
