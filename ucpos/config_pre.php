...
if (defined('MODULE_UCPOS_STATUS')) {
    ...
    $menu[] = array(
        ...
        'rank' => 10,
        'security_id' => '132',
        'link' => html_href_link(FILENAME_DEFAULT, 'module=bank_transfer&amp;page=status&amp;jID=33&amp;list=1', 'SSL'),
    );
    ...
    $menu[] = array(
        ...
        'rank' => 20,
        'security_id' => '131',
        'link' => html_href_link(FILENAME_DEFAULT, 'module=bank_transfer&amp;page=status&amp;jID=34&amp;list=1', 'SSL'),
    );
    $menu[] = array(
        'text' => 'Spend money',
        'menu_select' => 'banking',
        ...
        'rank' => 20,
        'security_id' => '127',
        'link' => html_href_link(FILENAME_DEFAULT, 'module=bank_transfer&amp;page=status&amp;jID=35&amp;list=1', 'SSL'),
    );
