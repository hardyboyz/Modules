...
define('GEN_VENDOR_ID', 'Supplier ID:');
...
define('ACT_C_ID_NUMBER','GST Number');
define('ACT_C_REP_ID','Sales Rep ID');
define('ACT_C_ACCOUNT_NUMBER','Reg Number');
...
// Text specific to UcCRM
define('ACT_I_TYPE_NAME','Contacts');
define('ACT_I_HEADING_TITLE','CRM');
...
define('ACT_V_ID_NUMBER','GST Number');
define('ACT_V_REP_ID','Purchase Rep ID');
define('ACT_V_ACCOUNT_NUMBER','Reg Number');
...
define('ACT_PAYMENT_MESSAGE','Enter the payment information to be stored in UcBooks.');
