...
define('MODULE_CONTACTS_DESCRIPTION','The contacts module manages all customer, Suppliers, employees, branches and projects used in the UcSoft Business Toolkit. <b>NOTE: This is a core module and should not be removed!</b>');
// Headings
...
define('TEXT_VENDOR','Suppliers');
define('TEXT_EMPLOYEE','Employee');
define('TEXT_CONTACT_TYPE','Contact Type');
define('NEXT_CUST_ID_NUM_DESC','Next Customer ID');
define('NEXT_VEND_ID_NUM_DESC','Next Suppliers ID');
define('NEXT_DO_NUM_DESC','Next Delivery Number');
define('NEXT_PUR_NUM_DESC','Next Purchase Number');
define('NEXT_DM_NUM_DESC','Next Customer Debit Note Number');
define('NEXT_VDM_NUM_DESC','Next Vendor Debit Note Number');
define('NEXT_EXPENSES_NUM_DESC','Next Expenses Number');
define('SALES_CUST_DEPOSIT_DESC','Next Customer Deposite Number');
define('BANK_TRANSFER_DESC','Next Bank Transfer Number');
define('RECEIVED_MONEY_DESC','Next Received Money Number');
define('SPEND_MONEY_DESC','Next Spend Money Number');
