  ...
  <tr class="<?php echo $odd?'odd':'even'; ?>" style="cursor:pointer">
	...
	<?php switch (JOURNAL_ID) {
		...
		case 13:
                case 31:    
			switch (JOURNAL_ID) {
				case  6: $search_journal = 4; $search_sub_journal = 0;  break;
				case  7: 
                                case 31: $search_journal = 6; $search_sub_journal = 0; break;
				case 12: $search_journal = 10;$search_sub_journal = 0; break;
                                case 30:
				case 13: $search_journal = 12; $search_sub_journal = 0; break; // this was changed by shaheen ( to jID=10) then again change this to JID=12 for show all open invoice againest customer  
                                 
			}
			$open_order_array = $cInfo->load_open_orders($acct_id, $search_journal,true,'',$search_sub_journal);
			if ($open_order_array) {
