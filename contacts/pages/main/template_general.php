                ...
                <table style="width:40%">
                    <tr>
                        ...
                        <td style="width: 56%">
                            ...
                            <?php
                                echo  html_input_field("address[$type" . "m][primary_name]", $cInfo->address[$type . "m"]['primary_name'], 'size="49"', true) . '</td></tr>' . chr(10);
                            ?>
                        </td>
                    </tr>
            ...
            <td width="33%" style="padding-right:10px !important;">
                <table style="width:100%">
                    ...
                    <tr>
                        ...
                        <td width="56%">
                            <?php echo html_input_field('contact_first', $cInfo->contact_first, 'size="33"', false); ?>
                        </td>
                    </tr>
                </table>
            </td>
            <td width="33%" style="padding-right:10px !important;">
                <table style="width:100%">
                    <tr>
                        ...
                        <td width="56%">
                            <?php echo html_input_field('contact_middle', $cInfo->contact_middle, 'size="33"', false); ?>
                        </td>
                    </tr>
                </table>
            </td>
            <td width="33%">
                <table style="width:100%">
                    <tr>
                        ...
                        <td width="56%">
                            <?php echo html_input_field('contact_last', $cInfo->contact_last, 'size="33"', false); ?>
                        </td>
                    </tr>
                </table>
            </td>
