...
?>
  ...
  <?php // *********************** Mailing/Main Address (only one allowed) ****************************** ?>
    ...
    <h5><?php echo ACT_CATEGORY_I_ADDRESS; ?></h5>
    <br/><br/>
      <table class="ui-widget" style="border-collapse:collapse;width:100%;">
      <tr>
       <td>
      ...
      <tr>
          <td width='50%'>
              <table style="width: 100%">
                  <tr>
                      <td width="40%"><span class="form_label" ><?php echo ACT_SHORT_NAME . html_hidden_field('i_id', ''); ?> </span></td>
                      <td width="4%">:</td>
                      <td width="56%"><?php echo html_input_field('i_short_name', $cInfo->i_short_name, 'size="21" maxlength="20"', true); ?></td>
                  </tr>
                  <tr>
                      <td width="40%"><span class="form_label" ><?php echo GEN_FIRST_NAME; ?> </span></td>
                      <td width="4%">:</td>
                      <td width="56%"><?php echo html_input_field('i_contact_first', $cInfo->i_contact_first, 'size="33" maxlength="32"', false); ?></td>
                  </tr>
                  <tr>
                      <td width="40%"><span class="form_label" ><?php echo ACT_ACCOUNT_NUMBER; ?> </span></td>
                      <td width="4%">:</td>
                      <td width="56%"><?php echo html_input_field('i_account_number', $cInfo->i_account_number, 'size="17" maxlength="16"'); ?></td>
                  </tr>
          ...
          <td width='50%'>
              <table style="width: 100%">
                  <tr>
                      <td width="40%"><span class="form_label" ><?php echo TEXT_TITLE; ?> </span><br/></td>
                      <td width="4%">:</td>
                      <td width="56%"><?php echo html_input_field('i_contact_middle', $cInfo->i_contact_middle, 'size="33" maxlength="32"', false); ?></td>
                  </tr>
                  <tr>
                      <td width="40%"><span class="form_label" ><?php echo GEN_LAST_NAME; ?> :</span></td>
                      <td width="4%">:</td>
                      <td width="56%"><?php echo html_input_field('i_contact_last', $cInfo->i_contact_last, 'size="33" maxlength="32"', false); ?></td>
                  </tr>
                  <tr>
                      <td width="40%"><span class="form_label" ><?php echo ACT_ID_NUMBER; ?> :</span></td>
                      <td width="4%">:</td>
                      <td width="56%"><?php echo html_input_field('i_gov_id_number', $cInfo->i_gov_id_number, 'size="17" maxlength="16"'); ?></td>
                  </tr>
              </table>
