...
<?php // ***********************  History Section  ****************************** ?>
    ...
    <h5><?php echo ACT_ACT_HISTORY; ?></h5>
    <br/><br/>
...
<br/><br/>
    ...
    <h5><?php echo ACT_ORDER_HISTORY; ?></h5>
    <br/><br/>
	  ...
	  <tr><td valign="top" width="50%">
	    ...
	    if ($result) {
		  ...
		  foreach ($result as $value) {
		    ...
		    echo '<td>';
			echo html_icon('actions/edit-find-replace.png', TEXT_EDIT,   'small', 'onclick="window.open(\'' . html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=orders&amp;action=edit&amp;jID=' . ($type == 'v' ? 4 : 10) . '&amp;oID=' . $value['id'], 'SSL') . '\',\'_blank\')"');
		    echo '<a href="' . html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=orders&amp;action=edit&amp;jID=' . ($type == 'v' ? 4 : 10) . '&amp;oID=' . $value['id'], 'SSL') . '">' . $value['purchase_invoice_id'] . '</a></td>';
	  ...
	  ?>
		...
		if ($result) {
		  ...
		  foreach ($result as $value) {
		    ...
		    echo '<tr class="'.($odd?"odd":"even").'">';
		    echo '<td>';
			echo html_icon('actions/edit-find-replace.png', TEXT_EDIT,   'small', 'onclick="window.open(\'' . html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=orders&amp;action=edit&amp;jID=' . $value['journal_id'] . '&amp;oID=' . $value['id'], 'SSL') . '\',\'_blank\')"');
		    echo '<a href="' . html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=orders&amp;action=edit&amp;jID=' . $value['journal_id'] . '&amp;oID=' . $value['id'], 'SSL') . '">' . $value['purchase_invoice_id'] . '</a></td>';
