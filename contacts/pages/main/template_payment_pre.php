                      ...
                      <td width="50%">
                          <table style="width: 100%">
                            <tr>
                                ...
                                <td width="4%">:</td>
                                <td width="56%">
                                    <?php echo html_input_field('payment_cc_name', $cInfo->payment_cc_name, 'size="50" maxlength="48"'); ?>
                      ...
                      <td width="50%">
                          <table style="width: 100%">
                              ...
                              <tr>
                                ...
                                <td width="4%">:</td>
                                <td width="56%"><?php echo html_input_field('payment_cc_number', $cInfo->payment_cc_number, 'size="20" maxlength="19"'); ?></td>
                            </tr>
                            <tr>
                                <td width="40%"></td>
                                <td width="4%"></td>
