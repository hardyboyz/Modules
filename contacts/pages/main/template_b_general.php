  ...
  <fieldset>
    ...
    <table>
      <tr>
        ...
        <td><?php echo html_input_field('short_name', $cInfo->short_name, 'size="21"', true); ?></td>
        <td align="right"><?php echo GEN_PRIMARY_NAME ?></td>
        <td><?php
                echo  html_input_field("address[$type" . "m][primary_name]", $cInfo->address[$type . "m"]['primary_name'], 'size="49" ', true) . '' . chr(10);
            ?></td>
      ...
      <tr>
        ...
        <td><?php echo html_input_field('contact_first', $cInfo->contact_first, 'size="33" ', false); ?></td>
        <td align="right"><?php echo GEN_MIDDLE_NAME; ?></td>
        <td><?php echo html_input_field('contact_middle', $cInfo->contact_middle, 'size="33"', false); ?></td>
        <td align="right"><?php echo GEN_LAST_NAME; ?></td>
        <td><?php echo html_input_field('contact_last', $cInfo->contact_last, 'size="33"', false); ?></td>
      </tr>
    </table>
  </fieldset>
