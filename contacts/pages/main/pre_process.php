...
if($_GET['f0']==0){
    $cInfo->help = '07.03.02.05';
}
if($sub_menu_select=='vendor_manager'){
    $cInfo->help = '07.02.02';
}
if($action=='new' && $sub_menu_select=='vendor_manager'){
    $cInfo->help = '07.02.02.01';
}
if($action=='edit' && $sub_menu_select=='vendor_manager'){
    $cInfo->help = '07.02.02.02';
}
if($_GET['module']=='contacts' && $_GET['page']=='main' && $action!='new'){
    $cInfo->help = '07.03.02';
}
if($_GET['module']=='contacts' && $_GET['page']=='main' && $action=='new'){
    $cInfo->help = '07.03.02.01';
}
if($_GET['module']=='contacts' && $_GET['page']=='main' && $action=='edit'){
    $cInfo->help = '07.03.02.02';
}
if($_GET['module']=='contacts' && $_GET['page']=='main' && $type=='e'){
    $cInfo->help = '07.07';
}
if($_GET['module']=='contacts' && $_GET['page']=='main' && $action=='edit' && $tyle='e'){
    $cInfo->help = '07.07.01.02';
}
if($_GET['module']=='contacts' && $_GET['page']=='main' && $action=='new' && $type=='e'){
    $cInfo->help = '07.07.01.01';
}
if($sub_menu_select=='branch_manager'){
     $cInfo->help = '07.08.04';
}
