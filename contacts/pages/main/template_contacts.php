          ...
          <td width='50%'>
              <table style="width: 100%">
                  <tr>
                      ...
                      <td width="4%">:</td>
                      <td width="56%"><?php echo html_input_field('i_short_name', $cInfo->i_short_name, 'size="21"', true); ?></td>
                  </tr>
                  <tr>
                      <td width="40%"><span class="form_label" ><?php echo GEN_FIRST_NAME; ?> </span></td>
                      <td width="4%">:</td>
                      <td width="56%"><?php echo html_input_field('i_contact_first', $cInfo->i_contact_first, 'size="33"', false); ?></td>
                  </tr>
                  <tr>
                      <td width="40%"><span class="form_label" ><?php echo ACT_ACCOUNT_NUMBER; ?> </span></td>
                      <td width="4%">:</td>
                      <td width="56%"><?php echo html_input_field('i_account_number', $cInfo->i_account_number, 'size="17"'); ?></td>
                  </tr>
          ...
          <td width='50%'>
              <table style="width: 100%">
                  <tr>
                      ...
                      <td width="4%">:</td>
                      <td width="56%"><?php echo html_input_field('i_contact_middle', $cInfo->i_contact_middle, 'size="33" ', false); ?></td>
                  </tr>
                  <tr>
                      <td width="40%"><span class="form_label" ><?php echo GEN_LAST_NAME; ?> :</span></td>
                      <td width="4%">:</td>
                      <td width="56%"><?php echo html_input_field('i_contact_last', $cInfo->i_contact_last, 'size="33"', false); ?></td>
                  </tr>
                  <tr>
                      <td width="40%"><span class="form_label" ><?php echo ACT_ID_NUMBER; ?> :</span></td>
                      <td width="4%">:</td>
                      <td width="56%"><?php echo html_input_field('i_gov_id_number', $cInfo->i_gov_id_number, 'size="17"'); ?></td>
                  </tr>
              </table>
