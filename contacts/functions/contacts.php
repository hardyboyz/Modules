...
//echo 'entries = '; print_r($entries); echo '<br>';
    ...
    if (!$short) {
        if ($method != 'm') {
            ...
            $field .= html_input_field("address[$add_type][primary_name]", $entries->address[$add_type]['primary_name'], 'size="49"', true) . '</td></tr>' . chr(10);
        }
        ...
        $field .= html_input_field("address[$add_type][contact]", $entries->address[$add_type]['contact'], 'size="33"', ADDRESS_BOOK_CONTACT_REQUIRED) . '</td></tr>' . chr(10);
        $field .= ' <tr><td width="40%"> <span class="form_label" >' . GEN_ADDRESS1 . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
        $field .= html_input_field("address[$add_type][address1]", $entries->address[$add_type]['address1'], 'size="33" ', ADDRESS_BOOK_ADDRESS1_REQUIRED) . '</td></tr>' . chr(10);
        $field .= ' <tr><td width="40%"> <span class="form_label" >' . GEN_ADDRESS2 . ' :</span></td><td width="4%">:</td><td width="56%">' . chr(10);
        $field .= html_input_field("address[$add_type][address2]", $entries->address[$add_type]['address2'], 'size="33"', ADDRESS_BOOK_ADDRESS2_REQUIRED) . '</td></tr>' . chr(10);
        $field .= ' <tr><td width="40%"><span class="form_label" >' . GEN_CITY_TOWN . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
        $field .= html_input_field("address[$add_type][city_town]", $entries->address[$add_type]['city_town'], 'size="25"', ADDRESS_BOOK_CITY_TOWN_REQUIRED) . '</td></tr>' . chr(10);
        $field .= ' <tr><td width="40%"> <span class="form_label" >' . GEN_STATE_PROVINCE . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
        $field .= html_input_field("address[$add_type][state_province]", $entries->address[$add_type]['state_province'], 'size="25"', ADDRESS_BOOK_STATE_PROVINCE_REQUIRED) . '</td></tr>' . chr(10);
        $field .= '<tr><td width="40%">  <span class="form_label" >' . GEN_POSTAL_CODE . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
        $field .= html_input_field("address[$add_type][postal_code]", $entries->address[$add_type]['postal_code'], 'size="11"', ADDRESS_BOOK_POSTAL_CODE_REQUIRED) . '</td></tr>' . chr(10);
        if ($method <> 'm' || ($add_type == 'im' && substr($add_type, 0, 1) <> 'i')) {
    ...
    $field .= html_input_field("address[$add_type][telephone1]", $entries->address[$add_type]['telephone1'], 'size="21"', ADDRESS_BOOK_TELEPHONE1_REQUIRED) . '</td></tr>' . chr(10);
    $field .= ' <tr><td width="40%">  <span class="form_label" >' . GEN_TELEPHONE2 . ' </span> </td><td width="4%">:</td><td width="56%">' . chr(10);
    $field .= html_input_field("address[$add_type][telephone2]", $entries->address[$add_type]['telephone2'], 'size="21"') . '</td></tr>' . chr(10);
    $field .= ' <tr><td width="40%"> <span class="form_label" >' . GEN_FAX . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
    $field .= html_input_field("address[$add_type][telephone3]", $entries->address[$add_type]['telephone3'], 'size="21"') . '</td></tr>' . chr(10);
    $field .= '  <tr><td width="40%"><span class="form_label" >' . GEN_TELEPHONE4 . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
    $field .= html_input_field("address[$add_type][telephone4]", $entries->address[$add_type]['telephone4'], 'size="21"') . '</td></tr>' . chr(10);
    $field .= '  <tr><td width="40%"><span class="form_label" >' . GEN_EMAIL . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
    $field .= html_input_field("address[$add_type][email]", $entries->address[$add_type]['email'], 'size="51"') . '</td></tr>' . chr(10);
    $field .= '  <tr><td width="40%"><span class="form_label" >' . GEN_WEBSITE . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
    $field .= html_input_field("address[$add_type][website]", $entries->address[$add_type]['website'], 'size="51"') . '</td></tr>' . chr(10);
