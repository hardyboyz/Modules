...
//echo 'entries = '; print_r($entries); echo '<br>';
    ...
    $field .= '<tr><td width="50%" style="padding-right: 10px !important;"><table style="width:100%">' . chr(10);
    if (!$short) {
        if ($method != 'm') {
            $field .= '<tr><td width="40%"> <span class="form_label" >' . GEN_PRIMARY_NAME . ' </span> </td><td width="4%">:</td><td width="56%">' . chr(10);
            $field .= html_input_field("address[$add_type][primary_name]", $entries->address[$add_type]['primary_name'], 'size="49" maxlength="48"', true) . '</td></tr>' . chr(10);
        }

        $field .= '<tr><td width="40%"> <span class="form_label" >' . GEN_CONTACT . html_hidden_field("address[$add_type][address_id]", $entries->address[$add_type]['address_id']) . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
        $field .= html_input_field("address[$add_type][contact]", $entries->address[$add_type]['contact'], 'size="33" maxlength="32"', ADDRESS_BOOK_CONTACT_REQUIRED) . '</td></tr>' . chr(10);
        $field .= ' <tr><td width="40%"> <span class="form_label" >' . GEN_ADDRESS1 . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
        $field .= html_input_field("address[$add_type][address1]", $entries->address[$add_type]['address1'], 'size="33" maxlength="32"', ADDRESS_BOOK_ADDRESS1_REQUIRED) . '</td></tr>' . chr(10);
        $field .= ' <tr><td width="40%"> <span class="form_label" >' . GEN_ADDRESS2 . ' :</span></td><td width="4%">:</td><td width="56%">' . chr(10);
        $field .= html_input_field("address[$add_type][address2]", $entries->address[$add_type]['address2'], 'size="33" maxlength="32"', ADDRESS_BOOK_ADDRESS2_REQUIRED) . '</td></tr>' . chr(10);
        $field .= ' <tr><td width="40%"><span class="form_label" >' . GEN_CITY_TOWN . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
        $field .= html_input_field("address[$add_type][city_town]", $entries->address[$add_type]['city_town'], 'size="25" maxlength="24"', ADDRESS_BOOK_CITY_TOWN_REQUIRED) . '</td></tr>' . chr(10);
        $field .= ' <tr><td width="40%"> <span class="form_label" >' . GEN_STATE_PROVINCE . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
        $field .= html_input_field("address[$add_type][state_province]", $entries->address[$add_type]['state_province'], 'size="25" maxlength="24"', ADDRESS_BOOK_STATE_PROVINCE_REQUIRED) . '</td></tr>' . chr(10);
        $field .= '<tr><td width="40%">  <span class="form_label" >' . GEN_POSTAL_CODE . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
        $field .= html_input_field("address[$add_type][postal_code]", $entries->address[$add_type]['postal_code'], 'size="11" maxlength="10"', ADDRESS_BOOK_POSTAL_CODE_REQUIRED) . '</td></tr>' . chr(10);
        if ($method <> 'm' || ($add_type == 'im' && substr($add_type, 0, 1) <> 'i')) {

            $field .= ' <tr><td width="40%"> <span class="form_label" >' . TEXT_NOTES . ' :</span></td><td width="4%">:</td><td width="56%">' . chr(10);
            $field .= html_textarea_field("address[$add_type][notes]", 42, 3, $entries->address[$add_type]['notes']) . chr(10);
            if ($reset_button)
                $field .= html_icon('actions/view-refresh.png', TEXT_RESET, 'small', 'onclick="clearAddress(\'' . $add_type . '\')"</td></tr>') . chr(10);
        }
    }
    $field .='</table></td>';

    $field .='<td width="50%" style="padding-right: 10px !important;"> <table style="width:100%">';
    $field .= '  <tr><td width="40%"> <span class="form_label" >' . GEN_TELEPHONE1 . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
    $field .= html_input_field("address[$add_type][telephone1]", $entries->address[$add_type]['telephone1'], 'size="21" maxlength="20"', ADDRESS_BOOK_TELEPHONE1_REQUIRED) . '</td></tr>' . chr(10);
    $field .= ' <tr><td width="40%">  <span class="form_label" >' . GEN_TELEPHONE2 . ' </span> </td><td width="4%">:</td><td width="56%">' . chr(10);
    $field .= html_input_field("address[$add_type][telephone2]", $entries->address[$add_type]['telephone2'], 'size="21" maxlength="20"') . '</td></tr>' . chr(10);
    $field .= ' <tr><td width="40%"> <span class="form_label" >' . GEN_FAX . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
    $field .= html_input_field("address[$add_type][telephone3]", $entries->address[$add_type]['telephone3'], 'size="21" maxlength="20"') . '</td></tr>' . chr(10);
    $field .= '  <tr><td width="40%"><span class="form_label" >' . GEN_TELEPHONE4 . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
    $field .= html_input_field("address[$add_type][telephone4]", $entries->address[$add_type]['telephone4'], 'size="21" maxlength="20"') . '</td></tr>' . chr(10);
    $field .= '  <tr><td width="40%"><span class="form_label" >' . GEN_EMAIL . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
    $field .= html_input_field("address[$add_type][email]", $entries->address[$add_type]['email'], 'size="51" maxlength="50"') . '</td></tr>' . chr(10);
    $field .= '  <tr><td width="40%"><span class="form_label" >' . GEN_WEBSITE . ' </span></td><td width="4%">:</td><td width="56%">' . chr(10);
    $field .= html_input_field("address[$add_type][website]", $entries->address[$add_type]['website'], 'size="51" maxlength="50"') . '</td></tr>' . chr(10);
    $field .= '  <tr><td width="40%"><span class="form_label" >' . GEN_COUNTRY . ' </span> </td><td width="4%">:</td><td width="56%">' . chr(10);
    $field .= html_pull_down_menu("address[$add_type][country_code]", gen_get_countries(), $entries->address[$add_type]['country_code'] ? $entries->address[$add_type]['country_code'] : COMPANY_COUNTRY) . '</td></tr>' . chr(10);
