...
class contacts_admin {
  function __construct() {
    ...
    $this->keys = array(
	  ...
	  'ADDRESS_BOOK_ADDRESS1_REQUIRED'       => '0',
	  'ADDRESS_BOOK_ADDRESS2_REQUIRED'       => '0',
	  'ADDRESS_BOOK_CITY_TOWN_REQUIRED'      => '0',
	  'ADDRESS_BOOK_STATE_PROVINCE_REQUIRED' => '0',
	  'ADDRESS_BOOK_POSTAL_CODE_REQUIRED'    => '0',
	...
	$this->tables = array(
	  TABLE_ADDRESS_BOOK => "CREATE TABLE " . TABLE_ADDRESS_BOOK . " (
		  ...
		  city_town varchar(255) NOT NULL default '',
	  ...
	  TABLE_CONTACTS => "CREATE TABLE " . TABLE_CONTACTS . " (
		  ...
		  contact_middle varchar(255) default NULL,
