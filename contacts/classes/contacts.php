...
class contacts {
  ...
  function load_open_orders($acct_id, $journal_id, $only_open = true, $limit = 0,$search_sub_journal = 0) {
  	global $db;
  	...
  	$sql .= " journal_id in (" . $journal_id . ") and sub_journal_id = ".$search_sub_journal." and bill_acct_id = " . $acct_id . ' order by post_date DESC';
