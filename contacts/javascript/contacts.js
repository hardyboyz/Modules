...
function TermsList() {
  ...
  window.open("index.php?module=contacts&page=popup_terms&type="+account_type+"&val="+terms,"terms","width=1150px,height=300px,resizable=1,scrollbars=1,top=150,left=100");
}
...
function downloadAttachment(filename) {
  ...
  $.ajax({
	type: "GET",
	url: 'index.php?module=ucounting&page=ajax&op=ucounting&action=download&file='+file_name,
	dataType: ($.browser.msie) ? "text" : "xml",
	error: function(XMLHttpRequest, textStatus, errorThrown) {
