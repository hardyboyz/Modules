...
function priceMgr(rowID, itemID) {
	...
	window.open('index.php?module=inventory&page=popup_price_mgr&iID='+itemID+'&cost='+rowCost+'&price='+rowPrice,"price_mgr","width=1150,height=400,resizable=1,scrollbars=1,top=150,left=100");
}
