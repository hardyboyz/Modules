<style type="text/css">
    .ui-widget-content.input input{width: 130px!important;}
...
$toolbar->icon_list['cancel']['params'] = 'onclick="index.php?module=inventory&page=price_sheets&type=c&list=1&sf=&so=&"';
...
<table width="100%" class="ui-widget">
    ...
    <tr>
        <td width="50%">
            <table width="100%">
                <tr>
                    <td width="40%"><span class="form_label" ><?php echo PRICE_SHEET_NAME; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('sheet_name', $sheet_name, '', false); ?><br/><br/></td>
                </tr>
                <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_EFFECTIVE_DATE; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_calendar_field($cal_ps); ?></td>
                </tr>
        ...
        <td width="50%">
            <table width="100%">
                <tr>
                    ...
                    <td width="4%">:</td>
                    <td width="56%"><?php echo html_input_field('revision', $revision, 'readonly="readonly" size="5"', false); ?><br/><br/></td>
                </tr>
                <tr>
                    <td width="40%"><span class="form_label" ><?php echo TEXT_USE_AS_DEFAULT; ?> </span></td>
                    <td width="4%">:</td>
                    <td width="56%"> <?php echo html_checkbox_field('default_sheet', '1', ($default_sheet) ? ' checked' : ''); ?></td>
                </tr>
...
<?php if (ENABLE_MULTI_CURRENCY) echo '<tr><td colspan="4" class="fieldRequired" align="center"> ' . sprintf(GEN_PRICE_SHEET_CURRENCY_NOTE, $currencies->currencies[DEFAULT_CURRENCY]['title']) . '</td></tr>'; ?>
  <tr>
	...
	for ($i = 0, $j = 1; $i < MAX_NUM_PRICE_LEVELS; $i++, $j++) {
		...
		echo '<td>' . html_input_field('adj_val_' . $j, $adj_val, 'disabled="disabled" size="10" onchange="updatePrice()" style="text-align:right"') . '</td>' . chr(10);
