...
if($_GET['type'] == 'v'){
     $btn_text = "+ New Price Sheet";
}else if($_GET['type'] == 'c'){
    $btn_text = "+ New Customer Price Sheet";
}

if ($security_level > 1) $toolbar->add_icon('new', 'onclick="submitToDo(\'new\')"', $order = 0, $btn_text);
...
<!--    <thead class="ui-widget-header">
    ...
    <thead class="ui-widget-hewidgetader">   
        <tr style="height: 36px;" > 
            <th class="ui-state-default" style="padding: 8px 0 0 0;" ><?php echo TEXT_SHEET_NAME ?></th>
            <th class="ui-state-default"><?php echo TEXT_INACTIVE ?></th>
            <th class="ui-state-default"><?php echo TEXT_REVISION ?></th>
            <th class="ui-state-default"><?php echo TEXT_DEFAULT ?></th>
            <th class="ui-state-default"><?php echo TEXT_EFFECTIVE_DATE ?></th>
            <th class="ui-state-default"><?php echo TEXT_EXPIRATION_DATE ?></th>
