...
<table class="ui-widget" style="border-collapse:collapse;width:100%">
    ...
    <tbody class="ui-widget-content">
        ...
        while (!$query_result->EOF) {
            ...
            ?>
            <?php if ($query_result->fields['inventory_type'] == 'ms' && (JOURNAL_ID == 4 || JOURNAL_ID == 6)) { ?>
                <tr class="<?php echo $odd ? 'odd' : 'even'; ?>" style="cursor:pointer" onclick="setReturnMasterItem(<?php echo $query_result->fields['id']; ?>,<?php echo $_GET['rowID'] ?>)">
                <?php } else { ?>
