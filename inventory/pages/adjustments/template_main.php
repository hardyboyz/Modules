...
$toolbar->add_icon('new', 'onclick="location.href = \'' . html_href_link(FILENAME_DEFAULT, 'module=inventory&amp;page=adjustments&amp;action=new&jID=' . JOURNAL_ID, 'SSL') . '\'"', 2, '+ New Adjustment');
    ...
    <table class="ui-widget" id="example" style="border-collapse:collapse;width:100%">
        ...
        <thead class="ui-widget-hewidgetader">   
            <tr style="height: 36px; text-align: center !important;" > 
                ...
                <th class="ui-state-default">Reason for Adjustment</th>
                <th class="ui-state-default">Adjustment Account</th>
