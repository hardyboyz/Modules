...
$pro_result = $db->Execute('SELECT * FROM '.TABLE_PRODUCT_CATEGORY.'');
$pro_index = 0;
while(!$pro_result->EOF){
//    if($pro_index==0){
//        $product_category[] = array('id' => '', 'text' => '<input type="text" name="pro_cat" placeholder="add category" id="pro_cat">');
//        $pro_index++;
//    }
    $product_category[] = array('id' => $pro_result->fields['cat_name'], 'text' => $pro_result->fields['cat_name']);
  //  $product_category[$pro_result->fields['id']] = $pro_result->fields['cat_name'];
    $pro_result->MoveNext();
}
