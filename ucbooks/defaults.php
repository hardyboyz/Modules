...
// +-----------------------------------------------------------------+
//  Path: /modules/ucbooks/defaults.php
//
// default directory for order attachments
define('UCBOOKS_DIR_MY_ORDERS',  DIR_FS_MY_FILES . $_SESSION['company'] . '/ucbooks/orders/');
// default for sorting on PAyBIlls and CUstomer Receipts listings
define('UCBOOKS_DEFAULT_BILL_SORT','invoice'); // choices are 'invoice', 'due_date'
