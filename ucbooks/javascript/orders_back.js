...
function ajaxOrderData(cID, oID, jID, open_order, ship_only, goods_return,recurring_invoice ) {
...
function addInvRow() {
    ...
    //this is for sku
    cell    = '<span class="input_container1"><input type="text" name="sku_'+rowCnt+'" id="sku_'+rowCnt+'" size="'+(max_sku_len+1)+'" maxlength="'+max_sku_len+'" autocomplete="off" onfocus="clearField(\'sku_'+rowCnt+'\', \''+text_search+'\')" onblur="setField(\'sku_'+rowCnt+'\', \''+text_search+'\'); loadSkuDetails(0, '+rowCnt+')" />&nbsp;';
    ...
    cell = '<input style="width:145px !important;" value="" readonly="readonly" onclick=\'window.open("index.php?count='+rowCnt+'&module=ucbooks&page=disc_msg","Description","height=500,width=750")\' name="desc_'+rowCnt+'" id="desc_'+rowCnt+'" size="'+((single_line_list=='1')?50:75)+'" maxlength="255" /> <input type="hidden" name="descHidden_'+rowCnt+'" id="descHidden_'+rowCnt+'" value=""  />';
    newCell = newRow.insertCell(-1);
    newCell.innerHTML = cell;
