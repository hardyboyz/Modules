...
// START Inventory Functions
    ...
    function Post_inventory() {
        ...
        switch ($this->journal_id) { // Pre-posting particulars that are journal dependent
            ...
            case 32:
                $str_field = 'quantity_on_hand';
                $so_po_str_field = 'quantity_on_delivery_order';
                $item_array = $this->load_so_po_balance($this->id);
                break;
            case 12:
            case 36:
...
//                            $adjustment = $this->journal_rows[$i]['qty'];
//                        $item_cost = ($this->journal_id == 4) ? $inv_list['price'] : 0;
//                        $full_price = ($this->journal_id == 32) ? $inv_list['price'] : 0;
//                        if (!$this->update_inventory_status($inv_list['sku'], $str_field, -$adjustment, $item_cost, $inv_list['description'], $full_price))
//                            return false;
                        break;
...
//                                if (empty($pstd)) {
//                                    if ($result1->fields['qty'] < $row['pstd']) {
//                                        $pstd = $row['pstd'] - $result1->fields['qty'];
//                                        $check_qty = true;
//                                    } else {
//                                        $pstd = $result1->fields['qty'] - $row['pstd'];
//                                        $check_qty = true;
//                                    }
//                                } else {
//                                    if ($result1->fields['qty'] < $pstd) {
//                                        $pstd = $pstd - $result1->fields['qty'];
//                                        $check_qty = true;
//                                    } else {
//                                        $pstd = $result1->fields['qty'] - $row['pstd'];
//                                        $check_qty = true;
...
//                                        $item_array[$so_po]['processed'] = $row['pstd'];
//                                    } else {
//                                        $item_array[$so_po]['processed'] = $result1->fields['qty'];
//                                    }
//                                    $check_pstd = true;
//                                } else {
//                                    $item_array[$so_po]['processed'] = $pstd;
//                                }
                            }
                        }
                    }
