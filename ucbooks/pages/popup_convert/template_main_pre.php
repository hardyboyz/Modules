...
// +-----------------------------------------------------------------+
//  Path: /modules/ucbooks/pages/popup_convert/template_main.php
//
...
<table class="ui-widget" style="border-style:none;width:100%">
 <tbody class="ui-widget-content">
  <tr>
   ...
   <tr>
	<td> <?php echo html_radio_field('conv_type', 'do', false, '', '') . ($jID == 3 ? ORD_CONVERT_TO_PO : ORD_CONVERT_TO_DO) . chr(10); ?></td>
	<td><?php echo ($jID == 3 ? ORD_HEADING_NUMBER_4 : ORD_HEADING_NUMBER_32) . html_input_field('do_num', $do_num, '') . '<br />' . chr(10); ?></td>
  </tr>
<?php if ($jID <> 3) { ?>
  <tr>
