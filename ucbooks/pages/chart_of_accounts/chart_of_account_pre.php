...
?>" href="<?php echo html_href_link(FILENAME_DEFAULT, 'module=ucounting&page=import_export&action_type=go_inventory', 'SSL') ?>"  rel="go_inventory"  isdone="1" rel="3">
        ...
        <?php
        echo html_form('chart_of_accounts', FILENAME_DEFAULT, 'module=ucbooks&page=chart_of_accounts', 'post', 'enctype="multipart/form-data"') . chr(10);
...
?>
<input type="hidden" name="page_name" value="chart_of_account" />
...
//  require (DIR_FS_MODULES . $module . '/pages/chart_of_accounts/template_tab_vendors.php');
    require (DIR_FS_MODULES . $module . '/pages/chart_of_accounts/template_tab_chart_of_accounts_dashboard.php');
