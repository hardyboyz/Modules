...
// +-----------------------------------------------------------------+
//  Path: /modules/ucbooks/pages/popup_recur/pre_process.php
//
...
switch (JOURNAL_ID) {
	...
	case  33:	// General Journal
	case  34:	// General Journal
	case  35:	// General Journal
	...
	case 12:	// Sales/Invoice Journal
		break;
	default:
		die('No valid journal id found (filename: modules/ucbooks/pages/popup_recur.php), Journal ID needs to be passed to this script to identify the correct procedure.');
}
