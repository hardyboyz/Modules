...
function addGLRow(debit, credit, description, tax_val) {
	...
	cell[1]  = '<td>';
	cell[1] += '<select style="width:300px;" name="acct_'+rowCnt+'" id="acct_'+rowCnt+'" onchange="updateDesc('+rowCnt+')"><\/select>&nbsp;';
	// Hidden fields
	cell[1] += '<input type="hidden" name="id_'+rowCnt+'" id="id_'+rowCnt+'" value="" />';
	// End hidden fields
	cell[2] = '<td><input style="width:350px !important;" type="text" name="desc_'+rowCnt+'" id="desc_'+rowCnt+'" value="'+description+'"><\/td>';
        ...
        cell[5] = '<td><input type="text" name="credit_'+rowCnt+'" id="credit_'+rowCnt+'" style="text-align:right" size="13" maxlength="12" value="'+credit+'"onchange="formatRow('+rowCnt+', \'c\')"><\/td>';
