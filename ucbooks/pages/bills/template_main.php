...
// +-----------------------------------------------------------------+
//  Path: /modules/ucbooks/pages/bills/template_main.php
//
...
if ($_GET['jID'] == 18) {
    $toolbar->icon_list['print']['params'] = 'onclick="window.open(\'' . html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=print_invoice&amp;oID=' . $_GET['oID'] . '&amp;jID=' . $_GET['jID'] . '&amp;action=pdf&amp;pdf_type=rec', 'SSL') . '\',\'_blank\')"';
    $toolbar->icon_list['print']['text'] = 'Generate Receipt PDF';
} else if ($_GET['jID'] == 20) {
    $toolbar->icon_list['print']['params'] = 'onclick="window.open(\'' . html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=print_invoice&amp;oID=' . $_GET['oID'] . '&amp;jID=' . $_GET['jID'] . '&amp;action=pdf&amp;pdf_type=pay_bill', 'SSL') . '\',\'_blank\')"';
    $toolbar->icon_list['print']['text'] = 'Generate Pay Bill PDF';
}
            ...
            <td width="50%">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td width="4%">:</td>
                        <td class="input_container" width="56%"><?php
    echo html_input_field('search', $order->bill_primary_name, 'onfocus="clearField(\'search\', \'' . GEN_PRIMARY_NAME . '\')" autocomplete="off"');
    echo '&nbsp;' . html_icon('actions/system-search.png', TEXT_SEARCH, 'small', 'align="top" style="cursor:pointer" onclick="AccountList()"');
    ?><ul id="customer_list"></ul></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="4%">:</td>
                        <td width="56%"><?php echo html_input_field('bill_primary_name', $order->bill_primary_name, 'size="33" onfocus="clearField(\'bill_primary_name\', \'' . GEN_PRIMARY_NAME . '\')" onblur="setField(\'bill_primary_name\', \'' . GEN_PRIMARY_NAME . '\')"') . chr(10); ?></td>
                    </tr>
                    <tr>
                        <td width="40%"><span class="form_label"><?php echo GEN_CONTACT; ?></span></td>
                        <td width="4%">:</td>
                        <td width="56%"><?php echo html_input_field('bill_contact', $order->bill_contact, 'size="33" onfocus="clearField(\'bill_contact\', \'' . GEN_CONTACT . '\')" onblur="setField(\'bill_contact\', \'' . GEN_CONTACT . '\')"') . chr(10); ?></td>
                    </tr>
                    <tr>
                        <td width="40%"><span class="form_label"><?php echo GEN_ADDRESS1; ?></span></td>
                        <td width="4%">:</td>
                        <td width="56%"><?php echo html_input_field('bill_address1', $order->bill_address1, 'size="33" onfocus="clearField(\'bill_address1\', \'' . GEN_ADDRESS1 . '\')" onblur="setField(\'bill_address1\', \'' . GEN_ADDRESS1 . '\')"') . chr(10); ?></td>
                    </tr>
                    <tr>
                        <td width="40%"><span class="form_label"><?php echo GEN_ADDRESS2; ?></span></td>
                        <td width="4%">:</td>
                        <td width="56%"><?php echo html_input_field('bill_address2', $order->bill_address2, 'size="33" onfocus="clearField(\'bill_address2\', \'' . GEN_ADDRESS2 . '\')" onblur="setField(\'bill_address2\', \'' . GEN_ADDRESS2 . '\')"') . chr(10); ?></td>
                    </tr>
                    <tr>
                        <td width="40%"><span class="form_label"><?php echo GEN_CITY_TOWN; ?></span></td>
                        <td width="4%">:</td>
                        <td width="56%"><?php echo html_input_field('bill_city_town', $order->bill_city_town, 'size="25" onfocus="clearField(\'bill_city_town\', \'' . GEN_CITY_TOWN . '\')" onblur="setField(\'bill_city_town\', \'' . GEN_CITY_TOWN . '\')"') . chr(10); ?></td>
                    </tr>
                    <tr>
                        <td width="40%"><span class="form_label"><?php echo GEN_STATE_PROVINCE; ?></span></td>
                        <td width="4%">:</td>
                        <td width="56%"><?php echo html_input_field('bill_state_province', $order->bill_state_province, 'size="3" onfocus="clearField(\'bill_state_province\', \'' . GEN_STATE_PROVINCE . '\')" onblur="setField(\'bill_state_province\', \'' . GEN_STATE_PROVINCE . '\')"') . chr(10); ?></td>
                    </tr>
                    <tr>
                        <td width="40%"><span class="form_label"><?php echo GEN_POSTAL_CODE; ?></span></td>
                        <td width="4%">:</td>
                        <td width="56%"><?php echo html_input_field('bill_postal_code', $order->bill_postal_code, 'size="11" onfocus="clearField(\'bill_postal_code\', \'' . GEN_POSTAL_CODE . '\')" onblur="setField(\'bill_postal_code\', \'' . GEN_POSTAL_CODE . '\')"') . chr(10); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="4%">:</td>
                        <td width="56%"><?php echo html_input_field('bill_email', $order->bill_email, 'size="40" onfocus="clearField(\'bill_email\', \'' . GEN_EMAIL . '\')" onblur="setField(\'bill_email\', \'' . GEN_EMAIL . '\')"') . chr(10); ?></td>
                    </tr>
                </table>
            </td>
            <td width="50%">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td width="56%">
                            <?php
                            echo html_input_field('total', $order->total_amount, 'readonly="readonly" size="15" style="text-align:right"');
                            ?>
                        </td>
                    </tr>
                ...
                <table width="100%">
                    ...
                    <?php if (JOURNAL_ID == 18) { ?>
                        ...
                        <tr>
                            ...
                            <td width="40%">
                                <?php
                                echo html_pull_down_menu('shipper_code', $dropdown_payment_modules, $order->shipper_code, 'onchange="activateFields()"') . chr(10);
                                ?>
                            </td>
                            <td width="56%">
                                <?php
                                ...
                                foreach ($payment_modules as $pmt_class) {
                                    $value = $pmt_class['id'];
                                    echo '          <div id="pm_' . $count . '" style="display:none; ">' . chr(10);
                                ...
                                foreach ($extra_payment_method as $key => $extra_method) {
                                    $counts = $count + $key;
                                    echo '          <div id="pm_' . $counts . '" style="display:none; ">' . chr(10);
                                    echo $extra_method['fields']['title'] . '<br />' . chr(10);
                                    echo $extra_method['fields']['field'] . '<br />' . chr(10);
                                    echo '          </div>' . chr(10);
                                }
                                ?>
                            </td>
                    ...
                    <?php } elseif (JOURNAL_ID == 20) { ?>
                        <tr>
                            ...
                            <td width="4%">:</td>
                            <td width="56%"><?php echo html_input_field('acct_balance', $currencies->format($acct_balance), 'readonly="readonly" size="15"  style="text-align:right"'); ?></td>
                        </tr>
                        <tr>
                            <td width="40%"><span class="form_label"><?php echo BNK_BALANCE_AFTER_CHECKS . '&nbsp;'; ?></span></td>
                            <td width="4%">:</td>
                            <td width="56%"><?php echo html_input_field('end_balance', $currencies->format($acct_balance), 'readonly="readonly" size="15" style="text-align:right"'); ?></td>
                        </tr>
        ...
        <tbody id="item_table" class="ui-widget-content">
            ...
            if ($order->id_1) {
                ...
                while (true) {
                    ...
                    echo '<td align="center">' . html_input_field($desc_num, $order->$desc_num, $extra_params . 'size="64"') . '</td>' . chr(10);
                    echo '<td align="center">' . html_input_field($dscnt_num, $currencies->format($currencies->clean_value($order->$dscnt_num)), $extra_params . 'size="15" onchange="updateRowTotal(' . $i . ')" style="text-align:right"') . '</td>' . chr(10);
                    echo '<td align="center">' . html_input_field($total_num, $currencies->format($currencies->clean_value($order->$total_num)), $extra_params . 'size="15" onchange="updateUnitPrice(' . $i . ')" style="text-align:right"') . '</td>' . chr(10);
