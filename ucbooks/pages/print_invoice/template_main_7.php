        ...
        <div style="width:30%; float:right; height:90px; border:1px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top"  >
                ...
                '</span>
							  ...
							  <tr><td>
                             <span style="font:12px arial"><b>Serial Number : </b></span></td><td> <span style="font:12px arial">'
                . $invoice_main->product_desc .
                '</span>
...
//end invoice pdf
	 ...
	 <div class="footer_area">
		...
		<td width="40%">
           <br> 
            ...
            <br>
            <span style="font:14px Arial;">
            Agreed to Repair: Please Chop and Sign
            </span>
        </td>
    ...
    <div class="footer_area">
        ...
        <table width = "100%" style"border:1px solid;">
            <tr>
                <td width="100%" style="background-color:#cccccc; font: bold 10px arial; text-align:center;">
                    <i>No signature is required as this is a computer generated form.</i>
                </td>
            </tr>
        </table>
