...
<style type="text/css">
    ...
    .adress_area{width: 17cm; height: 3cm; border: 1px solid;}
        .address_left{width: 5.96cm; height: 3cm; float: left; border-right: 1px solid; }
        .address_middle{width: 5.98cm; height: 5cm; float: left; border-right: 1px solid;}
        .address_right{width: 5cm; height: 3cm; float: left;}
...
if ($_GET['pdf_type'] == "do") {
    ...
    <br/>
    <div style="width:100%">
        <div style="width:50%; float:left; border:1px solid; height:80px; ">
        '.$shipping_info.'
            <!--<table width="100%" border="0" cellspacing="0" cellpadding="0" style=" " valign="top"  >
				...
				<tr>
                    <td style="font:12px arial;">
                         '.$invoice_main->bill_address1.', '.$invoice_main->bill_address2.' 
                    </td>
                </tr>
				
				 <tr>
                    <td style="font:12px arial;">
                         '.$invoice_main->bill_city_town.',  '.$invoice_main->bill_state_province.',  '.$invoice_main->bill_postal_code.',  '.$invoice_main->bill_country_code.'
                    </td>
                </tr>
        ...
        <div style="width:40%; float:right; height:80px; border:1px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top"  >
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:12px arial"><b>DO/INV Number : </b></span> 
                ...
                . '</span></td></tr><tr><td>
                            ...
                            <tr><td>
                             <span style="font:12px arial"><b>SO/Ref Num : </b></span></td><td> <span style="font:12px arial">'
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border-bottom:1px solid;">
        <tr>
		<td width="100%" height="7cm" valign="top" align"center" border="1" cellspacing="0" cellpadding="0" style=" border-bottom:1px solid;">
		
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border-bottom:1px solid;">
			<tr>
            <td width="6%" style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border: 1px solid;">Item</td>
            <td width="82%" style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border-right: 1px solid; border-bottom: 1px solid;border-top: 1px solid; ">Description</td>';
			...
			<tr>
            <td width="6%" style="border-bottom: none;border-right: 1px solid; border-left: 1px solid; padding: 5px;  font:12px arial">' . $i . '</td>
            <td width="82%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:12px arial">' . $item['description'] . '</td>';
            
            if(UOM == 1){
                $pdf .='<td width="10%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:12px arial">' . $item['uom'] . '</td>';
            }
            if(UOM_QTY == 1){
                $pdf .='<td width="10%" style="text-align: right; border-bottom: none;border-left: 1px solid; border-right:1px solid; padding: 5px; font:12px arial">' . (($item['uom_qty'] !=0) ? $item['uom_qty'] : 1) . '</td>';
            }
			$pdf .='<td width="10%" style="text-align: right; border-bottom: none;border-right: 1px solid; padding: 5px; font:12px arial">' . $item['qty'] . '</td></tr>
			';
            $i++;
			}
			$pdf .='</table>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border-bottom:1px solid;">
        ...
        <tr>
            <td width="100%" height="1.5cm" valign="top"  style="border-bottom: 1px;border-right: 1px solid; border-left: 1px solid; padding: 5px;  font:12px arial">
			<b>Note:</b><br>
			' . $message . '
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border-bottom:1px solid;">
        <tr>
            <td width="25%" style="background-color: #cccccc;font: bold 10px arial; text-align: center; height: 17px; padding-top: 3px; border: 1px solid;"><b>Authorised By:</b></td>
            <td width="25%" style="background-color: #cccccc;font: bold 10px arial; text-align: center; height: 17px; padding-top: 3px; border-right: 1px solid; border-bottom: 1px solid;border-top: 1px solid; "><b>Stock Keeper:</b></td>
            
        <td width="25%" style="background-color: #cccccc;font: bold 10px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid;"><b>Driver Signature:</b></td>
          
              <td width="25%" style="background-color: #cccccc;font: bold 10px arial; text-align: center; height: 17px; padding-top: 3px; border: 1px solid; "><b>Customer Signature and Chop:</b></td>
        ...
        <tr>
            <td width="25%" height="2cm" style="border-bottom: none;border-right: 1px solid; border-left: 1px solid; padding: 5px;  font:8px arial"></td>
            <td width="25%" height="2cm" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial"> </td>
            
            <td width="25%" valign="middle" height="2cm" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">Vehicle No: </td>
			
         <td width="25%" valign="bottom" height="2cm" style="border-bottom: none;border-left: 1px solid; border-right:1px solid; padding: 5px; font:8px arial"> 
		 Received in good order & Condition<br>
		 No claim for loss or damage<br>
        ...
        <div style="width:40%; float:right; height:80px; border:1px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top"  >
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:12px arial"><b>INV No: </b></span> 
                            </td><td><span style="font:12px arial">' .
                $invoice_main->purchase_invoice_id
                . '</span>
                            </td>
                ...
                '.$payment_due_date.'
                            ...
                            <tr><td>
                             <span style="font:12px arial"><b>Ref No: </b></span></td><td> <span style="font:12px arial">'
                . $invoice_main->purch_order_id .
                '</span>
    ...
    <br/>
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border-bottom:1px solid;">
		...
		<td width="100%" height="7cm" valign="top" align"center" border="1" cellspacing="0" cellpadding="0" style=" border-bottom:1px solid;">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border-bottom:1px solid;">
			<tr>
            <td width="8%" style="background-color: #cccccc;font: bold 10px arial; text-align: center; height: 17px; padding-top: 3px; border: 1px solid; border-right:none">No.</td>
            <td width="40%" style="background-color: #cccccc;font: bold 10px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid; ">Description</td>
           <!-- <td width="8%" style="background-color: #cccccc;font: bold 10px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid; ">GST Code</td>-->
           ';
        if(UOM == 1){
                $pdf .='<td width="10%" style="background-color: #cccccc;font: bold 10px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid;">UOM</td>';
            }
            if(UOM_QTY == 1){
                $pdf .='<td width="10%" style="background-color: #cccccc;font: bold 10px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid;">UOM QTY</td>';
            }
            $pdf .='
			<td width="8%" style="background-color: #cccccc;font: bold 10px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid;">QTY</td>
			
			 <td width="12%" style="background-color: #cccccc;font: bold 10px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid;border-top: 1px solid; ">Unit Price</td>
			
			<td width="12%" style="background-color: #cccccc;font: bold 10px arial; text-align: center; height: 17px; padding-top: 3px;  border: 1px solid;" >Total Amount</td>
        </tr>';
        ...
        <tr>
            <td width="8%" style="border-bottom: none;border-left: 1px solid; border-left: 1px solid; padding: 5px;  font:10px arial">' . $i . '</td>
            <td width="40%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:10px arial">' . $item['description'] . '</td>
           <!-- <td width="8%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:10px arial">' . $item['description_short'] . '</td>-->
           ';
            if(UOM == 1){
                $pdf .='<td width="10%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:10px arial">' . $item['uom'] . '</td>';
            }
            if(UOM_QTY == 1){
                $pdf .='<td width="10%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:10px arial">' . (($item['uom_qty'] !=0) ? $item['uom_qty'] : 1) . '</td>';
            }
            $pdf.='
			 <td width="8%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:10px arial">' . $item['qty'] . '</td>
			 
			 <td width="12%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:10px arial">' . $currencies->format_full($u_price, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
           
			
			<td width="12%" style="border-bottom: none;border-left: 1px solid;  border-right:1px solid;padding: 5px; font:10px arial">' . $currencies->format_full($item['debit_amount'] + $item['credit_amount'], true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
        </tr>
        ';
            $i++;
        }
        ...
        $pdf .='
       <tr>
            <td width="8%" valign="top" style="border-top:1px solid; border-left:1px solid;"><b>Note:</b></td>
            <td width="40%" style="border-top:1px solid;">' . $invoice_main->message . '</td>
          ...
          if(UOM_QTY == 1){
            $pdf .='<td width="10%" style="border-top:1px solid;"></td>';   
          }
            $pdf .='<td colspan="2" style="border:1px solid; border-left:1px solid;">
				...
				<table width="100%" style="">
                    <tr>
                        ...
                        <td width="50%" style=" font:10px arial;"><b>Sub Total</b></td>
                        <td width="50%" style=" font:10px arial;">' . $currencies->format_full($total_item_amount, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                    </tr>';
        if (in_array($item_val['dsc'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:10px arial;"><b>Discount </b></td>
                            <td width="50%" style=" font:10px arial;">' . $currencies->format_full($discount, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        if (in_array($item_val['frt'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:10px arial;"><b>Freight </b></td>
                            <td width="50%" style=" font:10px arial;">' . $currencies->format_full($freight, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        //if (in_array($item_val['tax'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:10px arial;"><b>GST 6% </b></td>
                            <td width="50%" style=" font:10px arial;">' . $currencies->format_full($tax, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        //}
        if (in_array($item_val['ttl'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:10px arial;"><b>Invoice Total </b></td>
                            <td width="50%" style=" font:10px arial;">' . $currencies->format_full($total, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        $pdf .='</table>
...
';
        ...
        <table width = "100%" style"border:1px solid;">
            <tr>
                <td width="100%" style="font: 8px arial; text-align:left;">
                    1)All payment should be made payable to ' . $company_name . '.<br>
					2) Any complaints on goods delivered have to be lodged within 7 days date of delivery, otherwise no claim will be entertained.
                </td>
            </tr>
        </table>
...
//end invoice pdf
    ...
    <div style="width:100%">
        ...
        <div style="width:40%; float:right; height:80px; border:1px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top"  >
                ...
                date("d-m-Y", strtotime($invoice_main->post_date))
                . '</span></td></tr><tr><td>
                             <span style="font:12px arial"><b>Due Quotation Date : </b></span></td><td> <span style="font:12px arial">'.$payment_due_date.'</span></td></tr>
                            <tr><td>
       ...
       <tr>
        ...
        if (in_array($item_val['ttl'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:12px arial;"><b>Quotation Total </b></td>
    ...
    <div style="width:100%">
        ...
        <div style="width:40%; float:right; height:80px; border:1px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top"  >
                ...
                date("d-m-Y", strtotime($invoice_main->post_date))
                . '</span></td></tr><tr><td>
                             <span style="font:12px arial"><b>Due SO Date : </b></span></td><td> <span style="font:12px arial">'.$payment_due_date.'</span></td></tr>
                            <tr><td>
                             <span style="font:12px arial"><b>PO Num : </b></span></td><td> <span style="font:12px arial">'
                . $invoice_main->purch_order_id .
                '</span>
  ...
  $pdf .='<td width="20%" style="border-bottom: none;border-left: 1px solid; border-right: 1px solid; padding: 5px; font:12px arial">' . $currencies->format_full($item['debit_amount'] + $item['credit_amount'], true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
       ...
       <tr>
        ...
        if (in_array($item_val['ttl'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:12px arial;"><b>Sales Total </b></td>
                            <td width="50%" style=" font:12px arial;">' . $currencies->format_full($total, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        $pdf .='</table></td>
    ...
    <div style="width:100%">
        ...
        <div style="width:40%; float:right; height:80px; border:1px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top"  >
                ...
                date("d-m-Y", strtotime($invoice_main->post_date))
                . '</span></td></tr><tr><td>
                             <span style="font:12px arial"><b>Due Inv Date : </b></span></td><td> <span style="font:12px arial">'.$payment_due_date.'</span></td></tr>
                            <tr><td>
                             <span style="font:12px arial"><b>PO Num : </b></span></td><td> <span style="font:12px arial">'
                . $invoice_main->purch_order_id .
                '</span>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" ">
        ...
        <tr>
            <td width="12%" style="border-bottom: none;border-right: 1px solid; border-left: 1px solid; padding: 5px; border-right:none;  font:12px arial">' . $i . '</td>
       ...
       <tr>
        ...
        if (in_array($item_val['ttl'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:12px arial;"><b>Credit Total </b></td>
                            <td width="50%" style=" font:12px arial;">' . $currencies->format_full($total, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        $pdf .='</table></td>
...
';
                ...
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:12px arial"><b>Debit Memo Number : </b></span> 
                            </td><td><span style="font:12px arial">' .
                $invoice_main->purchase_invoice_id
                . '</span>
                            </td>
                            ...
                            <tr>
                                <td>
                                <span style="font:12px arial"><b>Debit Memo Date : </b></span></td><td> <span style="font:12px arial">' .
                date("d-m-Y", strtotime($invoice_main->post_date))
                . '</span></td></tr><tr><td>
                             <span style="font:12px arial"><b>Due Debit Memo Date : </b></span></td><td> <span style="font:12px arial">' .
                date("d-m-Y", strtotime($invoice_main->terminal_date))
                . '</span></td></tr>
                            <tr><td>
                             <span style="font:12px arial"><b>Invoice Num : </b></span></td><td> <span style="font:12px arial">'
                . $invoice_main->purch_order_id .
                '</span>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" ">
       ...
       <tr>
            <td width="12%" style="border-top:1px solid;"></td>
            <td width="38%" style="border-top:1px solid;"></td>
            <td width="20%" style="border-top:1px solid; border-right:1px solid;"></td>
        ...
        if (in_array($item_val['tax'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:12px arial;"><b>Sales Tax </b></td>
                            <td width="50%" style=" font:12px arial;">' . $currencies->format_full($tax, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        if (in_array($item_val['ttl'], $item_val)) {
...
';
    ...
    <div style="width:100%">
        ...
        <div style="width:40%; float:right; height:80px; border:1px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top"  >
                ...
                date("d-m-Y", strtotime($invoice_main->post_date))
                . '</span></td></tr><tr><td>
                             <span style="font:12px arial"><b>Due Do Date : </b></span></td><td> <span style="font:12px arial">'.$payment_due_date.'</span></td></tr>
                            <tr><td>
                             <span style="font:12px arial"><b>PO Num : </b></span></td><td> <span style="font:12px arial">'
                . $invoice_main->purch_order_id .
                '</span>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border-bottom:1px solid;">
        <tr>
            ...
            <td width="12%" style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px;  border: 1px solid; border-left:none;" >QTY</td>';
            if(UOM == 1){
                $pdf .='<td style="border-right: 1px solid;background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid;">UOM</td>';
            }
        $pdf .='</tr>';
        ...
        <tr>
            ...
            if(UOM == 1){
                $pdf .='<td width="10%" style="border-bottom: none;border-left: 1px solid;border-right: 1px solid; padding: 5px; font:12px arial">' . $item['uom'] . '</td>';
            }
       ...
       <tr>
        ...
        if (in_array($item_val['ttl'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:12px arial;"><b>Pur Order Total </b></td>
                            <td width="50%" style=" font:12px arial;">' . $currencies->format_full($total, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        $pdf .='</table></td>
  ...
  $pdf .='<td width="20%" style="border-bottom: none;border-left: 1px solid; border-right: 1px solid; padding: 5px; font:12px arial">' . $currencies->format_full($item['debit_amount'] + $item['credit_amount'], true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border-bottom:1px solid;">
        <tr>
            ...
            <td width="20%" style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border-right: 1px solid; border-bottom: 1px solid;border-top: 1px solid; ">Due Date</td>
...
//array_pop($invoice_item);
        ...
        <tr>
            ...
            <td width="20%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:12px arial">' . $item['net_date'] . '</td>
