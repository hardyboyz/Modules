...
//start invoice pdf
...
} else if ($_GET['pdf_type'] == "inv" && ($_GET['jID'] == 12 && $_GET['sub_jID'] == 0) || ($_GET['jID'] == 12  && $_GET['sub_jID']==1)) {    if (isset($new_design)) {
        $pdf = $new_design['pdf'];
    } else {
    ...
    <br/>
    <div style="width:100%">
        <div style="width:40%; float:left; border:0px solid; height:90px; ">
		Patient Details
		<br>
            '.$customer_info.'
        </div>
        ...
        <div style="width:20%; float:right; height:90px; border:0px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top"  >
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:12px arial"><b>INVOICE: </b></span> 
