...
<style type="text/css">
    ...
    .company_area{width: 17cm; height: 3cm; }
        .company_area_left{width: 8cm; height: 3cm; float: left; text-align: left;}
        .company_area_right{width: 8cm; height: 3cm; float: right; text-align: right;}
        .company_name{font: bold 10px Arial;}
        .company_addrss{font:regular 10px Arial;}
...
if ($_GET['pdf_type'] == "do") {
    ...
    <div class="company_area">
        ...
        <div class="company_area_right" style="font:12px arial;"  >
            ...
            <br/>
		  <span style="font:12px arial;" class="company_addrss"> ' . $fax . ' </span>
            <br/>
...
';
    ...
    <div class="company_area">
        ...
        <div class="company_area_right" style="font:10px arial;"  >
            ...
            <br/>
            <span style="font: 10px arial;" class="company_addrss"> GST No: ' . $tax_id . '</span>
