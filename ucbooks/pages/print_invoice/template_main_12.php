...
$css = '
<style type="text/css">
    .pdf_area{width: 8cm; height: 18cm; border: 1px solid; padding: 4px;}
    .company_area{width: 8cm; height: 20px; }
        .company_area_left{width: 4cm; height: 3cm; float: left; text-align: left;}
        .company_area_right{width: 4cm; height: 3cm; float: right; text-align: right;}
        .company_name{font: bold 10px Arial;}
        .company_addrss{font:regular x-small Arial;}
    .adress_area{width: 8cm; height: 5cm; border: 1px solid;}
        ...
        .address_heading_text{font: bold 10px Arial; width: 5cm; height: 26px; background-color: #e2dfdf; border-bottom: 1px solid; text-align: center; padding: 4px 0 0 0}
        ...
        .invoice_heading{font:11px Arial; text-align: center; padding-top:4px;}
        .address_content{padding: 5px 0 0 10px; line-height: 18px; font:regular 10px Arial;}
    .invoice_item_area{width: 8cm; height: auto; border: 1px solid;}
        .invocie_item_header{width: 17cm; height: 30px; background-color: #e2dfdf; border-bottom: 1px solid;}
            .invocie_item_header_sku{width: 2cm; height: 26px; float: left; font: bold 12px Arial; text-align: center; padding: 4px 0 0 0; border-right: 1px solid;}
            .invocie_item_header_description{width: 6.5cm; height: 26px; float: left;font: bold 12px Arial; text-align: center; padding: 4px 0 0 0; border-right: 1px solid;}
            .invocie_item_header_qty{width: 2cm; height: 26px; float: left;font:bold 10px Arial; text-align: center; padding: 4px 0 0 0; border-right: 1px solid;}
            .invocie_item_header_nutprice{width: 3cm; height: 26px; float: left;font:bold 10px Arial; text-align: center; padding: 4px 0 0 0; border-right: 1px solid;}
            .invocie_item_header_extension{width: 3cm; height: 26px; float: left;font:bold 10px Arial; text-align: center; padding: 4px 0 0 0;}
         .invocie_item{width: 8cm; height: 30px; }
         ...
         .invocie_sub{width: 17cm; height: auto;}
            ...
            .heading_td{background-color: #cccccc;font: bold 8px arial; text-align: center; height: 17px; padding-top: 3px; border-right: 1px solid; border-bottom: 1px solid;}
            ...
            .footer_area table tr th { font: 8px; }
</style>';
...
$mpdf = new mPDF('utf-8', array(80,236));
...
if (!empty($company_address)) {
    $company_info .= ' <span style="font:8px arial;" class="company_addrss">' . $company_address . ',</span>
            <br/>';
}
// Line 3 
if (!empty($company_address2)) {
    $company_info .= ' <span style="font:8px arial;" class="company_addrss">' . $company_address2 . ',</span>
            <br/>';
}

// Line 4
if (!empty($company_postal_code)) {
    $company_info .= ' <span style="font:8px arial;" class="company_addrss">' . $company_postal_code;
...
if (!empty($company_city_town)) {
    if (!empty($company_postal_code))
        ...
        $company_info .= ' <span style="font:8px arial;" class="company_addrss">' . $company_city_town . ',</span><br/>';
}
// Line 5
if (!empty($company_state)) {
    $company_info .= ' <span style="font:8px arial;" class="company_addrss">' . $company_state;
...
if (!empty($company_country)) {
    if (!empty($company_state))
        ...
        $company_info .= ' <span style="font:8px arial;" class="company_addrss">' . $company_country . '</span><br/>';
}
// Line 6
if (!empty($phone)) {
    $company_info .= ' <span style="font:8px arial;" class="company_addrss">(T)' . $phone;
    if (empty($fax))
        $company_info .= '</span>';
}
...
if (!empty($fax)) {
    if (!empty($phone))
        ...
        $company_info .= ' <span style="font:8px arial;" class="company_addrss">(F)' . $fax . '</span><br/>';
}
// Line 7

if (!empty($email)) {
    $company_info .= ' <span style="font:8px arial;" class="company_addrss">' . $email . '</span>
            <br/>';
}
//Line 8

if (!empty($web)) {
    $company_info .= ' <span style="font:8px arial;" class="company_addrss">' . $web . '</span>
            <br/>';
}
// Line 9
if (!empty($tax_id)) {
    $company_info .= ' <span style="font:8px arial;" class="company_addrss">GST ID: ' . $tax_id . '</span>
            <br/>';
}
...
if ($_GET['pdf_type'] == "do") {
    ...
    <div class="company_area">
        <div class="company_area_right" style="font:8px arial;">
        ...
        <div style="width:30%; float:right; height:90px; border:1px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top"  >
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:8px arial"><b>DO Number : </b></span> 
                            </td><td><span style="font:8px arial">DO/' .
                ...
                . '</span>
                            ...
                            <tr>
                                <td>
                                <span style="font:8px arial"><b>DO Date : </b></span></td><td> <span style="font:8px arial">' .
                date("d-m-Y", strtotime($invoice_main->post_date))
                . '</span></td></tr><tr><td>
                             <span style="font:8px arial"><b>DO Due Date : </b></span></td><td> <span style="font:8px arial">'.$payment_due_date.'</span></td></tr>
                            <tr><td>
                             <span style="font:8px arial"><b>PO Num : </b></span></td><td> <span style="font:8px arial">'
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border-bottom:1px solid;">
        ...
        <tr>
            <td valign="top" align="center" width="8%" style="border-bottom: none;border-right: 1px solid; border-left: 1px solid; padding: 5px;  font:8px arial">' . $i . '</td>
			<td valign="top" align="center" width="10%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['sku'] . '</td>
			<td valign="top" align="left" width="70%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['description'] . '</td>
            <td valign="top" align="center" width="12%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['qty'] . '</td>';
            if(UOM == 1){
                $pdf .='<td width="10%" valign="top" align="center" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $item['uom'] . '</td>';
            }
            if(UOM_QTY == 1){
                $pdf .='<td width="10%" valign="top" align="center" style="border-bottom: none;border-left: 1px solid; border-right:1px solid; padding: 5px; font:8px arial">' . (($item['uom_qty'] !=0) ? $item['uom_qty'] : 1) . '</td>';
            }
        $pdf .='</tr>
        ';
            $i++;
    ...
    <div class="footer_area">
       <div style="font:10px arial">' . $default_message->configuration_value . '</div>
...
//start invoice pdf
  ...
  if (isset($new_design)) {
    ...
    <div style="width:100%">
        <div style="width:45%; float:left; border:1px solid; height:60px;">
            '.$customer_info.'
        </div>
		
        <div style="width:52%; float:right; height:60px; border:1px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top">
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:8px arial">INV No : </span> 
                            </td><td><span style="font:8px arial">' .
                $invoice_main->purchase_invoice_id
                . '</span>
                            </td>
                            </tr>
                            <tr>
                                <td>
                                <span style="font:8px arial">INV Date : </span></td><td> <span style="font:8px arial">' .
                date("d-m-Y", strtotime($invoice_main->post_date))
                . '</span></td></tr><tr><td>
                             <span style="font:8px arial">Due Date : </span></td><td> <span style="font:8px arial">
                '.$payment_due_date.'
            </span></td></tr>
                            <tr><td>
                             <span style="font:8px arial">PO Num : </span></td><td> <span style="font:8px arial">'
                . $invoice_main->purch_order_id .
                '</span>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
        <tr>
            <td width="5%" style="background-color: #cccccc;font: bold 9px arial; text-align: center; height: 17px; padding-top: 3px; border: 1px solid; border-right:none">No.</td>
            <td width="10%" style="background-color: #cccccc;font: bold 9px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid; ">Item Code</td>
			<td width="39%" style="background-color: #cccccc;font: bold 9px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid; ">Description</td>
            <td width="8%" style="background-color: #cccccc;font: bold 9px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid; ">GST</td>
            <td width="14%" style="background-color: #cccccc;font: bold 9px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid;border-top: 1px solid; ">Unit Price</td>
            <td width="8%" style="background-color: #cccccc;font: bold 9px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid;">Qty</td>';
        if(UOM == 1){
                $pdf .='<td style="background-color: #cccccc;font: bold 9px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid;">UOM</td>';
            }
            if(UOM_QTY == 1){
                $pdf .='<td style="background-color: #cccccc;font: bold 9px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid;">UOM QTY</td>';
            }
            $pdf .='<td width="16%" style="background-color: #cccccc;font: bold 9px arial; text-align: center; height: 17px; padding-top: 3px;  border: 1px solid;" >Total Amount</td>
        </tr>';
        ...
        <tr>
            <td valign="top" align="center" width="5%" style="border-bottom: none;border-left: 1px solid; border-left: 1px solid; padding: 5px;  font:8px arial">' . $i . '</td>
			<td valign="top" align="center" width="10%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $item['sku'] . '</td>
			<td valign="top" width="39%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $item['description'] . '</td>
            <td valign="top" align="center" width="8%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $item['description_short'] . '</td>
            <td valign="top" align="center" width="14%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $currencies->format_full($u_price, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
            <td valign="top" align="center" width="8%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $item['qty'] . '</td>';
            if(UOM == 1){
                $pdf .='<td valign="top" align="center" width="10%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $item['uom'] . '</td>';
            }
            if(UOM_QTY == 1){
                $pdf .='<td valign="top" align="center" width="10%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . (($item['uom_qty'] !=0) ? $item['uom_qty'] : 1) . '</td>';
            }
            $pdf.='<td valign="top" align="center" width="16%" style="border-bottom: none;border-left: 1px solid;  border-right:1px solid;padding: 5px; font:8px arial">' . $currencies->format_full($item['debit_amount'] + $item['credit_amount'], true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
        </tr>
        ';
            $i++;
        }
       ...
       <tr>
            ...
            $pdf .='<td colspan="3" style="border:1px solid; border-left:1px solid;">
                 <table width="100%" style="">
                    <tr>
                        ...
                        <td colspan="2" width="50%" style=" font:8px arial;"><b>Sub Total</b></td>
                        <td width="50%" style=" font:8px arial;">' . $currencies->format_full($total_item_amount, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                    </tr>';
        if (in_array($item_val['dsc'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td colspan="2" width="50%" style=" font:8px arial;"><b>Discount </b></td>
                            <td width="50%" style=" font:8px arial;">' . $currencies->format_full($discount, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        if (in_array($item_val['frt'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td colspan="2" width="50%" style=" font:8px arial;"><b>Freight </b></td>
                            <td width="50%" style=" font:8px arial;">' . $currencies->format_full($freight, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        if (in_array($item_val['tax'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td colspan="2" width="50%" style=" font:8px arial;"><b>GST</b></td>
                            <td width="50%" style=" font:8px arial;">' . $currencies->format_full($tax, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        if (in_array($item_val['ttl'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td colspan="2" width="50%" style=" font:8px arial;"><b>Net Total </b></td>
                            <td width="50%" style=" font:8px arial;">' . $currencies->format_full($total, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        $pdf .='</table></td>
       </tr>
    ...
    <div class="footer_area">
        ...
        <table width="100%">
            <tr>
                <th width="33%" style="font-size:8px">GST Summary</th>
                <th width="33%" style="font-size:8px">Amount</th>
                <th width="33%" style="font-size:8px">GST</th>
            </tr>
...
';
	...
	$currencies->format_full($item_val['total_rate_percentage'][$key], true, $invoice_main->currencies_code, $invoice_main->currencies_value);
            $pdf .='
                <tr>
                    <td width="33%" align="center" style="font-size:8px">'.$key.'</td>
                    <td width="33%" align="center" style="font-size:8px">'.$currencies->format_full($val, true, $invoice_main->currencies_code, $invoice_main->currencies_value).'</td>
                        
                    <td width="33%" align="center" style="font-size:8px">'.$currencies->format_full($item_val['total_rate_percentage'][$key], true, $invoice_main->currencies_code, $invoice_main->currencies_value).'</td>
                </tr>
            ';
        }
        ...
        $pdf .= '
            ...
            <br/>
    <div style="font:9px arial">' . $invoice_main->message . '</div>
    <br/>
    </div>
</div>';
    }
...
//end invoice pdf
                ...
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:8px arial"><b>Quo Num: </b></span> 
                            </td><td><span style="font:8px arial">' .
                $invoice_main->purchase_invoice_id
                . '</span>
                            </td>
                            ...
                            <tr>
                                <td>
                                <span style="font:8px arial"><b>Date: </b></span></td><td> <span style="font:8px arial">' .
                date("d-m-Y", strtotime($invoice_main->post_date))
                . '</span></td></tr><tr><td>
                             <span style="font:8px arial"><b>Due Date: </b></span></td><td> <span style="font:8px arial">'.$payment_due_date.'</span></td></tr>
                            <tr><td>
                             <span style="font:8px arial"><b>Ref Num: </b></span></td><td> <span style="font:8px arial">'
                . $invoice_main->purch_order_id .
                '</span>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" ">
        ...
        <tr>
            <td valign="top" align="center" width="5%" style="border-bottom: none;border-left: 1px solid; border-left: 1px solid; padding: 5px;  font:8px arial">' . $i . '</td>
            <td width="45%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $item['description'] . '</td>
            <td valign="top" align="center" width="10%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $item['description_short'] . '</td>
            <td valign="top" align="center" width="16%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $currencies->format_full($u_price, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
            <td valign="top" align="center" width="8%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $item['qty'] . '</td>';
            if(UOM == 1){
                $pdf .='<td width="10%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $item['uom'] . '</td>';
            }
            if(UOM_QTY == 1){
                $pdf .='<td width="10%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . (($item['uom_qty'] !=0) ? $item['uom_qty'] : 1) . '</td>';
            }
            $pdf.='<td valign="top" align="center" width="16%" style="border-bottom: none;border-left: 1px solid;  border-right:1px solid;padding: 5px; font:8px arial">' . $currencies->format_full($item['debit_amount'] + $item['credit_amount'], true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
        </tr>
        ';
            ...
            $pdf .='<td colspan="2" style="border:1px solid; border-left:1px solid;">
                 <table width="100%" style="">
                    <tr>
                        ...
                        <td width="50%" style=" font:8px arial;"><b>Sub Total</b></td>
                        <td width="50%" style=" font:8px arial;">' . $currencies->format_full($total_item_amount, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                    </tr>';
        if (in_array($item_val['dsc'], $item_val)) {
            //$discount = $item_val['dsc']['debit_amount'] + $item_val['dsc']['credit_amount'];
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:8px arial;"><b>Discount </b></td>
                            <td width="50%" style=" font:8px arial;">' . $currencies->format_full($discount, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        if (in_array($item_val['frt'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:8px arial;"><b>Freight </b></td>
                            <td width="50%" style=" font:8px arial;">' . $currencies->format_full($freight, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        if (in_array($item_val['tax'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:8px arial;"><b>GST</b></td>
                            <td width="50%" style=" font:8px arial;">' . $currencies->format_full($tax, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        if (in_array($item_val['ttl'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:8px arial;"><b>Net Total </b></td>
                            <td width="50%" style=" font:8px arial;">' . $currencies->format_full($total, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        $pdf .='</table></td>
                ...
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:8px arial"><b>SO Number: </b></span> 
                            </td><td><span style="font:8px arial">' .
                $invoice_main->purchase_invoice_id
                . '</span>
                            </td>
                ...
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:8px arial"><b>Deposit Num: </b></span> 
                            </td><td><span style="font:8px arial">' .
                $invoice_main->purchase_invoice_id
                . '</span>
                            </td>
                ...
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:8px arial"><b>CRN Num: </b></span> 
                            </td><td><span style="font:8px arial">' .
                $invoice_main->purchase_invoice_id
                . '</span>
                            </td>
                ...
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:8px arial"><b>DBN Num: </b></span> 
                            </td><td><span style="font:8px arial">' .
                $invoice_main->purchase_invoice_id
                . '</span>
                            </td>
                ...
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:8px arial"><b>Pur Number : </b></span> 
                            </td><td><span style="font:8px arial">' .
                $invoice_main->purchase_invoice_id
                . '</span>
                            </td>
                            ...
                            <tr>
                                <td>
                                <span style="font:8px arial"><b>Pur Date : </b></span></td><td> <span style="font:8px arial">' .
                date("d-m-Y", strtotime($invoice_main->post_date))
                . '</span></td></tr><tr><td>
                             <span style="font:8px arial"><b>Pur Due Date : </b></span></td><td> <span style="font:8px arial">'.$payment_due_date.'</span></td></tr>
                            <tr><td>
                             <span style="font:8px arial"><b>Ref Num : </b></span></td><td> <span style="font:8px arial">'
                . $invoice_main->purch_order_id .
                '</span>
...
';
        ...
        <div style="width:40%; float:right; height:80px; border:1px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top"  >
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:8px arial"><b>INV Number : </b></span> 
                            </td><td><span style="font:8px arial">' .
                $invoice_main->purchase_invoice_id
                . '</span>
                            </td>
                ...
                . '</span></td></tr><tr><td>
                             <span style="font:8px arial"><b>Due Date : </b></span></td><td> <span style="font:8px arial">'.$payment_due_date.'</span></td></tr>
                            <tr><td>
                             <span style="font:8px arial"><b>REF: </b></span></td><td> <span style="font:8px arial">'
                . $invoice_main->purch_order_id .
                '</span>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" ">
        ...
        <tr>
            <td width="12%" style="border-bottom: none;border-right: 1px solid; border-left: 1px solid; padding: 5px;  font:8px arial">' . $i . '</td>
            <td width="30%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['description'] . '</td>
            <td width="8%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['description_short'] . '</td>
            <td width="20%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $currencies->format_full($u_price, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
            <td width="10%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['qty'] . '</td>';
            if(UOM == 1){
                $pdf .='<td width="10%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $item['uom'] . '</td>';
            }
            if(UOM_QTY == 1){
            ...
            $pdf .='<td width="20%" style="border-bottom: none;border-right: 1px solid; border-left:1px solid; padding: 5px; font:8px arial">' . $currencies->format_full($item['debit_amount'] + $item['credit_amount'], true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
        </tr>
        ';
            $i++;
        }
       ...
       <tr>
        ...
        if (in_array($item_val['tax'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:8px arial;"><b>Purchase Tax </b></td>
                            <td width="50%" style=" font:8px arial;">' . $currencies->format_full($tax, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        if (in_array($item_val['ttl'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:8px arial;"><b>Purchase Total </b></td>
                            <td width="50%" style=" font:8px arial;">' . $currencies->format_full($total, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        $pdf .='</table></td>
                ...
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:8px arial"><b>PO Num: </b></span> 
                            </td><td><span style="font:8px arial">' .
                $invoice_main->purchase_invoice_id
                . '</span>
                            </td>
                            ...
                            <tr>
                                <td>
                                <span style="font:8px arial"><b>PO Date : </b></span></td><td> <span style="font:8px arial">' .
                date("d-m-Y", strtotime($invoice_main->post_date))
                . '</span></td></tr><tr><td>
                             <span style="font:8px arial"><b>PO Expiry: </b></span></td><td> <span style="font:8px arial">'.$payment_due_date.'</span></td></tr>
                            <tr><td>
                             <span style="font:8px arial"><b>Ref Num: </b></span></td><td> <span style="font:8px arial">'
                . $invoice_main->purch_order_id .
                '</span>
...
';
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border-bottom:1px solid;">
        ...
        <tr>
            <td valign="top" align="center" width="8%" style="border-bottom: none;border-right: 1px solid; border-left: 1px solid; padding: 5px;  font:8px arial">' . $i . '</td>
            <td width="80%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['description'] . '</td>
            <td valign="top" align="center" width="12%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['qty'] . '</td>';
            if(UOM == 1){
                $pdf .='<td width="10%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $item['uom'] . '</td>';
            }
            if(UOM_QTY == 1){
                $pdf .='<td width="10%" style="border-bottom: none;border-left: 1px solid; border-right:1px solid; padding: 5px; font:8px arial">' . (($item['uom_qty'] !=0) ? $item['uom_qty'] : 1) . '</td>';
            }
        $pdf .='</tr>
        ';
            $i++;
        ...
        // check whether message is rewrite or empty.
    ...
    <div class="footer_area">
         ...
         <br/>
    <br/>
    <div style="font:10px arial">' . $message . '</div>
    </div>
</div>';
    }
    ...
    <div style="width:100%">
        ...
        <div style="width:40%; float:right; height:80px; border:1px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top"  >
                ...
                date("d-m-Y", strtotime($invoice_main->post_date))
                . '</span></td></tr><tr><td>
                             <span style="font:8px arial"><b>Due Pur Date : </b></span></td><td> <span style="font:8px arial">'.$payment_due_date.'</span></td></tr>
                            <tr><td>
                             <span style="font:8px arial"><b>PO Num : </b></span></td><td> <span style="font:8px arial">'
                . $invoice_main->purch_order_id .
                '</span>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" ">
        ...
        <tr>
            <td width="12%" style="border-bottom: none;border-left: 1px solid; padding: 5px;  font:8px arial">' . $i . '</td>
            <td width="38%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $item['description'] . '</td>
            <td width="20%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $currencies->format_full($u_price, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
            <td width="10%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $item['qty'] . '</td>';
            if(UOM == 1){
                $pdf .='<td width="10%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:8px arial">' . $item['uom'] . '</td>';
            }
            if(UOM_QTY == 1){
  ...
  $pdf .='<td width="20%" style="border-bottom: none;border-left: 1px solid; border-right: 1px solid; padding: 5px; font:8px arial">' . $currencies->format_full($item['debit_amount'] + $item['credit_amount'], true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
        </tr>
        ';
            $i++;
        }
       ...
       <tr>
        ...
        if (in_array($item_val['ttl'], $item_val)) {
            ...
            $pdf .='<tr>
                            ...
                            <td width="50%" style=" font:8px arial;"><b>Req Quote Total </b></td>
                            <td width="50%" style=" font:8px arial;">' . $currencies->format_full($total, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
                        </tr>';
        }
        $pdf .='</table></td>
...
//array_pop($invoice_item);
        ...
        <tr>
            <td width="10%" style="border-bottom: none;border-right: 1px solid; border-left: 1px solid; padding: 5px;  font:8px arial">' . $i . '</td>
            <td width="10%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['purchase_invoice_id'] . '</td>
                        <td width="26%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $currencies->format_full(str_replace(",", "", $item['total_amount']), true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
            <td width="34%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $currencies->format_full(str_replace(",", "", $item['amount_paid']), true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
            
            <td width="34%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $currencies->format_full(str_replace(",", "", $balance_amount), true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
       ...
       <tr>
            ...
            <td width="26%" style="border: 1px solid;  border-left:none; border-top: none; border-bottom:none; padding:5px; font:8px arial;"><b>Total Due : </b>' . $currencies->format_full($total_amount_due, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
            <td width="34%" style="border: 1px solid; border-left:none; border-top: none; border-bottom:none; padding:5px; font:8px arial;"><b>Total Received : </b>' . $currencies->format_full($total_amount_recv, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
            
            <td width="34%" style="border: 1px solid; border-left:none; border-top: none; border-bottom:none; padding:5px; font:8px arial;"><b>Total Balance : </b>' . $currencies->format_full($total_balance, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
        </tr>  
    </table>
...
//array_pop($invoice_item);
        ...
        <tr>
            <td width="10%" style="border-bottom: none;border-right: 1px solid; border-left: 1px solid; padding: 5px;  font:8px arial">' . $i . '</td>
            <td width="10%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['description'] . '</td>
            <td width="20%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['gl_account'] . '</td>
            <td width="26%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['description_short'] . '</td>
            <td width="34%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $currencies->format_full(str_replace(",", "", $amount), true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
        </tr>
        ';
            $i++;
        }
    ...
    <br/>
    <br/>
    <div style="font:8px arial">' . $invoice_main->message . '</div>
    <br/>
    <br/>
    <div class="footer_area">
...
//array_pop($invoice_item);
                ...
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:8px arial"><b>Pur Num: </b></span> 
                            </td><td><span style="font:8px arial">' .
                $invoice_main->purchase_invoice_id
                . '</span>
                            </td>
        ...
        <div style="width:40%; float:right; height:80px; border:1px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top"  >
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:8px arial"><b>Store Id : </b></span> 
                            </td><td><span style="font:8px arial">' .
                $store
                . '</span>
                            </td>
                            ...
                            <tr>
                                <td>
                         <span style="font:8px arial"><b>Reason For Adjustment : </b></span> 
                            </td><td><span style="font:8px arial">' .
                ...
                . '</span>
                            ...
                            <tr>
                                <td>
                         <span style="font:8px arial"><b>Adjustment Account : </b></span> 
                            </td><td><span style="font:8px arial">' .
                ...
                . '</span>
                            ...
                            <tr>
                                <td>
                                <span style="font:8px arial"><b>Post Date : </b></span></td><td> <span style="font:8px arial">' .
                date("d-m-Y", strtotime($item_val['ttl']['post_date']))
                . '</span></td></tr><tr><td>
                             <span style="font:8px arial"><b>Reference : </b></span></td><td> <span style="font:8px arial">'
                . $invoice_main->purchase_invoice_id .
                '</span>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border-bottom:1px solid;">
        ...
        <tr>
            <td width="12%" style="border-bottom: none;border-right: 1px solid; border-left: 1px solid; padding: 5px;  font:8px arial">' . $i . '</td>
            <td width="25%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['sku'] . '</td>
            <td width="25%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['description'] . '</td>
            <td width="10%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['remaining'] . '</td>
            <td width="10%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['qty'] . '</td>
            <td width="10%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $currencies->format_full( $item['unit_cost'], true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>';

            $pdf .='<td width="10%" style="border-bottom: none;border-left: 1px solid;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['balance'] . '</td>';
...
//start inventory transfer pdf
        ...
        foreach ($branchs as $branche) {
          ...
          foreach ($branchs as $branche) {
            if($transfer_store_id==$branche['id']){
                ...
                $to = $db->Execute('SELECT address1, address2, city_town, state_province from address_book where ref_id="'.$transfer_store_id.'"');
                $customer_info = $to->fields['address1']." ".$to->fields['address2']." ".$to->fields['city_town'].' '.$to->fields['state_province'];
                break;
            }
        }
        $pdf = '<div class="pdf_area">
    ...
    <div style="width:100%">
        <div style="width:40%; float:left; border:1px solid; height:80px; ">
         <span style="font:8px arial"><b> &nbsp; To : </b></span>
        '.$customer_info.'
        </div>
        <div style="width:40%; float:right; height:80px; border:1px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top"  >
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:8px arial"><b>Reference Number : </b></span> 
                            </td><td><span style="font:8px arial">' .
                $invoice_main->purchase_invoice_id
                . '</span>
                            </td>
                             ...
                             <tr>
                                <td>
                         <span style="font:8px arial"><b>Transfer From : </b></span> 
                            </td><td><span style="font:8px arial">' .
                $transfer_from
                . '</span>
                            </td>
                                 ...
                                 <tr>
                                <td>
                         <span style="font:8px arial"><b>Transfer To : </b></span> 
                            </td><td><span style="font:8px arial">' .
                $transfer_to
                . '</span>
                            </td>
                            ...
                            <tr>
                                <td>
                         <span style="font:8px arial"><b>Transfer Account : </b></span> 
                            </td><td><span style="font:8px arial">' .
                $item_val['ttl']['gl_account']
                . '</span>
                            </td>
                ...
                date("d-m-Y", strtotime($invoice_main->post_date))
                . '</span></td></tr><tr><td>
                             <span style="font:8px arial"><b>Reason For Transfer : </b></span></td><td> <span style="font:8px arial">'
                . $item_val['ttl']['description'] .
                '</span>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border-bottom:1px solid;">
        ...
        <tr>
            <td width="12%" style="border-bottom: none;border-right: 1px solid; border-left: 1px solid; padding: 5px;  font:8px arial">' . $i . '</td>
            <td width="25%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['qty'] . '</td>
            <td width="25%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['remaining'] . '</td>
            <td width="10%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['balance'] . '</td>
            <td width="10%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['sku'] . '</td>';

            $pdf .='<td width = "10%" style = "border-bottom: none;border-left: 1px solid;border-right: 1px solid; padding: 5px; font:8px arial">' . $item['description'] . '</td>';
...
//array_pop($invoice_item);
        ...
        foreach ($invoice_item as $item) {
            ...
            <td width = "34%" style = "border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $currencies->format_full(str_replace(",", "", $item['debit_amount']), true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
            <td width = "34%" style = "border-bottom: none;border-right: 1px solid; padding: 5px; font:8px arial">' . $currencies->format_full(str_replace(",", "", $item['credit_amount']), true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
            </tr>
            ';
            $i++;
        }
