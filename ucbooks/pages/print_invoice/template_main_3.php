...
<style type="text/css">
    ...
    .company_area{width: 19cm; height: 4cm; }
        .company_area_left{width: 8cm; height: 4cm; float: left; text-align: left;}
        .company_area_right{width: 10cm; height: 4cm; float: right; text-align: right;}
...
$pdf = '<div class="pdf_area">
    ...
    <div class="company_area">
        <div class="company_area_left">
            <img alt="" width="300" height="100" src="user_company/'.$company_code.'/' . $_SESSION['company'] . '/ucform/images/company_logo/' . $logo . '" />
        </div>
...
$pdf = '<div class="pdf_area">
    ...
    <div class="company_area">
        ...
        <div class="company_area_right" style="font:14px arial;">
			 ...
			 <table width="60%" border="0" cellspacing="0" cellpadding="0" style=" " valign="top" align="right">
                <tr>
                    <td align="center" style="height:22px; background-color: #cccccc;font: bold 30px arial;">
                        TAX INVOICE
                    </td>
                </tr>
            </table>
			...
			<tr>
				...
				<tr>
                    <td align="left" style="height:22px; 10px arial;">
                        Inv No:
                    </td>
					 <td align="right" style="height:22px; 10px arial;">
                        ' .
                        $invoice_main->purchase_invoice_id
                        . '
                    </td>
          ...
          <!--  <span class="company_name" >' . $company_name . '</span>
           <!-- <span style="font:10px arial;" class="company_addrss" >' . $company_address . '</span>
            <br/>
            <span style="font:10px arial;" class="company_addrss"> ' . $phone . '  </span>
            <br/>
            <span style="font:10px arial;" class="company_addrss"> ' . $email . ' </span>
            <br/>
            <span style="font:10px arial;" class="company_addrss"> ' . $web . '</span>-->
    ...
    <div style="width:100%">
        <div style="width:40%; float:left; border:0 solid; height:80px; ">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" " valign="top"  >
                <tr>
                    <td style="font:12px arial;">
                        To:
    ...
    <br/>
     ...
     <div style="width:100%">
        <div style="width:100%; float:left; solid; height:80px; ">
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style=" " valign="top"  >
                <tr>
                    <td width="25%" align="center" border="1" style="height:22px; background-color: #cccccc;font: bold 12px arial;">
                         Sales Person
                    </td>
					<td width="30%" align="center" border="1" style="height:22px; background-color: #cccccc;font: bold 12px arial;">
                        Hotel
                    </td>
					<td width="22.5%" align="center" border="1" style="height:22px; background-color: #cccccc;font: bold 12px arial;">
                        Travelling Date
                    </td>
					<td width="22.5%" align="center" border="1" style="height:22px; background-color: #cccccc;font: bold 12px arial;">
                        Guest Name
			...
			<table width="100%" border="1" cellspacing="0" cellpadding="0" style=" " valign="top"  >
                <tr>
                    <td width="25%" align="center" border="1" style="height:22px; background-color: #fff; font: 12px arial;">
                      '.$sales_rep.'
                    </td>
					<td width="30%" align="center" border="1" style="height:22px; background-color: #fff; font: 12px arial;">
                        '.$invoice_main->purch_order_id.'
                    </td>
					<td width="22.5%" align="center" border="1" style="height:22px; background-color: #fff; font: 12px arial;">
                         '.date("d-m-Y", strtotime($invoice_main->terminal_date)).'
                    </td>
					<td width="22.5%" align="center" border="1" style="height:22px; background-color: #fff; font: 12px arial;">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" border-bottom:1px solid;">
        <tr>
            <td width="8%" style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border: 1px solid;">Item</td>
            <td width="49%" style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border-right: 1px solid; border-bottom: 1px solid; border-top: 1px solid; ">Tour Description</td>
            
            <td width="17.5%" style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border-right: 1px solid; border-bottom: 1px solid;border-top: 1px solid; ">Unit Price</td>
            <td width="8%" style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border-right: 1px solid; border-bottom: 1px solid; border-top: 1px solid;">Qty</td>
            <td width="17.5%" style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px;  border: 1px solid; border-left:none;" >Total Amount</td>
        </tr>';
...
foreach ($invoice_item as $item) {
    ...
    $pdf .='
        ...
        <tr>
            <td width="8%" valign="top" align="center" style="border-bottom: none;border-right: 1px solid; border-left: 1px solid; padding: 5px;  font:12px arial">' . $i . '</td>
            <td width="49%" valign="top" align="left" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:12px arial">' . $item['description'] . '</td>
            <td width="17.5%" valign="top" align="center" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:12px arial">' . $currencies->format_full($u_price, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
            <td width="8%" valign="top" align="center" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:12px arial">' . $item['qty'] . '</td>
            <td width="17.5%" valign="top" align="right" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:12px arial">' . $currencies->format_full($item['debit_amount'] + $item['credit_amount'], true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
        </tr>
        ';
    $i++;
}
...
$pdf .='
       <tr>
            <td width="8%" style="border-right: 1px solid; border-left: 1px solid;"></td>
            <td width="49%" style="border-right: 1px solid;"></td>
            <td width="17.5%" style="border-right: 1px solid;"></td>
            <td width="8%" align="center" style="border: 1px solid;  border-left:none; border-top: none; border-bottom:none; padding:5px; font:12px arial;"><b>Total</b></td>
            <td width="17.5%" align="right" style="border: 1px solid; border-left:none; border-top: none; border-bottom:none; padding:5px; font:12px arial;">' . $currencies->format_full($last_item['debit_amount']+$last_item['credit_amount'], true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
        </tr>  
    </table>
 ...
 <br>
    ...
    <div class="footer_area">
        <table width = "100%" style"border:1px solid;">
            <tr>
                <td width="100%" style="background-color:#fff; font: 10px arial; text-align:left;">
                    Kindly make cheque payable to:<br><br>
					<b>Global Asia Travel Network Sdn Bhd</b><br>
					Public Bank Berhad 3-1837225-28<br><br>
					Payment is due as per stated due date.<br>
					If you have any questions concerning this invoice, please contact ( Helen # 012-6093969 )
                </td>
            </tr>
        </table>
		<br>
        ...
        <table width = "100%" style"border:1px solid;">
            <tr>
                <td width="100%" style="background-color:#fff; font: bold 12px arial; text-align:center;">
			...
			<tr>
                <td width="60%" style="background-color:#fff; font: bold 12px arial; text-align:right;">
                   Global Asia Travel Network Sdn.Bhd
                </td>
				
				<td width="40%" style="background-color:#fff; font: bold 8px arial; text-align:left;">
                   ( 1044690-H )
                </td>
            </tr>
			</table>
			...
			<table  width = "100%" align = "center">
			<tr>
                <td width="100%" style="background-color:#fff; font: 10px arial; text-align:center;">
                  151-2-2,  Mutiara Puchong Business Centre, Jalan 3/152, Tmn Perindustrian OUG, 58200, Kuala Lumpur<br>
Email : booking@ga-travels.com &nbsp; &nbsp; Website : www.ga-travels.com &nbsp; &nbsp;    Tel : +603 7784 3969   &nbsp; &nbsp;  Fax : +603 7784 2969
                </td>
            </tr>
        </table>
    ...
    <div class="company_area">
        <div class="company_area_left">
         ...
         <div class="company_area_right" style="font:14px arial;">
			 ...
			 <table width="60%" border="0" cellspacing="0" cellpadding="0" style=" " valign="top" align="right">
                <tr>
                    <td align="center" style="height:22px; background-color: #fff; font: bold 20px arial;">
                        Proforma Invoice
                    </td>
                </tr>
            </table>
