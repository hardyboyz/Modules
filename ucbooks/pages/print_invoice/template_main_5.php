...
<style type="text/css">
    ...
    .company_area{width: 19cm; height: 5cm; }
        .company_area_left{width: 8cm; height: 5cm; float: left; text-align: left;}
        .company_area_right{width: 10cm; height: 5cm; float: right; text-align: right;}
...
//array_pop($invoice_item);
        ...
        <tr>
            ...
            <td width="20%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:12px arial">' . date("d-m-Y", strtotime($item['net_date'])) . '</td>
