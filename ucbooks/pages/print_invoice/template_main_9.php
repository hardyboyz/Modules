...
if ($_GET['pdf_type'] == "do") {
    ...
    <br/>
    <div style="width:100%">
        <div style="width:50%; float:left; border:1px solid; height:90px; ">
            '.$shipping_info.'
        </div>
        <div style="width:40%; float:right; height:90px; border:1px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top"  >
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:10px arial"><b>DO Number : </b></span> 
                            </td><td><span style="font:10px arial">DO/' .
                ...
                . '</span>
                            ...
                            <tr>
                                <td>
                                <span style="font:10px arial"><b>DO Date : </b></span></td><td> <span style="font:10px arial">' .
                date("d-m-Y", strtotime($invoice_main->post_date))
                . '</span></td></tr><tr><td>
                             <span style="font:10px arial"><b>Due Date : </b></span></td><td> <span style="font:10px arial">'.$payment_due_date.'</span></td></tr>
                            <tr><td>
                             <span style="font:10px arial"><b>Ref : </b></span></td><td> <span style="font:10px arial">'
        ...
        <div style="width:40%; float:right; height:90px; border:1px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top"  >
                <tr>
                    <td style="text-align:left;">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                         <span style="font:10px arial"><b>INV Number : </b></span> 
                            </td><td><span style="font:10px arial">' .
                $invoice_main->purchase_invoice_id
                . '</span>
                            </td>
                            </tr>
                            <tr>
                                <td>
                                <span style="font:10px arial"><b>INV Date : </b></span></td><td> <span style="font:10px arial">' .
                date("d-m-Y", strtotime($invoice_main->post_date))
                . '</span></td></tr><tr><td>
                             <span style="font:10px arial"><b>Due Date : </b></span></td><td> <span style="font:10px arial">
                '.$payment_due_date.'
            </span></td></tr>
                            <tr><td>
                             <span style="font:10px arial"><b>Ref : </b></span></td><td> <span style="font:10px arial">'
                ...
                '</span>
							 ...
							 <tr><td>
                             <span style="font:10px arial"><b>PO : </b></span></td><td> <span style="font:10px arial">'
        ...
        <div style="width:40%; float:right; height:90px; border:1px solid;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="" valign="top"  >
                ...
                . '</span>
                            ...
                            <tr>
                                <td>
                                <span style="font:10px arial"><b>Date: </b></span></td><td> <span style="font:10px arial">' .
                date("d-m-Y", strtotime($invoice_main->post_date))
                . '</span></td></tr><tr><td>
                             <span style="font:10px arial"><b>Due Date: </b></span></td><td> <span style="font:10px arial">'.$payment_due_date.'</span></td></tr>
                            <tr><td>
