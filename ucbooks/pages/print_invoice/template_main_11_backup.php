...
function discount_col($data){
  if($data > 0){
     return '<td width="16%" style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px;  border: 1px solid;" >Discount</td>';
  }
}

function discount_item($data,$percent){
  if($data > 0){
     return '<td valign="top" align="center" width="16%" style="border-bottom: none;border-left: 1px solid;  border-right:1px solid;padding: 5px; font:12px arial">' . $percent . '</td>';
  }
}

$company_code = COMPANY_CODE;
$discount_col_q   = mysql_query("SELECT configuration_value from configuration WHERE configuration_key='DISCOUNT_COL'");
$discount_col     = mysql_fetch_assoc($discount_col_q);
$view_discount    = $discount_col['configuration_value'];
...
if ($_GET['pdf_type'] == "do") {
    if (isset($new_design)) {
        $pdf = $new_design['pdf'];
          ...
          //get DO default message
        $sql_dm = "SELECT * FROM configuration WHERE configuration_key = 'MESSAGE_32_0'";
        $x = mysql_query($sql_dm);
...
//Start Invoice *******************************************************************//
  ...
  if (isset($new_design)) {
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" ">
        <tr>
            <td style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border: 1px solid; border-right:none">No.</td>
        ...
        if(UOM == 1){
          ...
          $pdf .= '<td style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px;  border: 1px solid;" >Discount</td>';
        ...
        <tr>
            ...
            $pdf .= '<td valign="top" align="center" style="border-bottom: none;border-left: 1px solid;  border-right:1px solid;padding: 5px; font:12px arial">' . $percent . '</td>';
...
//end invoice pdf
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" ">
        ...
        if(UOM == 1){
            ...
            $pdf .='<td style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px; border-left: 1px solid; border-bottom: 1px solid; border-top: 1px solid;">Discount</td>';
            $pdf .='<td width="16%" style="background-color: #cccccc;font: bold 12px arial; text-align: center; height: 17px; padding-top: 3px;  border: 1px solid;" >Total Amount</td>
        </tr>';
        ...
        <tr>
            ...
            $pdf .='<td valign="top" align="center" width="10%" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:12px arial">' . $percent . '</td>';
...
';
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" ">
        ...
        <tr>
            ...
            if(UOM_QTY == 1){
                $pdf .='<td valign="top" align="center" valign="top" align="center" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:12px arial">' . (($item['uom_qty'] !=0) ? $item['uom_qty'] : 1) . '</td>';
            }
            $pdf .='<td valign="top" align="center" valign="top" align="center" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:12px arial">' . $percent . '</td>';
            $pdf.='<td valign="top" align="center" style="border-bottom: none;border-left: 1px solid;  border-right:1px solid;padding: 5px; font:12px arial">' . $currencies->format_full($item['debit_amount'] + $item['credit_amount'], true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
        </tr>
        ';
            $i++;
...
';
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" ">
        ...
        <tr>
            ...
            $pdf .='<td width="20%" valign="top" align="center" style="border-bottom: none;border-right: 1px solid; border-left:1px solid; padding: 5px; font:12px arial">' . $currencies->format_full($item['debit_amount'] + $item['credit_amount'], true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
        </tr>
        ';
            $i++;
        }
...
';
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" ">
        ...
        <tr>
            ...
            $pdf .='<td valign="top" align="center" style="border-bottom: none;border-left: 1px solid; padding: 5px; font:12px arial">' . $percent . '</td>';
            $pdf.='<td valign="top" align="center" style="border-bottom: none;border-left: 1px solid;  border-right:1px solid;padding: 5px; font:12px arial">' . $currencies->format_full($item['debit_amount'] + $item['credit_amount'], true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
        </tr>
        ';
            $i++;
...
//array_pop($invoice_item);
        ...
        <tr>
            ...
            <td width="34%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:12px arial">' . $currencies->format_full(str_replace(",", "", $item['amount_paid']), true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
             <td width="34%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:12px arial">' . $currencies->format_full(str_replace(",", "", $balance_amount), true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
       ...
       <tr>
            ...
            <td width="34%" style="border: 1px solid; border-left:none; border-top: none; border-bottom:none; padding:5px; font:12px arial;"><b>Total Balance : </b>' . $currencies->format_full($total_balance, true, $invoice_main->currencies_code, $invoice_main->currencies_value) . '</td>
...
//array_pop($invoice_item);
    ...
    <br/>
    <br/>
    <div style="font:12px arial">' . $message . '</div>
    <br/>
    <br/>
    <div class="footer_area">
...
//array_pop($invoice_item);
        ...
        <tr>
            <td width="10%" style="border-bottom: none;border-right: 1px solid; border-left: 1px solid; padding: 5px;  font:12px arial">' . $i . '</td>
            <td width="20%" style="border-bottom: none;border-right: 1px solid; padding: 5px; font:12px arial">' . $item['description'] . '</td>
