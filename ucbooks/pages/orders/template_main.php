...
if (($_GET['jID'] == 12 && $_GET['sub_jID'] == 0) || ($_GET['jID'] == 12 && $_GET['sub_jID'] == 1)) {
    ...
    $toolbar->icon_list['print']['text'] = "Generate DO PDF";
} else if ($_GET['jID'] == 13 && SUB_JOURNAL_ID == 0) {
...
} else if ($_GET['jID'] == 13 && SUB_JOURNAL_ID == 1) {
    $toolbar->icon_list['print']['params'] = 'onclick="window.open(\'' . html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=print_invoice&amp;oID=' . $_GET['oID'] . '&amp;jID=' . $_GET['jID'] . '&amp;action=pdf&amp;pdf_type=cust_deposit', 'SSL') . '\',\'_blank\')"';
    $toolbar->icon_list['print']['text'] = "Generate Customer Deposit PDF";
} else if ($_GET['jID'] == 19 && SUB_JOURNAL_ID == 1) {
    $toolbar->icon_list['print']['params'] = 'onclick="window.open(\'' . html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=print_invoice&amp;oID=' . $_GET['oID'] . '&amp;jID=' . $_GET['jID'] . '&amp;action=pdf&amp;pdf_type=cust_deposit', 'SSL') . '\',\'_blank\')"';
    $toolbar->icon_list['print']['text'] = "Generate Customer Deposit PDF";
    ...
    $toolbar->icon_list['print']['params'] = 'onclick="window.open(\'' . html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=print_invoice&amp;oID=' . $_GET['oID'] . '&amp;jID=' . $_GET['jID'] . '&amp;action=pdf&amp;pdf_type=pdm', 'SSL') . '\',\'_blank\')"';
    $toolbar->icon_list['print']['text'] = "Generate Debit Note PDF";
}
else if ($_GET['jID'] == 7) {
    $toolbar->icon_list['print']['params'] = 'onclick="window.open(\'' . html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=print_invoice&amp;oID=' . $_GET['oID'] . '&amp;jID=' . $_GET['jID'] . '&amp;action=pdf&amp;pdf_type=pcm', 'SSL') . '\',\'_blank\')"';
    $toolbar->icon_list['print']['text'] = "Generate Credit Note PDF";
}else {
...
if (isset($_GET['oID']) && $_GET['jID'] == 10) {
  if($_GET['action']=="edit"){
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'edit') { // for create a diposit button into sales order
        $toolbar->add_icon('post_next', 'onclick="window.open(\'' . html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=orders&amp;oID=' . $_GET['oID'] . '&amp;jID=19&sub_jID=1&amp;action=prc_cust', 'SSL') . '\',\'_blank\')"');
        $toolbar->icon_list['post_next']['text'] = "Customer deposit";
    }
...
<h1><?php
        if (JOURNAL_ID == 6 && SUB_JOURNAL_ID == 1) {
            ...
            echo constant('ORD_TEXT_13_1_WINDOW_TITLE');
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="28%">
                                ...
                                <span class="form_label" ><?php if (JOURNAL_ID == 6 && SUB_JOURNAL_ID == 1) echo 'Expense #';else if (JOURNAL_ID == 12 && SUB_JOURNAL_ID == 1) echo constant('ORD_HEADING_NUMBER_36');else if (JOURNAL_ID == 19 && SUB_JOURNAL_ID == 1) echo 'Customer Deposits';else if (JOURNAL_ID == 13 && SUB_JOURNAL_ID == 1) echo 'Customer Deposits';else if (JOURNAL_ID == 12 && SUB_JOURNAL_ID == 2) echo constant('ORD_HEADING_NUMBER_30'); else echo constant('ORD_HEADING_NUMBER_' . JOURNAL_ID); ?> :</span><br/><br/>
    ...
    <td width="33%">
                            ...
                            <td colspan="4">
                                <table class="td_padding address_heading" style="width:100%">
                                    <tr>
                                        ...
                                        <td  <?php if ((JOURNAL_ID == 19 || JOURNAL_ID==13) && SUB_JOURNAL_ID == 1) echo 'style="display:none;"' ?> width="50%">
                                            <table style="width: 100%">
                                                <tr>
                        ...
                        <tr >
                            <td colspan="4">
                                <table class="td_padding" style="width:100%">
                                    <tr>
                                        <?php if((JOURNAL_ID == 19 || JOURNAL_ID==13) && SUB_JOURNAL_ID == 1) { ?>
                                            <td width="100%" >
                                            ...
                                            <table class="address_table" style="width: 100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="56%" height="30px">
                                                        ...
                                                        if (!((JOURNAL_ID == 19 || JOURNAL_ID==13) && SUB_JOURNAL_ID == 1)) {
                                        ...
                                        <td width="50%">
                                            <table class="address_table" <?php if ((JOURNAL_ID == 19 || JOURNAL_ID==13) && SUB_JOURNAL_ID == 1) { ?> style="width: 100%; display:none;"<?php } else { ?>  style="width: 100%;" <?php } ?>>
                                                <?php
        ...
        <tr>
            <td>
                ...
                <?php } else { ?>
                    <div id="hidden_btn" style="width:25px; display: none; height: 25px; cursor: pointer;" class="plus">
                        <img alt="" src="images/plus_icon.png" title="Show More Form" />
                    </div>
                    <br>
                    <br>
                    ...
                    <table class="input_width" style="border-collapse:collapse;width:100%;">
                        <tr>    
                            <td width="33%">
                                ...
                                <table class="td_padding" style="width: 100%">
                                    <tr>
                                        <td width="40%" height="30px"><span class="form_label"><?php echo 'Cash account'; ?></span></td>
                                        <td width="4%" height="30px">:</td>
                                        <td width="56%" height="30px"><?php echo html_pull_down_menu('gl_acct_id', $gl_array_list, $order->gl_acct_id, 'tabindex="34" style="width:210px;"'); ?></td>
                                    </tr>
                                </table>
                ...
                <div id="currency_area" style="display:none;">
                    <table class="input_width" style="border-collapse:collapse;width:100%;">
                            ...
                            <td width="33%">
                                <table class="td_padding" style="width: 100%">
                                    <?php if ($template_options['terms']) { ?>
                                        <tr>
                                            <?php if(JOURNAL_ID==9){ ?>
                                            <td width="40%" height="30px"><span class="form_label"><?php echo 'Validity'; ?></span></td>
                                            <?php }else{ ?>
                        ...
                        <tr class="select_width">
                            ...
                            <td width="33%">
                                <table class="td_padding" style="width: 100%">
                                    <?php if (ENABLE_ORDER_DISCOUNT && in_array(JOURNAL_ID, array(9, 10, 12, 36,13, 19))) { ?>
                                        <tr>
                            ...
                            <?php if (!((JOURNAL_ID == 19 || JOURNAL_ID==13) && SUB_JOURNAL_ID == 1)) { ?>
                                <td width="33%">
                                    <table class="td_padding" style="width: 100%">
                                        <tr>
                                            <td width="40%" height="30px">
                                                <span class="form_label"><?php echo in_array(JOURNAL_ID, array(6, 9, 10, 36, 12)) ? ORD_HEADING_NUMBER_4_1 : TEXT_REFERENCE_NUMBER; ?></span>
                                            </td>
                                            <td width="4%" height="30px"> :</td>
                                            <td width="56%" height="30px"><?php echo html_input_field('purch_order_id', $order->purch_order_id, 'tabindex="39" size="21"'); ?> </td>
                                        </tr>
                            ...
                            <td colspan="4">
                                ...
                                <table class="ui-widget" width="100%">
                                    <tr>
                                        ...
                                        <td width="56%">
                                            <?php
                                            $msg = constant('MESSAGE_' . JOURNAL_ID . '_' . SUB_JOURNAL_ID);
//echo html_input_field('message', $order->message, 'readonly="readonly" size="21" maxlength="20"'); 
                                            ?>
                                            <?php echo html_textarea_field('message', 28, 3, $msg, 'tabindex="45"', true);  ?>
                                ...
                                <?php if ($_GET['jID'] == 12 || $_GET['jID'] == 36 || $_GET['jID'] == 6) { ?>
                                    <div class="recurring_block">
                                        <table class="ui-widget" width="100%">
                                            ...
                                            <tr>
                                                <td width="40%" height="30px"><span class="recurring_interval_block">Repeat this invoice Every </span></td><td></td><td height="30px" width="4%"> : </td><td width="56%" height="30px"><input style="margin-left:-5px;" tabindex="50" value="<?php echo $recurring_interval; ?>" type="text" disabled name="recurring_interval" id="recurring_interval" /> days</span></td>
                                                </tr>
                    ...
                    <thead class="ui-widget-header">
                        ...
                        <?php } else { // two line order screen        ?>
                            <tr>
                                ...
                                <th ><?php echo TEXT_DESCRIPTION; ?></th>
                                <?php if (!((JOURNAL_ID == 19 || JOURNAL_ID==13) && SUB_JOURNAL_ID == 1)) { ?>
                                    <?php if (!(JOURNAL_ID == 6 && SUB_JOURNAL_ID == 1)) { ?>
                                        <th><?php echo TEXT_COLUMN_1_TITLE; ?></th>
                                    <?php } ?>
                                    <th><?php echo TEXT_UNIT_PRICE; ?></th>
                                <?php } ?>
...
//                                echo '  <td align="center">' . chr(10);
                                ...
                                if (in_array(JOURNAL_ID, array(6, 7, 12, 36, 13,19))) {
                                ...
                                echo '  <td nowrap="nowrap" align="center">';
                                echo html_input_field('discval_' . $i, $order->item_rows[$j]['discval'], 'size="11" onchange="updateRowTotal(' . $i . ', true)" style="text-align:right"');
                                echo '</td>' . chr(10);
                                
                                echo '  <td nowrap="nowrap" align="center">';
                                echo html_checkbox_field('disc_percent', '1', ($order->item_rows[$j]['disc_percent']) ? true : false, '', '') . chr(10);
                                echo '  </td>' . chr(10);
...
//                                    echo '  <td colspan="4">' . html_pull_down_menu('acct_' . $i, $gl_array_list, $order->item_rows[$j]['acct']) . '</td>' . chr(10);
                                    ...
                                    echo '  <td style="display:none">' . html_input_field('discval_' . $i, '', 'size="11" style="text-align:right"') . '</td>' . chr(10);
                                    echo '  <td style="display:none">' . html_input_field('discper_' . $i, '', 'size="11" style="text-align:right"') . '</td>' . chr(10);
                                ...
                                echo html_hidden_field('discval_' . $i, '') . chr(10);
                                echo html_hidden_field('discper_' . $i, '') . chr(10);
                                // End hidden fields
                    ...
                    <tbody class="ui-widget-content" id="footer_discount">
                        ...
                        <?php if (ENABLE_ORDER_DISCOUNT && in_array(JOURNAL_ID, array(9, 10, 32, 12, 36, 19))) { ?>
                            <tr>
                                ...
                                <td align="right">
                                    <?php echo ORD_DISCOUNT_PERCENT . ' ' . html_input_field('disc_percent', ($order->disc_percent ? number_format(100 * $order->disc_percent, 3) : '0'), ' tabindex="501" size="7" onchange="calculateDiscountPercent()" readonly="readonly" style="text-align:right"') . ' ' . TEXT_DISCOUNT; ?>
                                    <?php echo html_input_field('discount', $currencies->format(($order->discount ? $order->discount : '0'), true, $order->currencies_code, $order->currencies_value), 'tabindex="502" size="15"  onchange="calculateDiscount()" readonly="readonly" style="text-align:right"'); ?>
                                </td>
                            </tr>
                            <?php
                        } else {
                        ...
                        <?php if (defined('MODULE_SHIPPING_STATUS')) { ?>
                            <tr>
                                ...
                                <td <?php if ((JOURNAL_ID == 19 || JOURNAL_ID==13) && SUB_JOURNAL_ID == 1) { ?>style="display:none;" <?php } ?> align="right">
                                    <?php
...
<?php
if (JOURNAL_ID == 10 && $_GET['action'] == 'edit') {
    $query = "select * FROM " . TABLE_JOURNAL_MAIN . " where journal_id=19 and sub_journal_id=1 and so_po_ref_id='" . $_GET['oID'] . "'";
    $result = mysql_query($query);
    $result1 = mysql_query($query);
    if ($result1 != false) {
        $res1 = mysql_fetch_row($result1);
            ...
            <div>
                <table width="50%">
                    ...
                    <?php while ($res = mysql_fetch_array($result)) { ?>
                        ...
                        <tr>
                            <td style="text-align: center;"><a target="_blank" href="<?php echo 'index.php?module=ucbooks&page=orders&oID=' . $res['id'] . '&jID=19&sub_jID=1&type=c&action=edit' ?>"><?php echo $res['purchase_invoice_id']; ?></a></td>
                            <td style="text-align: center;"><?php echo $res['total_amount'] ?></td>
                            <td style="text-align: center;"><a target="_blank" href="<?php echo 'index.php?module=ucbooks&page=print_invoice&oID=' . $res['id'] . '&jID=19&sub_jID=1&action=pdf&pdf_type=cust_deposit' ?>">Deposit PDF</a></td>
                        </tr> 
                    <?php } ?>
