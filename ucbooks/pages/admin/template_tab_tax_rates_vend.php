...
// +-----------------------------------------------------------------+
//  Path: /modules/ucbooks/pages/admin/template_tab_tax_rates_vend.php
//

if (isset($_GET['action_type']) && $_GET['action_type'] == 'purchase_tax_rates') {
    echo html_form('admin', FILENAME_DEFAULT,"module=ucbooks&page=admin&action_type=purchase_tax_rates", 'post', 'enctype="multipart/form-data"', true) . chr(10);
...
<div id="tab_tax_rates_vend">
  ...
  <h1>Purchase Tax Rates<?php //echo $tax_rates_vend->title; ?></h1>
  <div id="tax_rates_vend_content"><?php echo $tax_rates_vend->build_main_html(); ?></div>
</div>

<?php if (isset($_GET['action_type']) && $_GET['action_type'] == 'purchase_tax_rates') { ?>
</form>
<?php } ?>
