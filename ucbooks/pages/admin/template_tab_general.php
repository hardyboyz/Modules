...
// +-----------------------------------------------------------------+
//  Path: /modules/ucbooks/pages/admin/template_tab_general.php
//
...
<div id="tab_general">
  <fieldset>
    <table>
	  ...
	  <tr>
	    <td><?php echo 'Do you want to show UOM?'; ?></td>
	    <td><?php echo html_pull_down_menu('uom', $sel_yes_no, $_POST['uom'] ? $_POST['uom'] : UOM, ''); ?></td>
	  </tr>
          <tr>
	    <td><?php echo 'Do you want to show UOM Qty?'; ?></td>
	    <td><?php echo html_pull_down_menu('uom_qty', $sel_yes_no, $_POST['uom_qty'] ? $_POST['uom_qty'] : UOM_QTY, ''); ?></td>
	  </tr>
     
    <tr>
	    <td><?php echo 'Do you want to show Discount Column?'; ?></td>
	    <td><?php echo html_pull_down_menu('discount_col', $sel_yes_no, $_POST['discount_col'] ? $_POST['discount_col'] : DISCOUNT_COL, ''); ?></td>
	  </tr>
