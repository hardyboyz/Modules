...
} else if (isset($_GET['action_type']) && $_GET['action_type'] == 'purchase_tax_authorities') {
    $menu_select = 'quality';
    $sub_menu_select = 'purchase_tax_authorities';
} else if (isset($_GET['action_type']) && $_GET['action_type'] == 'sales_tax_rates') {
    $menu_select = 'quality';
    $sub_menu_select = 'sales_tax_rates';
} else if (isset($_GET['action_type']) && $_GET['action_type'] == 'purchase_tax_rates') {
    $menu_select = 'quality';
...
if (isset($_GET['action_type']) && $_GET['action_type'] == 'sales_tax_authorities') {
    ...
    $include_template = 'template_tab_tax_auths.php';
    ...
    $include_tabs = true;
    $include_calendar = false;
    $include_template = 'template_tab_tax_auths_vend.php';
    define('PAGE_TITLE', BOX_UCBOOKS_MODULE_ADM);
} else if (isset($_GET['action_type']) && $_GET['action_type'] == 'sales_tax_rates') {
    $include_header = true;
    $include_footer = true;
    $include_tabs = true;
    $include_calendar = false;
    $include_template = 'template_tab_tax_rates.php';
    define('PAGE_TITLE', BOX_UCBOOKS_MODULE_ADM);
} else if (isset($_GET['action_type']) && $_GET['action_type'] == 'purchase_tax_rates') {
    $include_header = true;
    $include_footer = true;
    $include_tabs = true;
    $include_calendar = false;
    $include_template = 'template_tab_tax_rates_vend.php';
    define('PAGE_TITLE', BOX_UCBOOKS_MODULE_ADM);
} else {
