...
// +-----------------------------------------------------------------+
//  Path: /modules/ucbooks/pages/popup_orders/pre_process.php
//
...
switch (JOURNAL_ID) {
	...
	case 20:	// Purchases (direct pay)
		...
		break;
	default:
		die('No valid journal id found (filename: modules/ucbooks/popup.php), Journal ID needs to be passed to this script to identify the correct procedure.');
}
