...
<?php } ?>
   ...
   var openerDoc;
    ...
    function setReturnItem(iID,rID) {
        window.top.loadSkuDetails(iID, rID);
        self.close();  
    }
    ...
    function LoadNewMasterStock(iID,rowCnt){
        //self.close();  
        window.open("index.php?module=ucbooks&page=masterStock&action=new&skuID=" + iID+"&rowCnt=" + rowCnt, "ucbooks", "width=1150px,height=800px,resizable=1,scrollbars=1,top=150,left=100");
        // self.close();
    }
    function SaveNewMasterStock(iID,rowCnt){
         
        openerDoc = window.open("index.php?module=ucbooks&page=masterStock&action=save&skuID=" + iID+"&rowCnt=" + rowCnt, "ucbooks", "width=1150px,height=800px,resizable=1,scrollbars=1,top=150,left=100");
