...
//	$order->sales_tax_auths     = db_prepare_input($_POST['sales_tax_auths']);
        ...
        if (!$error) { // Post the order
            ...
            if(mysql_query($query)){
                 gen_redirect(html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=recurring_invoice_edit&amp;oID=' . $_GET['oID']. '&amp;jID=' . $_GET['jID'] . '&amp;action=edit&rec_id=' . $_GET['rec_id'], 'SSL'));
            }
                ...
                if ($action == 'save') {
                    ...
                    gen_redirect(html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=orders&amp;oID=' . $order->id . '&amp;jID=' . $_GET['jID'] . '&amp;action=edit', 'SSL'));
                    ...
                    gen_redirect(html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=bills&amp;jID=' . $jID . '&amp;type=' . $account_type . '&amp;oID=' . $order->id . '&amp;action=pmt', 'SSL'));
