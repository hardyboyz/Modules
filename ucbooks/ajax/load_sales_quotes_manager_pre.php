...
if ($_GET['jID'] == 18) {
    ...
    $aColumns = array('post_date', 'post_date', 'purchase_invoice_id', 'purchase_invoice_id', 'bill_primary_name', 'product_desc', 'closed', 'total_amount', 'currencies_code', 'currencies_value', 'short_name', 'id');
    $sTable = "v_sales_invoice";
} else if ($_GET['jID'] == 2) {
    $aColumns = array('post_date', 'sub_journal_id', 'post_date', 'purchase_invoice_id', 'purchase_invoice_id', 'bill_primary_name', 'product_desc', 'closed', 'total_amount', 'currencies_code', 'currencies_value', 'short_name', 'id');
    $sTable = "v_sales_invoice";
} else {

    $aColumns = array('post_date', 'purchase_invoice_id', 'bill_primary_name', 'product_desc', 'closed', 'total_amount', 'currencies_code', 'currencies_value', 'short_name', 'id');
    $sTable = "v_sales_invoice";
}
// changed by shaheen
//if ($_GET['jID'] == 2) {
