...
// +-----------------------------------------------------------------+
//  Path: /modules/ucbooks/language/en_us/language.php
//
// Page Titles
...
define('TEXT_DEBIT_PAID','Debit Paid');
define('TEXT_CREDIT_TAKEN','Credit Taken');
define('TEXT_DEBIT_TAKEN','Debit Taken');
define('TEXT_LC_CUSTOMER','customer');
define('TEXT_LC_VENDOR','Supplier');
...
define('ORD_VENDOR_NAME','Supplier Name');
...
define('ORD_CONVERT_TO_DO','Convert to DO ');
...
define('BNK_VENDOR_NAME','Supplier Name');
...
define('ORD_HEADING_NUMBER_4_1', 'Ref. No.');
...
define('GL_ERROR_NO_REFERENCE','For recurring transactions, a starting reference number needs to be entered. UcBooks will increment it for each recurring entry.');
...
define('GL_ERROR_NO_RETAINED_EARNINGS_ACCOUNT','Zero or more than one retained earnings accounts found. There needs to be one and only one retained earnings account in UcBooks to operate properly!');
define('PB_ERROR_NO_PREFERRED_VENDOR','No valid Supplier could be found, make sure at least one sku has a prefered Supplier setup for the inventory item.');
...
// Javascript Messages
define('ORD_JS_RECUR_NO_INVOICE','For a recurring transaction, a starting invoice number needs to be entered. UcBooks will increment it for each recurring entry.');
...
define('LOW_STOCK_NO_VENDOR','No Supplier found');
...
// Tooltip messages
define('ORD_TT_PURCH_INV_NUM','If you leave this field blank, Ucounting will automatically assign a number.');
// Journals
...
define('GEN_ADM_TOOLS_J36','POS Journal (36)');
...
define('ORD_HEADING_NUMBER_30','Debit Memo #');
define('ORD_HEADING_NUMBER_31','Debit Memo #');
// Delete Messages
...
define('GENERAL_JOURNAL_36_ERROR_6','SI - An invoice cannot be deleted if there has been a credit memo or payment applied!');
...
define('GENERAL_JOURNAL_30_ERROR_6','CDM - An Debit memo cannot be deleted if there has been a payment applied!');
define('GENERAL_JOURNAL_31_ERROR_6','VDM - An Debit memo cannot be deleted if there has been a payment applied!');
