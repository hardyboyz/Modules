...
// +-----------------------------------------------------------------+
//  Path: /modules/ucbooks/dashboards/todays_s_quotes/todays_s_quotes.php
//
  ...
  function Output($params) {
	...
	if ($result->RecordCount() < 1) {
	  ...
	  while (!$result->EOF) {
		...
		$contents .= '<div>';
//		$contents .= '<a href="' . html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=orders&amp;oID=' . $result->fields['id'] . '&amp;jID=10&amp;action=edit', 'SSL') . '">';
                $contents .= '<a href="' . html_href_link(FILENAME_DEFAULT, 'module=ucbooks&amp;page=orders&amp;oID=' . $result->fields['id'] . '&amp;jID=9&amp;action=edit', 'SSL') . '">';
