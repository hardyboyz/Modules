...
class purchase_dashboard extends ctl_panel {
  ...
  function Output($params) {
	...
	return $this->build_div('Top 5 Inventory Bought chart', $contents, $control);
  }
