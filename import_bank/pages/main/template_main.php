...
$toolbar->icon_list['cancel']['params'] = 'onclick="location.href = \'' . html_href_link(FILENAME_DEFAULT, 'module=ucounting&amp;page=import_export', 'SSL') . '\'"';
...
<table width="100%" border="0" cellspacing="0" cellpadding="1" style="background-color: #eeeeee;">
    <tr>
        <td>
            <h5><?php echo TEXT_IMPORT; ?></h5>
            <br/><br/>
            <span class="form_label"><?php echo GEN_BANK_IMPORT_MESSAGE; ?></span>
            <br/><br/>
            <?php
            foreach ($page_list as $mod => $params) {
                ...
                foreach ($structure->Module->Table as $table) {
                    if ($table->CanImport) {
                        ?>
                         <?php echo html_combo_box('bank_acct', $cash_chart, '', ''); ?><br/>
                          <?php echo html_file_field('file_name') . ' '; ?><br/>
                          <br/>
