...
$toolbar->icon_list['cancel']['params'] = 'onclick="index.php?module=assets&&page=main"';
...
<style type="text/css">
   #remove_image,#inactive{width: 20px;}
</style>
<h1><?php echo MENU_HEADING_ASSETS . ' - ' . TEXT_ASSET_ID . '# ' . $cInfo->asset_id; ?></h1>

  <div id="inv_image" title="<?php echo $cInfo->asset_id; ?>">
    <?php if ($cInfo->image_with_path) echo html_image(DIR_WS_FULL_PATH . PATH_TO_MY_FILES . $_SESSION['company'] . '/assets/images/' . $cInfo->image_with_path, '', 600) . chr(10);
  ...
  <table>
      <tr>
          <td width="33%">
              ...
              <br/><br/>
            <span class="form_label"> <?php echo TEXT_DESCRIPTION_SHORT; ?> :</span><br/>
            <?php echo html_input_field('description_short', $cInfo->description_short, 'size="33" maxlength="32"', false); ?>
            <br/><br/>
            <span class="form_label"> <?php echo ASSETS_ENTRY_ASSETS_TYPE; ?> :</span><br/>
             <?php echo html_hidden_field('asset_type', $cInfo->asset_type);
		echo html_input_field('inv_type_desc', $assets_types[$cInfo->asset_type], 'readonly="readonly"', false); ?>
            <br/><br/>
            <span class="form_label"> <?php echo ASSETS_ENTRY_FULL_PRICE; ?> :</span><br/>
		...
		?>
            <br/><br/>
            <span class="form_label"> <?php echo ASSETS_ENTRY_ASSETS_SERIALIZE; ?> :</span><br/>
            <?php echo html_input_field('serial_number', $cInfo->serial_number, 'size="33" maxlength="32"'); ?>
            <br/><br/>
            <span class="form_label"> <?php echo TEXT_DETAIL_DESCRIPTION; ?> :</span><br/>
            <?php echo html_textarea_field('description_long', 40, 3, $cInfo->description_long, '', $reinsert_value = true); ?>
          ...
          <td width="33%">
			...
			echo html_image(DIR_WS_FULL_PATH . PATH_TO_MY_FILES . $_SESSION['company'] . '/assets/images/' . $cInfo->image_with_path, $cInfo->image_with_path, '', '100', 'rel="#photo1"');
		} else echo '&nbsp;'; ?>
              <?php echo TEXT_IMAGE . ' (' . TEXT_REMOVE . ' ' . html_checkbox_field('remove_image', '1', $cInfo->remove_image) . ')'; ?>
              <br/><br/>
              <?php echo html_file_field('asset_image'); ?>
              <br/><br/>
              <span class="form_label"><?php echo ASSETS_ENTRY_IMAGE_PATH; ?> :</span><br/>
		...
		echo html_input_field('asset_path', substr($cInfo->image_with_path, 0, strrpos($cInfo->image_with_path, '/'))); ?>
              <br/><br/>
              <span class="form_label"><?php echo ASSETS_PURCHASE_CONDITION; ?> :</span><br/>
              <?php echo html_pull_down_menu('purch_cond', $purch_cond_array, $cInfo->purch_cond); ?>
              <br/><br/>
      ...
      <tr>
          <td width="33%">
              <span class="form_label"><?php echo ASSETS_ENTRY_ACCT_SALES; ?> :</span><br/>
              <?php echo html_pull_down_menu('account_asset', $gl_array_list, $cInfo->account_asset); ?>
              <br/><br/>
              <span class="form_label"><?php echo ASSETS_ENTRY_ACCT_INV; ?> :</span><br/>
              <?php echo html_pull_down_menu('account_depreciation', $gl_array_list, $cInfo->account_depreciation); ?>
              <br/><br/>
              <span class="form_label"><?php echo ASSETS_ENTRY_ACCT_COS; ?> :</span><br/>
              <?php echo html_pull_down_menu('account_maintenance', $gl_array_list, $cInfo->account_maintenance); ?>
              <br/><br/>
          ...
          <td width="33%">
              <span class="form_label"><?php echo ASSETS_DATE_ACCOUNT_CREATION; ?> :</span><br/>
              <?php echo html_calendar_field($cal_date1); ?>
              <br/><br/>
              <span class="form_label"><?php echo ASSETS_DATE_LAST_UPDATE; ?> :</span><br/>
              <?php echo html_calendar_field($cal_date2); ?>
              <br/><br/>
              <span class="form_label"><?php echo ASSETS_DATE_LAST_JOURNAL_DATE; ?> :</span><br/>
              <?php echo html_calendar_field($cal_date3); ?>
              <br/><br/>
