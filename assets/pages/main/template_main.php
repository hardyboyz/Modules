...
$toolbar->icon_list['new']['text']  = "+ New Asset";
...
<!--    <thead class="ui-widget-header">
    ...
    <thead class="ui-widget-hewidgetader">   
        <tr style="height: 36px;" > 
            <th class="ui-state-default" style="padding: 8px 0 0 0;" ><?php echo TEXT_ASSET_ID ?></th>
            <th class="ui-state-default"><?php echo ASSETS_ENTRY_ASSETS_TYPE ?></th>   
            <th class="ui-state-default"><?php echo TEXT_CONDITION ?></th> 
            <th class="ui-state-default"><?php echo ASSETS_ENTRY_ASSETS_SERIALIZE ?></th> 
            <th class="ui-state-default"><?php echo TEXT_DESCRIPTION ?></th> 
            <th class="ui-state-default"><?php echo TEXT_ACQ_DATE ?></th> 
            <th class="ui-state-default"><?php echo TEXT_RETIRE_DATE ?></th> 
