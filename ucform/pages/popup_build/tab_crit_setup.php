...
// +-----------------------------------------------------------------+
//  Path: /modules/ucform/pages/popup_ucfrom/tab_crit_setup.php
//
 ...
 <tbody class="ui-widget-content">
	<tr>
	  <td>
		...
		<thead class="ui-widget-header"><tr><th colspan="3"><?php echo UCFORM_DATEINFO; ?></th></tr></thead>
		<tbody class="ui-widget-content">
		<tr>
		  <td width="33%" valign="top"><?php
			echo UCFORM_DATELIST . '<br /><br />';
			echo UCFORM_DATEINST . '<br /><br />';
	...
	<tr>
	  <td>
		...
		<tr><th colspan="20"><?php echo UCFORM_GRPLIST; ?></th></tr>
		<tr>
	...
	<tr>
	  <td>
		<table class="ui-widget" style="border-collapse:collapse;width:100%">
		<thead class="ui-widget-header">
		<tr><th colspan="20"><?php echo UCFORM_SORTLIST; ?></th></tr>
		<tr>
		  <th><?php echo UCFORM_TBLFNAME; ?></th>
		  <th><?php echo UCFORM_DISPNAME; ?></th>
		  <th><?php echo TEXT_DEFAULT;       ?></th>
	...
	<tr>
	  <td>
		...
		<tr>
		  ...
		  <th><?php echo UCFORM_CRITTYPE;   ?></th>
