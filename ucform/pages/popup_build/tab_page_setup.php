...
// +-----------------------------------------------------------------+
//  Path: /modules/ucform/pages/popup_ucfrom/tab_page_setup.php
//
  ...
  <table class="ui-widget" style="border-style:none;margin-left:auto;margin-right:auto;">
   ...
   <tbody class="ui-widget-content">
    ...
    <tr class="ui-widget-header">
      ...
      <th colspan="2"><?php echo UCFORM_PGLAYOUT; ?></th>
    </tr>
    <tr>
    ...
    <tr class="ui-widget-header">
      ...
      <th colspan="2"><?php echo UCFORM_PGMARGIN; ?></th>
    </tr>
    <tr>
...
<?php if ($report->reporttype == 'rpt') { ?>
  <table class="ui-widget" style="border-collapse:collapse;margin-left:auto;margin-right:auto;">
   <thead class="ui-widget-header">
    <tr><th colspan="8"><?php echo UCFORM_PGHEADER; ?></th></tr>
    <tr>
      <th>&nbsp;</th>
   ...
   <tbody class="ui-widget-content">
    ...
    <tr>
      <td nowrap="nowrap"><?php echo UCFORM_PGTITL1 . ' ' . html_input_field('title1desc', $report->page->title1->text, 'size="30" maxlength="50"'); ?></td>
    ...
    <tr>
      <td nowrap="nowrap"><?php echo UCFORM_PGTITL2 . ' ' . html_input_field('title2desc', $report->page->title2->text, 'size="30" maxlength="50"'); ?></td>
    ...
    <tr>
      <td colspan="2"><?php echo UCFORM_PGFILDESC; ?></td>
    ...
    <tr>
      <td colspan="2"><?php echo UCFORM_RPTDATA; ?></td>
    ...
    <tr>
      <td colspan="2"><?php echo UCFORM_TOTALS; ?></td>
