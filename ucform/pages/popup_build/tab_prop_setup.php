...
// +-----------------------------------------------------------------+
//  Path: /modules/ucform/pages/popup_ucfrom/tab_security_setup.php
//
?>
<div id="tab_prop">
...
<?php } elseif ($report->reporttype == 'frm') { ?>
    <tr>
      <td><?php echo UCFORM_SERIAL_FORM; ?></td>
      <td><?php echo html_checkbox_field('serialform', '1', $report->serialform ? true : false, '', ''); ?></td>
    </tr>
	<tr>
	  <td><?php echo TEXT_SET_PRINTED_FLAG . '<sup>1</sup>'; $notes .= '<br /><sup>1 </sup>' . UCFORM_PRINTED_NOTE; ?></td>
