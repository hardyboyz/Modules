...
CONCAT(journal_item.gl_account,' - ',chart_of_accounts.description) AS c3, journal_item.description AS c4, journal_item.debit_amount AS c5,
 journal_item.credit_amount AS c6,journal_main.journal_id AS c7,journal_main.purchase_invoice_id as c8,(SELECT chart_of_accounts_history.beginning_balance FROM chart_of_accounts_history WHERE account_id='".$gl_account_id."' and period = ".$period_id.") as balance FROM journal_main JOIN journal_item ON journal_main.id = journal_item.ref_id 
