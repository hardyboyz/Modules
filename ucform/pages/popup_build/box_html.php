...
// +-----------------------------------------------------------------+
//  Path: /modules/ucform/pages/popup_build/box_html.php
//
...
function box_build_attributes($properties, $i, $showtrunc = true, $showfont = true, $showborder = true, $showfill = true, $pre = '', $title = '') {
  ...
  if ($showfont) {
    ...
    $output .= '    <div id="' . $pre.'box_whl_' . $i . '" 
	  ...
	  <img src="'.DIR_WS_MODULES.'ucform/images/colorwheel.jpg" width="256" height="256" alt="" />' . nl;
    $output .= '  </div>' . nl;
...
function box_build($properties, $i) {
  ...
  switch ($properties->type) {
	...
	case 'Data':
      ...
      $output .= ' <thead class="ui-widget-header">' . nl;
      $output .= '  <tr>'   . nl;
      $output .= '    <th>' . UCFORM_TBLFNAME . '</th>' . nl;
      $output .= '    <th>' . TEXT_PROCESSING . '</th>' . nl;
      $output .= '  </tr>'  . nl;
      $output .= ' </thead><tbody class="ui-widget-content">' . nl;
      $output .= '  <tr>'   . nl;
	...
	case 'Img':
      ...
      $output .= '  </tr>'  . nl;
      $output .= '  <tr>'   . nl;
      $output .= '    <th colspan="2">' . UCFORM_IMAGESEL . '</th>' . nl;
      $output .= '  </tr>'  . nl;
      $output .= ' </thead><tbody class="ui-widget-content">' . nl;
      $output .= '  <tr>'   . nl;
...
//	  $output .= box_build_attributes($properties, $i, false, false, false, false);
	...
	case 'Line':
      ...
      $output .= ' <thead class="ui-widget-header">' . nl;
      $output .= '  <tr>'   . nl;
      $output .= '    <th colspan="3">' . UCFORM_LINE_TYPE . '</th>' . nl;
      $output .= '  </tr>'  . nl;
      $output .= ' </thead><tbody class="ui-widget-content">' . nl;
      $output .= '  <tr>'   . nl;
      ...
      $output .= '  </tr>'  . nl;
      $output .= '  <tr class="ui-widget-header">'   . nl;
      $output .= '    <th colspan="3">' . UCFORM_ENDPOS . '</th>' . nl;
      $output .= '  </tr>'  . nl;
      $output .= '  <tr>'   . nl;
	...
	case 'Tbl':
      ...
      $output .= '</tr></table>' . nl;
	  $output .= box_build_attributes($properties, $i, false, true,  true, true, 'h', UCFORM_TABLE_HEADING_PROP);
	  $output .= box_build_attributes($properties, $i, false, false, true, true, '',  TEXT_TABLE_BODY_PROPERTIES);
	  $output .= UCFORM_FORM_TABLE_NOTES;
	...
	case 'LtrTpl':
      ...
      $output .= ' <thead class="ui-widget-header">' . nl;
      $output .= '  <tr>' . nl;
      $output .= '    <th>' . UCFORM_TEXTDISP . '</th>' . nl;
      $output .= '  </tr>' . nl;
      $output .= ' </thead><tbody class="ui-widget-content">' . nl;
      $output .= '  <tr>' . nl;
