...
// +-----------------------------------------------------------------+
//  Path: /modules/ucform/pages/popup_build/template_import.php
//
...
<table class="ui-widget" style="border-style:none;margin-left:auto;margin-right:auto;">
 <tbody class="ui-widget-content">
	...
	<tr  class="ui-widget-header">
      <th colspan="2"><?php echo UCFORM_DEFIMP; ?></th>
    </tr>
    <tr>
    ...
    <tr>
      <td>
	    <?php echo UCFORM_RPTBROWSE . ' ' . html_file_field('reportfile'); ?>
	  </td>
    </tr>
    <tr>
      <td>
	    <?php echo UCFORM_RPTENTER . '<br />' . UCFORM_RPTNOENTER; ?>
