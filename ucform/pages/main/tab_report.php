...
// +-----------------------------------------------------------------+
//  Path: /modules/ucform/pages/main/tab_report.php
//
...
if ($security_level > 3) {
  $docbar->icon_list['delete']['params'] = 'onclick="if (confirm(\'' . UCFORM_DELETE_DOCUMENT . '\')) docAction(\'delete\')"';
} else {
...
$fieldset_content .= '    <tr><td>' . TEXT_TYPE . '</td><td>' . $ucformTypes[$doc_details->fields['doc_ext']] . '</td></tr>' . chr(10);
