...
// +-----------------------------------------------------------------+
//  Path: /modules/ucform/doc_ctl/pages/main/tab_folder.php
//
...
if ($id) {
  $docbar->icon_list['delete']['params'] = 'onclick="if (confirm(\'' . UCFORM_DELETE_DIRECTORY . '\')) dirAction(\'delete\')"';
} else {
...
while (!$query_result->EOF) {
    //if($query_result->fields['doc_ext'] == "rpt"){
        if (security_check($query_result->fields['security'])) {
                ...
                $fieldset_content .= '	<td onclick="ReportGenPopup(' . $query_result->fields['id'] . ', \'' . $query_result->fields['doc_ext'] . '\')" >' . html_icon(get_mime_image($query_result->fields['doc_ext'], $folder), '', 'small') . '</td>' . chr(10);
                $fieldset_content .= '	<td onclick="ReportGenPopup(' . $query_result->fields['id'] . ', \'' . $query_result->fields['doc_ext'] . '\')">' . $query_result->fields['doc_title'] . '</td>' . chr(10);
