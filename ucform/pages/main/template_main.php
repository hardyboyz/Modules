    ...
    $(document).ready(function (){ 
        ...
        get_dashboard();
         $('#example').dataTable({
                ...
                "bServerSide": true,
                "sServerMethod": "GET",
                "sAjaxSource": 'index.php?module=ucbooks&page=ajax&op=loaducform',
                "iDisplayLength": 10,
...
<style type="text/css">
    ...
    #banner{margin: 0px auto;padding:10px !important;}
</style>
...
//    echo $toolbar->build_toolbar($add_search = true);
        ...
        <table class="ui-widget" id="example" style="border-collapse:collapse;width:100%">
            <thead class="ui-widget-hewidgetader">   
                <tr style="height: 36px; text-align: center !important;" > 
                    <th class="ui-state-default" style="width: 90px !important">Report Name</th>
                </tr>
            <tbody>
    ...
    <table id="table" class="ui-widget" style="border-style:none;width:100%;">
        <tr>
