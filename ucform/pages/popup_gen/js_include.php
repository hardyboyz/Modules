...
// +-----------------------------------------------------------------+
//  Path: /modules/ucform/pages/popup_gen/js_include.php
//
...
function goToBalanceSheet(id){
    var period = $('#period').val();
     window.open('index.php?module=ucform&page=popup_build&action=balance_sheet&id='+id+'&period='+period+'','_blank');
}
function goToIncomestatement(id){
     var period = $('#period').val();
     window.open('index.php?module=ucform&page=popup_build&action=balance_sheet&id='+id+'&period='+period+'&param=in_stat','_blank');
}
function goToBalanceSheetdetail(id,period){
     window.open('index.php?module=ucform&page=popup_build&action=balance_sheet&id='+id+'&period='+period+'','_blank');
}
function goToIncomestatementdetail(id,period){
     window.open('index.php?module=ucform&page=popup_build&action=balance_sheet&id='+id+'&period='+period+'&param=in_stat','_blank');
}
function check_form() {
  var rpt_id = false;
  ...
  if (!rpt_id) {
	alert('<?php echo UCFORM_NO_SELECTION; ?>');
	return false;
  }
  return true;
}
...
function fetchEmailMsg() {
  ...
  if (rID) {
    $.ajax({
      type: "GET",
	  url: 'index.php?module=ucform&page=ajax&op=load_email_msg&rID='+rID,
