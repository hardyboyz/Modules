...
// +-----------------------------------------------------------------+
//  Path: /modules/ucform/classes/install.php
//
...
class ucform_admin {
  function __construct() {
	...
	// Load tables
	$this->tables = array(
	  TABLE_UCFORM => "CREATE TABLE " . TABLE_UCFORM . " (
  ...
  function update($module) {
	...
	$error = false;
	if (MODULE_UCFORM_STATUS == '3.0') write_configure('PDF_APP', 'TCPDF');
	if (MODULE_UCFORM_STATUS < '3.5') {
