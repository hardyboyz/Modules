...
// +-----------------------------------------------------------------+
//  Path: /modules/ucform/language/en_us/admin.php
//
// Module information
define('MODULE_UCFORM_TITLE','UcForm Module');
define('MODULE_UCFORM_DESCRIPTION','The ucform module contains all the report and form tools needed to print reports in PDF or HTML format. <b>NOTE: This is a core module and should not be removed!</b>');
// title
define('BOX_UCFORM_MODULE_ADM', 'UcForm Admin');
// Headings and Helpers
define('PB_CONVERT_REPORTS','Convert .txt Reports to UcForm');
// admin defines
...
// Tools
define('UCFORM_TOOLS_REBUILD_TITLE','UcForm Stucture Verification / Rebuild');
define('UCFORM_TOOLS_REBUILD_DESC','This tool verifies, and rebuilds the report and form structure. It will re-load the folder structure, make sure there are no orphaned reports and clean out any ucfom table entries that don\'t have a report/form file associated with it');
define('UCFORM_TOOLS_REBUILD_SUBMIT','Start Structure Verify/Rebuild');
define('UCFORM_TOOLS_REBUILD_SUCCESS','Successfully rebuilt report table. The number of reports rebuilt was %s. %s orphaned reports were placed in the Miscellaneous folder.');
?>