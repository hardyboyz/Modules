...
// +-----------------------------------------------------------------+
//  Path: /modules/ucform/ajax/validate_dir.php
//
$fID = $_GET['fID'] ? $_GET['fID'] : 'validateDir';

/**************   Check user security   *****************************/
$xml = NULL;
$security_level = $_SESSION['admin_security'][SECURITY_ID_UCFORM];
