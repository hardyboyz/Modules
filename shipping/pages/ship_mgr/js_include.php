...
function loadPopUp(method, action, id) {
  window.open("index.php?module=shipping&page=popup_tracking&method="+method+"&action="+action+"&sID="+id,"popup_tracking","width=1150,height=350,resizable=1,scrollbars=1,top=150,left=100");
}
