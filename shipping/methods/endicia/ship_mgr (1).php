...
<table class="ui-widget" style="border-style:none;width:100%">
  <tr>
	...
	<td><?php echo ($security_level < 2) ? '&nbsp;' : html_button_field('ship_log_'.$method_id, SHIPPING_CREATE_ENTRY, 'onclick="window.open(\'index.php?module=shipping&amp;page=popup_tracking&amp;method=' .$method_id.'&amp;action=new\',\'popup_tracking\',\'width=1150,height=350,resizable=1,scrollbars=1,top=150,left=00\')"'); ?></td>
 ...
 <tbody class="ui-widget-content">
	...
	if ($result->RecordCount() > 0) {
	  ...
	  while(!$result->EOF) {
		...
		echo html_icon('actions/document-print.png',   TEXT_PRINT,        'small', 'onclick="window.open(\'index.php?module=shipping&amp;page=popup_label_mgr&amp;action=view&amp;method=' . $method_id . '&amp;date=' . $date . '&amp;labels=' . $result->fields['tracking_id'] . '\',\'label_mgr\',\'width=1150,height=700,resizable=1,scrollbars=1,top=50,left=110\')"') . chr(10);
