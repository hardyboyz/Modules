...
<h3>Step 5. Configure Options</h3><p>Make sure the mode is set to Production for rate estimation and label printing. Contact UcSoft for the Dial-A-Zip password as it is a shared account with UcSoft and we would like to know who is using this service. You should now be able to retrieve rates, and print labels using the service. NOTE: UcSoft has performed all label testing on a Zebra ZP 505 printer. Older Eltron/Zebra 2442 and 2844 printers don\'t support the bar code types necessary for USPS postage printing.</p>');
// key descriptions
