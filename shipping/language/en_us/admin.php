...
define('MODULE_SHIPPING_DESCRIPTION','The shipping module is a wrapper for user configurable shipping methods. Some methods are included with the core package and others are available for download from the UcSoft website.');
...
define('SHIPPING_TOOLS_CLEAN_LOG_DESC','This operation creates a downloaded backup of your shipping label files. This will help keep the server storage size down and reduce company backup file sizes. Backing up these files is recommended before cleaning out old files to preserve UcBooks transaction history. <br />INFORMATION: Cleaning out the shipping labels will leave the current records in the database shipping manager and logs.');
