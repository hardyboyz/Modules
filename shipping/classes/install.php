...
class shipping_admin {
  function __construct() {
    ...
    $this->keys = array(
	  ...
	  'ADDRESS_BOOK_SHIP_ADD1_REQ'                     => '0',
	  'ADDRESS_BOOK_SHIP_ADD2_REQ'                     => '0',
	  'ADDRESS_BOOK_SHIP_CITY_REQ'                     => '0',
	  'ADDRESS_BOOK_SHIP_STATE_REQ'                    => '0',
	  'ADDRESS_BOOK_SHIP_POSTAL_CODE_REQ'              => '0',
	  'SHIPPING_DEFAULT_WEIGHT_UNIT'                   => 'KGS',
	  'SHIPPING_DEFAULT_CURRENCY'                      => 'MYR',
	  'SHIPPING_DEFAULT_PKG_DIM_UNIT'                  => 'CM',
